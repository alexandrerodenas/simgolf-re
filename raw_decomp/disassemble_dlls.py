...
disassemble_dll(os.path.expanduser("~/simgolf-re/game_data/exe/Terrain.dll"), "Terrain.dll")
disassemble_dll(os.path.expanduser("~/simgolf-re/game_data/exe/sound.dll"), "sound.dll")
disassemble_dll(os.path.expanduser("~/simgolf-re/game_data/exe/jgld.dll"), "jgld.dll")
