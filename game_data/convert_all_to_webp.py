...
Usage :
  python3 game_data/convert_all_to_webp.py [--all] [--pcx] [--bmp] [--flc]
  python3 game_data/convert_all_to_webp.py --check    # fichiers manquants
  python3 game_data/convert_all_to_webp.py --stats    # stats
...
# Ajouter le dossier game_data au path pour importer decode_flc
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from decode_flc import FLCDecoder

EXTRACTED = os.path.expanduser("~/simgolf-re/game_data/extracted")
OUT_WEBP = os.path.expanduser("~/simgolf-re/game_data/converted/webp")
OUT_ANIM = os.path.expanduser("~/simgolf-re/game_data/converted/animations")
