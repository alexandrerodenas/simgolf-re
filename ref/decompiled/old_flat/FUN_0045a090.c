...

{
  ...
  do {
    ...
    if ((iVar5 < 0x13) && ((&DAT_00575ab0)[iVar5 * 0x208] != '\0')) {
      if (puVar13[-2] != '\0') {
        local_270 = 1;
      }
      iVar9 = 0;
...
LAB_0045a5d2:
  ...
  do {
    ...
    do {
      iVar9 = local_270;
      iVar3 = local_274 / 2 + 1;
      if ((iVar3 < 0x13) && ((&DAT_00575ab0)[iVar3 * 0x208] != '\0')) {
...
LAB_0045adc4:
    ...
    DAT_00569498 = 0;
    FUN_0045c150();
    DAT_0059e7b8 = DAT_0059e7b8 & 0xffdfffff;
    FUN_0046d0c0();
    DAT_00567b04 = 0;
  }
  return;
