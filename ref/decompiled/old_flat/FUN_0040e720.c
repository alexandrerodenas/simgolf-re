...

{
  ...
  if ((((&DAT_00575ab8)[DAT_005685f0 * 0x82] == 0) || ((&DAT_00575ac8)[DAT_005685f0 * 0x82] == 0))
     || ((((byte)DAT_0059e7b8 & 0x40) != 0 && (*(int *)(&DAT_00575ac0 + DAT_005685f0 * 0x208) == 0))
        )) {
  ...
  iVar14 = (int)*(short *)(&DAT_00575ab4 + uVar9 * 0x82);
  if (((*(byte *)(&DAT_00575cb0 + uVar9 * 0x82) & 0x60) != 0) && (0xfa < iVar14)) {
    iVar14 = iVar14 + 0x19;
  }
  if (300 < iVar14) {
    iVar14 = DAT_005a8c60 * -0x19 + iVar14;
  }
  (&DAT_00575ab0)[iVar8] = 3;
  if (iVar14 < 0x33) {
    (&DAT_00575ab0)[iVar8] = 2;
  }
  if (0xf9 < iVar14) {
    (&DAT_00575ab0)[iVar8] = 4;
  }
  if (0x1da < iVar14) {
    (&DAT_00575ab0)[iVar8] = 5;
  }
  if (0x271 < iVar14) {
    (&DAT_00575ab0)[iVar8] = 6;
  }
  if (DAT_00822c88 < 2) {
    ...
    if ((&DAT_00575ab0)[uVar9 * 0x208] == '\x05') {
...
LAB_0040ea77:
    ...
    if (0x1a9 < iVar14) goto LAB_0040ea77;
  }
  else if (cVar2 == '\x05') {
    if (iVar14 < 500) {
      uVar10 = 0xffffffff;
    ...
    if (0x23f < iVar14) goto LAB_0040ea77;
  }
  puVar15 = (undefined2 *)(&DAT_00575ad8 + iVar8);
  *(undefined4 *)(&DAT_00575ca4 + iVar8) = 0;
  *(undefined4 *)(&DAT_00575ad4 + iVar8) = 0;
  *(undefined4 *)(&DAT_00575ad0 + iVar8) = 0;
  *(undefined4 *)(&DAT_00575c9c + iVar8) = 0;
  *(undefined2 *)(&DAT_00575c0a + iVar8) = 0;
  *(undefined2 *)(&DAT_00575c08 + iVar8) = 0;
  iVar14 = 10;
  do {
    iVar12 = 8;
    puVar5 = puVar15;
  ...
  iVar12 = uVar9 * 0x208;
  puVar16 = (undefined4 *)(&DAT_00575b88 + iVar8);
  ...
  (&DAT_00575ab2)[iVar12] = (byte)((int)((iVar8 >> 0x1c & 0xfU) + 1) >> 1) & 7;
  ...
  *pbVar1 = *pbVar1 | 0x40;
  ...
  cVar2 = (&DAT_00575ab0)[uVar10 * 0x208];
  for (uVar9 = uVar9 & 3; uVar9 != 0; uVar9 = uVar9 - 1) {
    *pcVar18 = *pcVar6;
    pcVar6 = pcVar6 + 1;
    pcVar18 = pcVar18 + 1;
...
LAB_0040f01d:
  ...
  if (uVar9 == 1) {
    lVar3 = (longlong)(DAT_00578150 + DAT_00575cc0 * 2) * 0x55555556;
    DAT_00585860 = (char)((ulonglong)lVar3 >> 0x20) - (char)(lVar3 >> 0x3f);
    lVar3 = (longlong)(DAT_00578154 + DAT_00575cc4 * 2) * 0x55555556;
