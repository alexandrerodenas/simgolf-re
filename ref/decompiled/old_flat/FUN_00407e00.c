...
LAB_00408900:
  ...
  *(undefined2 *)(&DAT_005794ce + iVar11) = 0xffff;
  ...
  if ((uVar12 == uVar8) || (((DAT_0059e7b8 & 0x200000) == 0 && (uVar12 == (uVar8 ^ 1))))) {
    ...
    do {
      if (local_1c <= (char)(&DAT_005a5a04)[iVar13 + iVar16]) {
    ...
    if (param_4 != 0) {
      *(undefined2 *)(&DAT_005794ce + iVar11) = 0;
      iVar13 = 0;
      do {
        if ('\x03' < (char)(&DAT_005a5a04)[iVar13 + iVar16]) {
          *(ushort *)(&DAT_005794ce + iVar11) =
               *(ushort *)(&DAT_005794ce + iVar11) | (ushort)(1 << ((byte)iVar13 & 0x1f));
        }
        iVar13 = iVar13 + 1;
...
LAB_00408be9:
    ...
    if ((&DAT_005794d0)[iVar11] != '\0') {
      ...
      if (param_4 == 0) {
        if ((char)(&DAT_005a5a04)[iVar13 + iVar16] < '\n') {
          uVar8 = 0xffffffff;
          ...
          if ((&DAT_005a5a04)[iVar13 + iVar16] == '\0') {
            uVar5 = FUN_00467130(3 - DAT_00822c88,1,3);
            (&DAT_005a5a04)[iVar13 + iVar16] = uVar5;
            uVar8 = 0xffffffff;
            ...
            *(ushort *)(&DAT_005794ce + iVar17) =
            ...
            cVar4 = (&DAT_005a5a04)[iVar13 + iVar16] + '\x01';
            uVar8 = 0xffffffff;
            (&DAT_005a5a04)[iVar13 + iVar16] = cVar4;
            ...
            uVar8 = DAT_005a59f8;
            if ((char)(&DAT_005a5a04)[iVar13 + iVar16] == local_1c) {
              uVar8 = 0xffffffff;
          ...
          if (uVar20 == uVar8) {
            (&DAT_005795a8)[iVar13 + uVar8 * 0x100] = (&DAT_005a5a04)[iVar13 + iVar16];
        ...
        if ((char)(&DAT_005a5a04)[iVar13 + iVar16] < '\x03') {
          return;
        }
        (&DAT_005a5a04)[iVar13 + iVar16] = (&DAT_005a5a04)[iVar13 + iVar16] + -1;
        uVar8 = 0xffffffff;
        pcVar22 = &DAT_004c3f70;
        do {
          pcVar26 = pcVar22;
