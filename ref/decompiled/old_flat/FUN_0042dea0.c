    ...
    if (cVar1 != '\0') {
      ...
      do {
        ...
        do {
          ...
          iVar7 = iVar15 + 4;
          iVar11 = iVar11 + iVar9;
          *(int *)((int)local_40 + iVar15) = *(int *)((int)local_40 + iVar15) + iVar9;
          *(int *)((int)local_20 + iVar15) = *(int *)((int)local_20 + iVar15) + iVar9 * local_5c;
          iVar6 = iVar6 + iVar9 * local_5c;
          psVar3 = psVar3 + 0xb;
          iVar15 = iVar7;
        } while (iVar7 < 0x20);
        local_5c = local_5c + 1;
      ...
      if (9 < iVar11) {
        iVar15 = -DAT_00822c88;
        if (((iVar15 + 6) * iVar11) / 3 + (char)(&DAT_00575ab0)[iVar12] * iVar11 < iVar6) {
          (&DAT_00575cb0)[local_64 * 0x82] = uVar13 & 0xfffffff3 | 4;
        }
        if (iVar6 < (char)(&DAT_00575ab0)[iVar12] * iVar11 - ((iVar15 + 3) * iVar11) / 6) {
...
LAB_0042e2d6:
      ...
      *(undefined4 *)(&DAT_00575cac + iVar11) = 0;
      if (1 < local_64) {
        ...
        if ((&DAT_00575ab0)[iVar11] == (&DAT_005758a8)[iVar11]) {
          *(int *)(&DAT_00575cac + iVar11) = *(int *)(&DAT_00575cac + iVar11) + 1;
        }
