/**
 * func_004a7119 — Auto-décompilé
 * Adresse: 0x004a7119 [golf.exe]
 * Taille: 26070 bytes, Type: std_prologue
 * Appel: __cdecl, Locals: 0B, SEH: True
 * Appelle: 0x4a9874, 0x4a7145, 0x4a98c6, 0x4a730c, 0x4a99a0, 0x4a95bb, 0x4a910c, dword
 * Constantes: 0x4a7239, 0x4aa584, 0x4a99ed, 0x4aa2b6, 0x4a83cb, 0x4a97cc, 0x4a7e33, 0x4a5d5f
 */
void func_004a7119(void) {
    /* 5214 instructions */
    ...
    // sar ebx, 5
    // and ecx, 0x1f
    // mov ebx, dword ptr [ebx*4 + 0x842040]
    // lea ecx, [ecx + ecx*8]
    // test byte ptr [ebx + ecx*4 + 4], 0x80
    // if (...) GOTO(0x4a73a2)
    // mov ecx, edx
    // cmp ecx, eax
    // jae 0x4a73a2
    ...
    // mov eax, dword ptr [ebp - 8]
    // if (...) GOTO(0x4a7468)
    // test byte ptr [edi + 0xc], 1
    // if (...) GOTO(0x4a7460)
    // mov ecx, dword ptr [edi + 4]
    // test ecx, ecx
    // if (...) GOTO(0x4a73c9)
    // and dword ptr [ebp - 8], ecx
    // if (...) GOTO(0x4a7460)
    // sub eax, edx
    // add eax, ecx
    ...
    // mov ebp, esp
    // sub esp, 0x18
    // fld qword ptr [0x4bc480]
    // fstp qword ptr [ebp - 8]
    // fld qword ptr [0x4bc478]
    ...
    // push ebp
    // mov ebp, esp
    // cmp dword ptr [ebp + 0x10], 0x65
    // if (...) GOTO(0x4a7912)
    // cmp dword ptr [ebp + 0x10], 0x45
    // if (...) GOTO(0x4a7912)
    // cmp dword ptr [ebp + 0x10], 0x66
    // if (...) GOTO(0x4a78ff)
    // push dword ptr [ebp + 0x14]
    // push dword ptr [ebp + 0xc]
    // push dword ptr [ebp + 8]
    ...
    // return;
    // push esi
    // mov esi, dword ptr [0x4ba0d4]
    // push dword ptr [0x4e4b60]
    // CALL(esi)
    // push dword ptr [0x4e4b50]
    // CALL(esi)
    // push dword ptr [0x4e4b40]
    // CALL(esi)
    // push dword ptr [0x4e4b20]
    // CALL(esi)
    // pop esi
    // return;
    // push ebp
    ...
    // mov eax, dword ptr [ebp + 8]
    // push esi
    // cmp dword ptr [eax*4 + 0x4e4b1c], 0
    // lea esi, [eax*4 + 0x4e4b1c]
    // if (...) GOTO(0x4a7a08)
    // push edi
    // push(0x18)
    // CALL(0x4a504f)
