...
/* Function: FUN_10043430 @ 0x10043430 */
/* Body size: 4314 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __thiscall FUN_10043430(void *this,int *param_1,int param_2,int param_3,char param_4)

{
  ...
  if ((*(int *)((int)this + 0x14) == 0) || (param_1 == (int *)0x0)) goto LAB_100444f4;
  local_8 = this;
  (**(code **)(*param_1 + 0x10))();
  iVar3 = __chkesp();
  if (iVar3 == 0) goto LAB_100444f4;
  ...
  if (iVar3 == iVar1) {
    ...
    iVar1 = FUN_1007f370(DAT_10122dc8);
    if (iVar3 != iVar1) goto LAB_10043b70;
        ...
        do {
          do {
            if ((*pbVar8 != 0xff) && ((param_4 == '\0' || (*pbVar8 < 0xf8)))) {
              ...
              *puVar10 = ((ushort)(((uVar5 & 0xf81f) * 0x10 + iVar4 >> 1) + iVar4 >> 1) & 0x81f0) +
                         ((ushort)(((uVar5 & 0x7e0) * 0x10 + iVar6 >> 1) + iVar6 >> 1) & 0x7e00);
            }
            pbVar8 = pbVar8 + -1;
            puVar10 = puVar10 + 1;
            iVar1 = iVar1 + -1;
        ...
        do {
          ...
          do {
            if ((*pbVar8 != 0xff) && ((param_4 == '\0' || (*pbVar8 < 0xf8)))) {
              ...
              iVar6 = (*puVar10 & 0x7e0) * 0x10;
              *puVar10 = ((ushort)(((uVar5 & 0xf81f) * 0x10 + iVar1 >> 1) + iVar1 >> 1) & 0x81f0) +
                         ((ushort)(((uVar5 & 0x7e0) * 0x10 + iVar6 >> 1) + iVar6 >> 1) & 0x7e00);
            }
            uVar5 = (ushort)uVar7;
