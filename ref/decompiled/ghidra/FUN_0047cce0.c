...
/* Function: FUN_0047cce0 @ 0x0047CCE0 */
/* Body size: 207 addresses */


void __thiscall FUN_0047cce0(int param_1,int *param_2)
  ...
  if (param_2 != (int *)0x0) {
    ...
    if (((*(uint *)(param_1 + 0x9c) & 0x400) != 0) || ((*(uint *)(param_1 + 0x9c) & 0x11) != 0)) {
      ...
      *param_2 = *param_2 + iVar1;
      ...
      iVar2 = param_2[3] + -iVar1;
      param_2[1] = param_2[1] + iVar1;
      param_2[3] = iVar2;
      if (*(int *)(param_1 + 0x188) != -1) {
        param_2[3] = (*(int *)(param_1 + 0x184) - *(int *)(param_1 + 0x188)) + iVar2;
      }
    }
    if ((*(byte *)(param_1 + 0x9c) & 0x10) != 0) {
      param_2[1] = param_2[1] + (*(int *)(param_1 + 0x180) - *(int *)(param_1 + 0x184));
    }
