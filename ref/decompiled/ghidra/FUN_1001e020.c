...
/* Function: FUN_1001e020 @ 0x1001E020 */
/* Body size: 548 addresses */


undefined4 FUN_1001e020(void)
  ...
  if (((BVar1 == 0) || (local_8c != 2)) || (local_98 < 5)) {
    ...
    if (DVar3 != 0) {
      ...
      if ((local_123c != (char *)0x0) && (pcVar4 = _strchr(local_123c,0x2c), pcVar4 != (char *)0x0))
      {
        ...
        aCStackY_14[2] = '\x01';
        aCStackY_14[3] = '\x10';
        local_1234 = FUN_10024750((byte *)(pcVar4 + 1),(undefined4 *)0x0,10);
        if (local_1234 == 2) {
          return 2;
        }
        if (local_1234 == 3) {
