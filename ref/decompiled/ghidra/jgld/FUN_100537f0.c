...
/* Function: FUN_100537f0 @ 0x100537F0 */
/* Body size: 4538 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __thiscall FUN_100537f0(void *this,int *param_1,int param_2,int param_3,char param_4)

{
  ...
  if ((*(int *)((int)this + 0x14) == 0) || (param_1 == (int *)0x0)) goto LAB_10054994;
  local_8 = this;
  (**(code **)(*param_1 + 0x10))();
  iVar3 = __chkesp();
  if (iVar3 == 0) goto LAB_10054994;
  ...
  if (iVar3 == iVar1) {
    ...
    iVar1 = FUN_1007f370(DAT_10122dc8);
    if (iVar3 != iVar1) goto LAB_10053fa0;
        ...
        do {
          do {
            if ((*pbVar7 != 0xff) && ((param_4 == '\0' || (*pbVar7 < 0xf8)))) {
              ...
              *puVar9 = ((ushort)((*puVar9 & 0xf81f) * 0xb0 + (uVar4 & 0xf81f) * 0x50 >> 4) & 0x81f0
                        ) + ((ushort)((*puVar9 & 0x7e0) * 0xb0 + (uVar4 & 0x7e0) * 0x50 >> 4) &
                            0x7e00);
            }
            pbVar7 = pbVar7 + -1;
            puVar9 = puVar9 + 1;
      ...
      do {
        do {
          if ((*pbVar7 != 0xff) && ((param_4 == '\0' || (*pbVar7 < 0xf8)))) {
            uVar4 = *(ushort *)(iVar3 + (uint)*pbVar7 * 2);
            *puVar9 = ((ushort)((*puVar9 & 0xf81f) * 0xb0 + (uVar4 & 0xf81f) * 0x50 >> 4) & 0x81f0)
                      + ((ushort)((*puVar9 & 0x7e0) * 0xb0 + (uVar4 & 0x7e0) * 0x50 >> 4) & 0x7e00);
          }
          pbVar7 = pbVar7 + 1;
          puVar9 = puVar9 + 1;
          iVar1 = iVar1 + -1;
