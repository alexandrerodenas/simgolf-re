...
/* Function: FUN_1009a440 @ 0x1009A440 */
/* Body size: 297 addresses */


undefined8 __cdecl FUN_1009a440(byte *param_1)

{
  ...
  while( true ) {
    if (DAT_10125998 < 2) {
      local_18 = *(ushort *)(PTR_DAT_1012578c + (uint)*param_1 * 2) & 8;
    }
    else {
      local_18 = FUN_10089800((uint)*param_1,8);
    }
    if (local_18 == 0) break;
    param_1 = param_1 + 1;
  }
  ...
  while( true ) {
    if (DAT_10125998 < 2) {
      local_1c = *(ushort *)(PTR_DAT_1012578c + local_8 * 2) & 4;
    }
    else {
      local_1c = FUN_10089800(local_8,4);
    }
    if (local_1c == 0) break;
