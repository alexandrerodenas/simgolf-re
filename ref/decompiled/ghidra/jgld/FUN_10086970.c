...
/* Function: FUN_10086970 @ 0x10086970 */


void __cdecl FUN_10086970(uint *param_1,int param_2)
    ...
    if (*piVar2 == 0) {
      if (DAT_10129fd4 != (uint *)0x0) {
        ...
        *(char *)(DAT_10129fd4[4] + 0x43) = *(char *)(DAT_10129fd4[4] + 0x43) + -1;
        ...
        if (DAT_10129fd4[2] == 0xffffffff) {
          VirtualFree((LPVOID)DAT_10129fd4[3],0,0x8000);
          ...
          if (DAT_10129fd4 < param_1) {
            param_1 = param_1 + -5;
          }
          DAT_10129fcc = DAT_10129fdc;
        }
      }
      DAT_10129fd4 = param_1;
      DAT_10129fc8 = uVar9;
    }
  }
  return;
