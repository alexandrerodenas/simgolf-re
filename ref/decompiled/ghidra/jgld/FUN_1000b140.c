...
/* Body size: 1902 addresses */


void __thiscall
FUN_1000b140(void *this,int param_1,int param_2,int param_3,int param_4,uint param_5)

{
  ...
  local_8 = this;
  if (param_1 == param_3) {
    thunk_FUN_1000bde0(this,param_1,param_2,param_4,param_5);
  }
  else if (param_2 == param_4) {
    thunk_FUN_1000ba90(this,param_1,param_3,param_2,param_5);
  }
  else {
    if ((param_5 & 0x80000000) == 0) {
      ...
      if (local_38 != (int *)0x0) {
        ...
        if (local_3c == 0) {
          ...
          if (local_3c != 1) goto LAB_1000b89b;
          (**(code **)(*local_38 + 0x1c))();
          iVar3 = __chkesp();
          param_5 = (uint)*(ushort *)(iVar3 + (param_5 & 0xff) * 2);
        }
        ...
        if ((((param_1 <= local_10) && (param_2 <= local_c)) && (local_18 <= param_3)) &&
          ...
          if (local_20 < local_24) {
            ...
            if ((param_1 < local_10) && (param_2 < local_c)) {
              ...
              (**(code **)(*local_8 + 0xe0))();
              iVar2 = __chkesp();
              local_34 = (undefined2 *)(iVar1 + param_1 * 2 + param_2 * iVar2 * 2);
