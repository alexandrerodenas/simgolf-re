...
/* Function: FUN_10093e60 @ 0x10093E60 */
/* Body size: 349 addresses */


undefined4 __cdecl FUN_10093e60(char *param_1,byte *param_2)

{
  ...
  if (*param_2 == 0) {
    ...
    FUN_1007f760((uint *)(param_1 + 0x80),(uint *)(param_2 + 1));
    uVar2 = 0;
  }
  else {
    local_8 = 0;
    while (_Count = FUN_10097340(param_2,&DAT_1011fea8), _Count != 0) {
