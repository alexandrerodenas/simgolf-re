...
/* Function: FUN_1005af00 @ 0x1005AF00 */
/* Body size: 2403 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __thiscall FUN_1005af00(void *this,int *param_1,int param_2,int param_3,int param_4)

{
  ...
  if ((*(int *)((int)this + 0x14) == 0) || (param_1 == (int *)0x0)) goto LAB_1005b84d;
  ...
  if (local_34 == (int *)0x0) goto LAB_1005b84d;
  local_8 = this;
  ...
  *(uint *)((int)local_8 + 0x28) = (uint)*(byte *)((int)local_8 + 0x28);
  ...
  if (local_6c == 0) {
    ...
    if (local_6c != 1) goto LAB_1005b84d;
    (**(code **)(*local_34 + 0x1c))();
    DAT_10128600 = __chkesp();
  }
  ...
  if (iVar5 == iVar3) {
    ...
    iVar3 = FUN_1007f370(DAT_10122dc8);
    if (iVar5 != iVar3) goto LAB_1005b442;
    ...
    if (DAT_10122dc0 < 0) {
      if (DAT_10122dc4 < 0) {
        iVar5 = FUN_10081f90(0,0x1011d610,DAT_10122e44 + 0x60,0,&DAT_1011d528);
        if (iVar5 == 1) {
          pcVar2 = (code *)swi(3);
          (*pcVar2)();
          return;
        ...
        iVar5 = FUN_10081f90(0,0x1011d610,DAT_10122e44 + 0x5e,0,&DAT_1011d528);
        if (iVar5 == 1) {
          pcVar2 = (code *)swi(3);
          (*pcVar2)();
          return;
      ...
      iVar5 = FUN_10081f90(0,0x1011d610,DAT_10122e44 + 0x5a,0,&DAT_1011d528);
      if (iVar5 == 1) {
        pcVar2 = (code *)swi(3);
        (*pcVar2)();
        return;
...
LAB_1005b442:
    ...
    if (DAT_10122dc0 < 0) {
      if (DAT_10122dc4 < 0) {
        iVar5 = FUN_10081f90(0,0x1011d610,DAT_10122e44 + 0xac,0,&DAT_1011d528);
        if (iVar5 == 1) {
          pcVar2 = (code *)swi(3);
          (*pcVar2)();
          return;
        ...
        iVar5 = FUN_10081f90(0,0x1011d610,DAT_10122e44 + 0xaa,0,&DAT_1011d528);
        if (iVar5 == 1) {
          pcVar2 = (code *)swi(3);
          (*pcVar2)();
          return;
      ...
      iVar5 = FUN_10081f90(0,0x1011d610,DAT_10122e44 + 0xa6,0,&DAT_1011d528);
      if (iVar5 == 1) {
        pcVar2 = (code *)swi(3);
        (*pcVar2)();
        return;
