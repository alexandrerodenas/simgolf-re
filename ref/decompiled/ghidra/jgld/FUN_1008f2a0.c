...
/* Function: FUN_1008f2a0 @ 0x1008F2A0 */
/* Body size: 250 addresses */


void __cdecl FUN_1008f2a0(char *param_1,int param_2,int param_3)
  ...
  *local_8 = '\0';
  ...
  if (*param_1 == '1') {
    *(int *)(param_3 + 4) = *(int *)(param_3 + 4) + 1;
    ...
    FUN_1008f590((undefined4 *)param_1,(undefined4 *)(param_1 + 1),sVar3 + 1);
  }
  return;
}
