...
/* Function: FUN_1005c600 @ 0x1005C600 */
/* Body size: 2440 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __thiscall
FUN_1005c600(void *this,int *param_1,int param_2,int param_3,int param_4,int param_5)

{
  ...
  if ((*(int *)((int)this + 0x14) == 0) || (param_1 == (int *)0x0)) goto LAB_1005cf72;
  ...
  if (local_34 == (int *)0x0) goto LAB_1005cf72;
  local_8 = this;
  ...
  *(uint *)((int)local_8 + 0x28) = (uint)*(byte *)((int)local_8 + 0x28);
  ...
  if (local_6c == 0) {
    ...
    if (local_6c != 1) goto LAB_1005cf72;
    (**(code **)(*local_34 + 0x1c))();
    DAT_10128600 = __chkesp();
  }
  ...
  if (iVar5 == iVar3) {
    ...
    iVar3 = FUN_1007f370(DAT_10122dc8);
    if (iVar5 != iVar3) goto LAB_1005cb5b;
    ...
    if (DAT_10122dc0 < 0) {
      if (DAT_10122dc4 < 0) {
        iVar5 = FUN_10081f90(0,0x1011d610,DAT_10122e4c + 0x62,0,&DAT_1011d528);
        if (iVar5 == 1) {
          pcVar2 = (code *)swi(3);
          (*pcVar2)();
          return;
        ...
        iVar5 = FUN_10081f90(0,0x1011d610,DAT_10122e4c + 0x60,0,&DAT_1011d528);
        if (iVar5 == 1) {
          pcVar2 = (code *)swi(3);
          (*pcVar2)();
          return;
      ...
      iVar5 = FUN_10081f90(0,0x1011d610,DAT_10122e4c + 0x5c,0,&DAT_1011d528);
      if (iVar5 == 1) {
        pcVar2 = (code *)swi(3);
        (*pcVar2)();
        return;
          ...
          if (bVar1 != 0xff) {
            if (bVar1 < 0xf8) {
              *(undefined2 *)(local_2c + local_40 * 2) =
                   *(undefined2 *)(DAT_10128600 + (uint)*(byte *)(DAT_101285c8 + (uint)bVar1) * 2);
            }
            else {
              *(undefined2 *)(local_2c + local_40 * 2) =
                   *(undefined2 *)(DAT_101285ec + (uint)*(ushort *)(local_2c + local_40 * 2) * 2);
            }
          }
          local_40 = local_40 + 1;
          local_30 = local_30 + 1;
...
LAB_1005cb5b:
    ...
    if (DAT_10122dc0 < 0) {
      if (DAT_10122dc4 < 0) {
        iVar5 = FUN_10081f90(0,0x1011d610,DAT_10122e4c + 0xaf,0,&DAT_1011d528);
        if (iVar5 == 1) {
          pcVar2 = (code *)swi(3);
          (*pcVar2)();
          return;
        ...
        iVar5 = FUN_10081f90(0,0x1011d610,DAT_10122e4c + 0xad,0,&DAT_1011d528);
        if (iVar5 == 1) {
          pcVar2 = (code *)swi(3);
          (*pcVar2)();
          return;
      ...
      iVar5 = FUN_10081f90(0,0x1011d610,DAT_10122e4c + 0xa9,0,&DAT_1011d528);
      if (iVar5 == 1) {
        pcVar2 = (code *)swi(3);
        (*pcVar2)();
        return;
              ...
              if (bVar1 != 0xff) {
                if (bVar1 < 0xf8) {
                  *(undefined2 *)(local_2c + local_3c * 2) =
                       *(undefined2 *)
                        (DAT_10128600 + (uint)*(byte *)(DAT_101285c8 + (uint)bVar1) * 2);
                }
                else {
                  *(undefined2 *)(local_2c + local_3c * 2) =
                       *(undefined2 *)
