...
/* Function: FUN_10021720 @ 0x10021720 */
/* Body size: 3877 addresses */
...
void __thiscall
FUN_10021720(void *this,int *param_1,int param_2,int param_3,int param_4,int param_5)

{
  ...
  if ((*(int *)((int)this + 0x14) == 0) || (param_1 == (int *)0x0)) goto LAB_1002262f;
  local_8 = this;
  (**(code **)(*param_1 + 0x10))();
  iVar3 = __chkesp();
  if (iVar3 == 0) goto LAB_1002262f;
  ...
  if (local_48 == 0) {
    ...
    if (local_48 != 1) goto LAB_1002262f;
    (**(code **)(*local_3c + 0x1c))();
    DAT_1012856c = __chkesp();
  }
  ...
  if (iVar3 == iVar1) {
    ...
    iVar1 = FUN_1007f370(DAT_10122dc8);
    if (iVar3 != iVar1) goto LAB_10021d7f;
      ...
      if (DAT_10122dc4 < 0) {
        ...
        do {
          do {
            if (*pbVar7 < 0xfe) {
              if (*pbVar7 == 0xf8) {
                *puVar9 = *(ushort *)(DAT_10128574 + (uint)*puVar9 * 2);
              }
              else {
                *puVar9 = *(ushort *)
                           (DAT_10128548 + (uint)*(ushort *)(iVar3 + (uint)*pbVar7 * 2) * 2);
              }
            }
            pbVar7 = pbVar7 + -1;
            puVar9 = puVar9 + 1;
        ...
        do {
          if (*pbVar7 < 0xfe) {
            if (*pbVar7 == 0xf8) {
              ...
              *puVar9 = *(ushort *)(DAT_10128548 + (uint)*(ushort *)(iVar3 + (uint)*pbVar7 * 2) * 2)
              ;
            }
          }
          pbVar7 = pbVar7 + 1;
          ...
          do {
            if (*pbVar7 < 0xfe) {
              if (*pbVar7 == 0xf8) {
                ...
                *puVar9 = *(ushort *)
                           (iVar3 + (uint)*(ushort *)(DAT_10128548 + (uint)*pbVar7 * 2) * 2);
              }
            }
            uVar4 = (ushort)uVar6;
        ...
        do {
          if (*pbVar7 < 0xfe) {
            if (*pbVar7 == 0xf8) {
              ...
              *puVar9 = *(ushort *)(iVar3 + (uint)*(ushort *)(DAT_10128548 + (uint)*pbVar7 * 2) * 2)
              ;
            }
          }
          uVar4 = (ushort)uVar6;
