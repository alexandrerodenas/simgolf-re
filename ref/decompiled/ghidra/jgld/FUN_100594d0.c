...
/* Function: FUN_100594d0 @ 0x100594D0 */
/* Body size: 2291 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __thiscall FUN_100594d0(void *this,int *param_1,int param_2,int param_3)

{
  ...
  if ((*(int *)((int)this + 0x14) == 0) || (param_1 == (int *)0x0)) goto LAB_10059dad;
  ...
  if (local_34 == (int *)0x0) goto LAB_10059dad;
  local_8 = this;
  ...
  *(uint *)((int)local_8 + 0x28) = (uint)*(byte *)((int)local_8 + 0x28);
  ...
  if (local_6c == 0) {
    ...
    if (local_6c != 1) goto LAB_10059dad;
    (**(code **)(*local_34 + 0x1c))();
    DAT_10128600 = __chkesp();
  }
  ...
  if (iVar5 == iVar3) {
    ...
    iVar3 = FUN_1007f370(DAT_10122dc8);
    if (iVar5 != iVar3) goto LAB_100599d6;
    ...
    if (DAT_10122dc0 < 0) {
      if (DAT_10122dc4 < 0) {
        iVar5 = FUN_10081f90(0,0x1011d610,DAT_10122e38 + 0x5b,0,&DAT_1011d528);
        if (iVar5 == 1) {
          pcVar2 = (code *)swi(3);
          (*pcVar2)();
          return;
        ...
        iVar5 = FUN_10081f90(0,0x1011d610,DAT_10122e38 + 0x59,0,&DAT_1011d528);
        if (iVar5 == 1) {
          pcVar2 = (code *)swi(3);
          (*pcVar2)();
          return;
      ...
      iVar5 = FUN_10081f90(0,0x1011d610,DAT_10122e38 + 0x55,0,&DAT_1011d528);
      if (iVar5 == 1) {
        pcVar2 = (code *)swi(3);
        (*pcVar2)();
        return;
...
LAB_100599d6:
    ...
    if (DAT_10122dc0 < 0) {
      if (DAT_10122dc4 < 0) {
        iVar5 = FUN_10081f90(0,0x1011d610,DAT_10122e38 + 0xa3,0,&DAT_1011d528);
        if (iVar5 == 1) {
          pcVar2 = (code *)swi(3);
          (*pcVar2)();
          return;
        ...
        iVar5 = FUN_10081f90(0,0x1011d610,DAT_10122e38 + 0xa1,0,&DAT_1011d528);
        if (iVar5 == 1) {
          pcVar2 = (code *)swi(3);
          (*pcVar2)();
          return;
      ...
      iVar5 = FUN_10081f90(0,0x1011d610,DAT_10122e38 + 0x9d,0,&DAT_1011d528);
      if (iVar5 == 1) {
        pcVar2 = (code *)swi(3);
        (*pcVar2)();
        return;
