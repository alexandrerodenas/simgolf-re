...
/* Function: FUN_1005ed80 @ 0x1005ED80 */
/* Body size: 3196 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __thiscall FUN_1005ed80(void *this,int *param_1,int param_2,int param_3)

{
  ...
  if ((*(int *)((int)this + 0x14) == 0) || (param_1 == (int *)0x0)) goto LAB_1005f9e9;
  local_8 = this;
  (**(code **)(*param_1 + 0x10))();
  iVar4 = __chkesp();
  if (iVar4 == 0) goto LAB_1005f9e9;
  ...
  if (iVar4 == iVar2) {
    ...
    iVar2 = FUN_1007f370(DAT_10122dc8);
    if (iVar4 != iVar2) goto LAB_1005f237;
    ...
    if (DAT_10122dc0 < 0) {
      if (DAT_10122dc4 < 0) {
        ...
        (**(code **)(*param_1 + 0x18))();
        iVar4 = __chkesp();
        local_2c = (byte *)(iVar4 + local_18.left + local_18.top * DAT_10128644);
        ...
        *(int *)PTR_DAT_10122e54 = *(int *)PTR_DAT_10122e58 + DAT_10128678;
        ...
        do {
          ...
          do {
            ...
            pbVar8 = pbVar8 + (-(uint)CARRY2(uVar5,(ushort)iVar2) - uVar1);
            pbVar10 = pbVar10 + 1;
            iVar2 = iVar2 + -0x10000;
          } while (-1 < iVar2);
          pbVar10 = pbVar10 + _DAT_10128648;
      ...
      *(int *)PTR_DAT_10122e54 = *(int *)PTR_DAT_10122e58 + DAT_10128678;
      ...
      do {
        ...
        do {
          ...
          uVar5 = (ushort)uVar7;
          uVar7 = CONCAT22((short)(uVar7 >> 0x10),uVar5 + (ushort)iVar2);
          pbVar8 = pbVar8 + CARRY2(uVar5,(ushort)iVar2) + uVar1;
          pbVar10 = pbVar10 + 1;
          iVar2 = iVar2 + -0x10000;
        } while (-1 < iVar2);
        pbVar10 = pbVar10 + _DAT_10128648;
