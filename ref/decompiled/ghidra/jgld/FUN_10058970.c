...
/* Function: FUN_10058970 @ 0x10058970 */
/* Body size: 2321 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __thiscall FUN_10058970(void *this,int *param_1,int param_2,int param_3,int param_4)

{
  ...
  if ((*(int *)((int)this + 0x14) == 0) || (param_1 == (int *)0x0)) goto LAB_1005926b;
  ...
  if (local_34 == (int *)0x0) goto LAB_1005926b;
  local_8 = this;
  ...
  *(uint *)((int)local_8 + 0x28) = (uint)*(byte *)((int)local_8 + 0x28);
  ...
  if (local_6c == 0) {
    ...
    if (local_6c != 1) goto LAB_1005926b;
    (**(code **)(*local_34 + 0x1c))();
    DAT_10128600 = __chkesp();
  }
  ...
  if (iVar5 == iVar3) {
    ...
    iVar3 = FUN_1007f370(DAT_10122dc8);
    if (iVar5 != iVar3) goto LAB_10058e89;
    ...
    if (DAT_10122dc0 < 0) {
      if (DAT_10122dc4 < 0) {
        iVar5 = FUN_10081f90(0,0x1011d610,DAT_10122e34 + 0x5d,0,&DAT_1011d528);
        if (iVar5 == 1) {
          pcVar2 = (code *)swi(3);
          (*pcVar2)();
          return;
        ...
        iVar5 = FUN_10081f90(0,0x1011d610,DAT_10122e34 + 0x5b,0,&DAT_1011d528);
        if (iVar5 == 1) {
          pcVar2 = (code *)swi(3);
          (*pcVar2)();
          return;
      ...
      iVar5 = FUN_10081f90(0,0x1011d610,DAT_10122e34 + 0x57,0,&DAT_1011d528);
      if (iVar5 == 1) {
        pcVar2 = (code *)swi(3);
        (*pcVar2)();
        return;
...
LAB_10058e89:
    ...
    if (DAT_10122dc0 < 0) {
      if (DAT_10122dc4 < 0) {
        iVar5 = FUN_10081f90(0,0x1011d610,DAT_10122e34 + 0xa5,0,&DAT_1011d528);
        if (iVar5 == 1) {
          pcVar2 = (code *)swi(3);
          (*pcVar2)();
          return;
        ...
        iVar5 = FUN_10081f90(0,0x1011d610,DAT_10122e34 + 0xa3,0,&DAT_1011d528);
        if (iVar5 == 1) {
          pcVar2 = (code *)swi(3);
          (*pcVar2)();
          return;
      ...
      iVar5 = FUN_10081f90(0,0x1011d610,DAT_10122e34 + 0x9f,0,&DAT_1011d528);
      if (iVar5 == 1) {
        pcVar2 = (code *)swi(3);
        (*pcVar2)();
        return;
