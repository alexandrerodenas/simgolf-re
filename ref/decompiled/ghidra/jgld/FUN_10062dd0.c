...
/* Function: FUN_10062dd0 @ 0x10062DD0 */
/* Body size: 3597 addresses */
...
void __thiscall
FUN_10062dd0(void *this,int *param_1,int param_2,int param_3,int param_4,int param_5)

{
  ...
  if ((*(int *)((int)this + 0x14) == 0) || (param_1 == (int *)0x0)) goto LAB_10063bca;
  local_8 = this;
  (**(code **)(*param_1 + 0x10))();
  iVar3 = __chkesp();
  if (iVar3 == 0) goto LAB_10063bca;
      ...
      if (DAT_10122dc4 < 0) {
        ...
        do {
          do {
            if (*pbVar7 < 0xfe) {
              if (*pbVar7 == 0xf8) {
                *pbVar9 = *(byte *)(DAT_1012866c + (uint)*pbVar9);
              }
              else {
                *pbVar9 = *(byte *)(iVar3 + (uint)*(byte *)(DAT_1012862c + (uint)*pbVar7));
              }
            }
            pbVar7 = pbVar7 + -1;
            pbVar9 = pbVar9 + 1;
          ...
          pbVar7 = pbVar7 + -_DAT_1012861c;
          pbVar9 = pbVar9 + _DAT_10128648;
    ...
    if (DAT_10122dc0 < 0) {
      if (DAT_10122dc4 < 0) {
        ...
        *(int *)PTR_DAT_10122e54 = *(int *)PTR_DAT_10122e58 + DAT_10128678;
        ...
        _DAT_1012867c = _DAT_10128688 >> 0x10;
        _DAT_10128628 = DAT_10128624 << 0x10;
        pbVar7 = local_30;
        pbVar9 = local_2c;
        do {
          iVar5 = CONCAT22((short)((uint)DAT_10128650 >> 0x10),DAT_10128688);
          uVar6 = CONCAT22((short)((uint)iVar1 >> 0x10),DAT_1012863c);
          do {
            if (*pbVar7 < 0xfe) {
              if (*pbVar7 == 0xf8) {
                *pbVar9 = *(byte *)(DAT_1012866c + (uint)*pbVar9);
            ...
            pbVar7 = pbVar7 + (-(uint)CARRY2(uVar4,(ushort)iVar5) - _DAT_1012867c);
            pbVar9 = pbVar9 + 1;
            iVar5 = iVar5 + -0x10000;
          } while (-1 < iVar5);
          pbVar9 = pbVar9 + _DAT_10128648;
          iVar1 = uVar6 + _DAT_10128628;
          pbVar7 = pbVar7 + *(int *)(PTR_DAT_10122e58 + (uint)CARRY4(uVar6,_DAT_10128628) * -4);
          DAT_10128670 = DAT_10128670 + -1;
        } while (DAT_10128670 != 0);
      }
      else {
      ...
      *(int *)PTR_DAT_10122e54 = *(int *)PTR_DAT_10122e58 + DAT_10128678;
      ...
      do {
        ...
        do {
          ...
          uVar4 = (ushort)uVar6;
          uVar6 = CONCAT22((short)(uVar6 >> 0x10),uVar4 + (ushort)iVar5);
          pbVar7 = pbVar7 + CARRY2(uVar4,(ushort)iVar5) + _DAT_1012867c;
          pbVar9 = pbVar9 + 1;
          iVar5 = iVar5 + -0x10000;
        } while (-1 < iVar5);
        pbVar9 = pbVar9 + _DAT_10128648;
