...

{
  ...
  local_58 = local_8[3] * param_1[3];
  fVar7 = thunk_FUN_10003c90(local_8,param_1);
  local_c = (float)((float10)local_58 - fVar7);
  pfVar1 = thunk_FUN_100039b0(local_8,local_48,param_1[3]);
  pfVar4 = local_54;
  pfVar2 = thunk_FUN_100039b0(param_1,local_30,local_8[3]);
  pfVar3 = local_3c;
  this = thunk_FUN_10003e50(local_8,local_24,param_1);
