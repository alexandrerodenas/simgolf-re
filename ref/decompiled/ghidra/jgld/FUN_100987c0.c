...
/* Function: FUN_100987c0 @ 0x100987C0 */


undefined1 * FUN_100987c0(void)

{
  ...
  if (puVar4 != (undefined1 *)0x0) {
    ...
    for (local_14 = 0; local_14 < 7; local_14 = local_14 + 1) {
      *local_18 = 0x3a;
      puVar5 = FUN_1007f760((uint *)(local_18 + 1),*(uint **)(puVar1 + local_14 * 4));
      sVar2 = _strlen((char *)puVar5);
      puVar6 = (undefined1 *)((int)(local_18 + 1) + sVar2);
      *puVar6 = 0x3a;
      puVar5 = (uint *)(puVar6 + 1);
      _Str = FUN_1007f760(puVar5,*(uint **)(puVar1 + local_14 * 4 + 0x1c));
