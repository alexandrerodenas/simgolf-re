...
/* Function: FUN_10063f60 @ 0x10063F60 */
/* Body size: 3356 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* WARNING: Restarted to delay deadcode elimination for space: stack */

void __thiscall FUN_10063f60(void *this,int *param_1,int param_2,int param_3,int param_4)

{
  ...
  if ((*(int *)((int)this + 0x14) == 0) || (param_1 == (int *)0x0)) goto LAB_10064c69;
  local_8 = this;
  (**(code **)(*param_1 + 0x10))();
  iVar4 = __chkesp();
  if (iVar4 == 0) goto LAB_10064c69;
  ...
  if (iVar4 == iVar2) {
    ...
    iVar2 = FUN_1007f370(DAT_10122dc8);
    if (iVar4 != iVar2) goto LAB_1006446b;
    ...
    if (DAT_10122dc0 < 0) {
      if (DAT_10122dc4 < 0) {
        ...
        iVar2 = __chkesp();
        iVar4 = DAT_1012862c;
        local_2c = (undefined1 *)(iVar2 + local_18.left + local_18.top * DAT_10128644);
        ...
        do {
          do {
            if (*pbVar8 < 0xfe) {
              *puVar10 = *(undefined1 *)(iVar4 + (uint)CONCAT11(*pbVar8,*puVar10));
            }
            pbVar8 = pbVar8 + -1;
            puVar10 = puVar10 + 1;
            iVar2 = iVar2 + -1;
...
LAB_1006446b:
    ...
    (**(code **)(*param_1 + 0x18))();
    iVar4 = __chkesp();
    local_2c = (undefined1 *)(iVar4 + local_18.left + local_18.top * DAT_10128644);
    (**(code **)(*param_1 + 0xe0))();
    DAT_10128644 = __chkesp();
    DAT_10128650 = local_18.right - local_18.left;
    DAT_10128670 = local_18.bottom - local_18.top;
      ...
      if (DAT_10122dc4 < 0) {
        ...
        *(int *)PTR_DAT_10122e54 = *(int *)PTR_DAT_10122e58 + DAT_10128678;
        ...
        do {
          ...
          uVar7 = CONCAT22((short)((uint)iVar2 >> 0x10),DAT_1012863c);
          do {
            if (*pbVar8 < 0xfe) {
              *puVar10 = *(undefined1 *)(iVar4 + (uint)CONCAT11(*pbVar8,*puVar10));
            }
            ...
            pbVar8 = pbVar8 + (-(uint)CARRY2(uVar5,(ushort)iVar6) - uVar1);
            puVar10 = puVar10 + 1;
            iVar6 = iVar6 + -0x10000;
          } while (-1 < iVar6);
          puVar10 = puVar10 + _DAT_10128648;
          iVar2 = uVar7 + _DAT_10128628;
      ...
      *(int *)PTR_DAT_10122e54 = *(int *)PTR_DAT_10122e58 + DAT_10128678;
      ...
      do {
        ...
        do {
          ...
          uVar5 = (ushort)uVar7;
          uVar7 = CONCAT22((short)(uVar7 >> 0x10),uVar5 + (ushort)iVar6);
          pbVar8 = pbVar8 + CARRY2(uVar5,(ushort)iVar6) + uVar1;
          puVar10 = puVar10 + 1;
          iVar6 = iVar6 + -0x10000;
        } while (-1 < iVar6);
        puVar10 = puVar10 + _DAT_10128648;
