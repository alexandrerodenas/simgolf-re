...

{
  ...
  *(undefined4 *)((int)local_14 + 0x18) = 0;
  ...
  if (*(int *)((int)local_14 + 0x10) == 0) {
    *(undefined4 **)((int)local_14 + 0x10) = local_24;
    ...
    *(undefined4 *)(*(int *)((int)local_14 + 0x10) + 8) = *(undefined4 *)((int)local_14 + 0x10);
    ...
    local_24[1] = *(undefined4 *)(*(int *)((int)local_14 + 0x10) + 4);
    local_24[2] = *(undefined4 *)((int)local_14 + 0x10);
    *(undefined4 **)(*(int *)((int)local_14 + 0x10) + 4) = local_24;
    *(undefined4 **)(local_24[1] + 8) = local_24;
  }
  *(int *)((int)local_14 + 0xc) = *(int *)((int)local_14 + 0xc) + 1;
  *(undefined4 **)((int)local_14 + 0x14) = local_24;
