...
/* Function: FUN_10086f50 @ 0x10086F50 */
/* Body size: 1334 addresses */


int * __cdecl FUN_10086f50(int param_1)

{
  ...
  puVar7 = DAT_10129fdc + DAT_10129fd8 * 5;
  ...
  for (local_1c = DAT_10129fcc;
      (local_1c < puVar7 && ((local_28 & *local_1c) == 0 && (local_38 & local_1c[1]) == 0));
      local_1c = local_1c + 5) {
  }
  if (local_1c == puVar7) {
    for (local_1c = DAT_10129fdc;
        (local_1c < DAT_10129fcc && ((local_28 & *local_1c) == 0 && (local_38 & local_1c[1]) == 0));
        local_1c = local_1c + 5) {
    }
    if (local_1c == DAT_10129fcc) {
      for (; (local_1c < puVar7 && (local_1c[2] == 0)); local_1c = local_1c + 5) {
      }
      if (local_1c == puVar7) {
        for (local_1c = DAT_10129fdc; (local_1c < DAT_10129fcc && (local_1c[2] == 0));
            local_1c = local_1c + 5) {
        }
        if ((local_1c == DAT_10129fcc) && (local_1c = FUN_10087490(), local_1c == (uint *)0x0)) {
          return (int *)0x0;
        }
      }
      iVar5 = FUN_100875a0((int)local_1c);
  ...
  *(uint *)((int)piVar8 + (uVar9 - 4)) = uVar9 + 1;
  iVar5 = *piVar2;
  *piVar2 = *piVar2 + 1;
  if (((iVar5 == 0) && (local_1c == DAT_10129fd4)) && (local_34 == DAT_10129fc8)) {
    DAT_10129fd4 = (uint *)0x0;
  }
  *piVar4 = local_34;
  return piVar8 + 1;
}
