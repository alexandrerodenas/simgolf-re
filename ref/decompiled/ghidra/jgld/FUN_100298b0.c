...
/* Function: FUN_100298b0 @ 0x100298B0 */
/* Body size: 3860 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* WARNING: Restarted to delay deadcode elimination for space: stack */

void __thiscall FUN_100298b0(void *this,int *param_1,int param_2,int param_3,int param_4)

{
  ...
  if ((*(int *)((int)this + 0x14) == 0) || (param_1 == (int *)0x0)) goto LAB_1002a7ae;
  local_8 = this;
  (**(code **)(*param_1 + 0x10))();
  iVar5 = __chkesp();
  if (iVar5 == 0) goto LAB_1002a7ae;
  ...
  if (local_48 == 0) {
    ...
    if (local_48 != 1) goto LAB_1002a7ae;
    (**(code **)(*local_3c + 0x1c))();
    DAT_1012856c = __chkesp();
  }
  ...
  if (iVar5 == iVar1) {
    ...
    iVar1 = FUN_1007f370(DAT_10122dc8);
    if (iVar5 != iVar1) goto LAB_10029f06;
      ...
      if (DAT_10122dc4 < 0) {
        ...
        do {
          do {
            if (*pbVar8 != 0xff) {
              if (*pbVar8 < 0xf8) {
                *puVar10 = *(ushort *)(iVar5 + (uint)*pbVar8 * 2);
              }
              else {
                iVar4 = (uint)(byte)(*pbVar8 + 8) << 0xf;
                *puVar10 = *(ushort *)
                            (iVar1 + CONCAT22((short)((uint)iVar4 >> 0x10),(ushort)iVar4 | *puVar10)
                                     * 2);
              }
            }
            pbVar8 = pbVar8 + -1;
...
LAB_10029f06:
    ...
    iVar1 = (int)lVar11;
    lVar11 = __ftol();
    iVar3 = param_3 + (int)lVar11;
    lVar11 = __ftol();
    thunk_FUN_10008360(&local_18.left,param_2 + (int)lVar11,iVar3,iVar1,iVar5);
    local_28 = local_18.left;
    local_24 = local_18.top;
    local_20 = local_18.right;
    local_1c = local_18.bottom;
    (**(code **)(*param_1 + 0xcc))();
    pRVar2 = (RECT *)__chkesp();
    iVar5 = thunk_FUN_10008590(&local_18,&local_18,pRVar2);
    if (iVar5 == 0) {
      (**(code **)(*param_1 + 0x24))(1);
      __chkesp();
      goto LAB_1002a7ae;
    ...
    iVar5 = FUN_1007f370(DAT_10122dc0);
    _DAT_10128588 = iVar1 / iVar5;
    iVar1 = DAT_10122dc8 << 0x10;
    iVar5 = FUN_1007f370(DAT_10122dc4);
    DAT_10128540 = iVar1 / iVar5;
    if (DAT_10122dc0 < 0) {
      if (DAT_10122dc4 < 0) {
        ...
        *(int *)PTR_DAT_10122e1c = *(int *)PTR_DAT_10122e20 + DAT_1012857c;
        ...
        do {
          ...
          uVar7 = CONCAT22((short)((uint)iVar3 >> 0x10),DAT_10128554);
          do {
            if (*pbVar8 != 0xff) {
              if (*pbVar8 < 0xf8) {
                *puVar10 = *(ushort *)(iVar5 + (uint)*pbVar8 * 2);
                ...
                iVar3 = (uint)(byte)(*pbVar8 + 8) << 0xf;
                *puVar10 = *(ushort *)
                            (iVar1 + CONCAT22((short)((uint)iVar3 >> 0x10),(ushort)iVar3 | *puVar10)
                                     * 2);
              }
            }
            uVar6 = (ushort)uVar7;
            uVar7 = CONCAT22((short)(uVar7 >> 0x10),uVar6 + (ushort)iVar4);
            pbVar8 = pbVar8 + (-(uint)CARRY2(uVar6,(ushort)iVar4) - _DAT_10128580);
            puVar10 = puVar10 + 1;
            iVar4 = iVar4 + -0x10000;
          } while (-1 < iVar4);
          puVar10 = (ushort *)((int)puVar10 + _DAT_10128560);
          iVar3 = uVar7 + _DAT_10128544;
      ...
      *(int *)PTR_DAT_10122e1c = *(int *)PTR_DAT_10122e20 + DAT_1012857c;
      ...
      do {
        ...
        do {
          ...
          uVar6 = (ushort)uVar7;
          uVar7 = CONCAT22((short)(uVar7 >> 0x10),uVar6 + (ushort)iVar4);
          pbVar8 = pbVar8 + CARRY2(uVar6,(ushort)iVar4) + _DAT_10128580;
          puVar10 = puVar10 + 1;
          iVar4 = iVar4 + -0x10000;
        } while (-1 < iVar4);
        puVar10 = (ushort *)((int)puVar10 + _DAT_10128560);
