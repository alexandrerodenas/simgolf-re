...

{
  ...
  if (param_7 != (_s_CatchableType *)0x0) {
    FUN_10084990((int)param_1,(int)param_2,&param_6->adjectives,(uint *)param_7);
  }
  if (param_10 == (EHRegistrationNode *)0x0) {
    FUN_1007eb60(param_2,(PEXCEPTION_RECORD)param_1);
  }
  else {
    FUN_1007eb60(param_10,(PEXCEPTION_RECORD)param_1);
  }
  FUN_10084600((int)param_2,param_4,(int)param_5,param_8->tryLow);
  *(__ehstate_t *)(param_2 + 8) = param_8->tryHigh + 1;
  UNRECOVERED_JUMPTABLE =
       (undefined *)
       FUN_100847f0((DWORD)param_1,param_2,(DWORD)param_3,param_5,param_6->addressOfHandler,param_9,
                    0x100);
  if (UNRECOVERED_JUMPTABLE != (undefined *)0x0) {
    FUN_1007eaf0(UNRECOVERED_JUMPTABLE);
  }
  return;
}
