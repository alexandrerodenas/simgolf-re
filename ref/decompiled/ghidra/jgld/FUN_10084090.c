...
/* Function: FUN_10084090 @ 0x10084090 */
/* Body size: 239 addresses */


undefined4 __cdecl
FUN_10084090(EHExceptionRecord *param_1,EHRegistrationNode *param_2,_CONTEXT *param_3,void *param_4,
...

{
  ...
  if ((*(uint *)(param_1 + 4) & 0x66) == 0) {
    if (param_5->nTryBlocks != 0) {
      ...
      FUN_10084180(param_1,param_2,param_3,param_4,param_5,param_8,param_6,param_7);
    }
  }
  else if ((param_5->maxState != 0) && (param_6 == 0)) {
    FUN_10084600((int)param_2,param_4,(int)param_5,-1);
  }
  return 1;
}
