...
/* Function: FUN_10027430 @ 0x10027430 */
/* Body size: 3676 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* WARNING: Restarted to delay deadcode elimination for space: stack */

void __thiscall FUN_10027430(void *this,int *param_1,int param_2,int param_3,int param_4)

{
  ...
  if ((*(int *)((int)this + 0x14) == 0) || (param_1 == (int *)0x0)) goto LAB_10028276;
  local_8 = this;
  (**(code **)(*param_1 + 0x10))();
  iVar4 = __chkesp();
  if (iVar4 == 0) goto LAB_10028276;
  ...
  (**(code **)(*param_1 + 0xe4))();
  iVar4 = __chkesp();
  local_48 = *(int *)(iVar4 + 4);
  if (local_48 == 0) {
    (**(code **)(*local_3c + 0x18))();
    DAT_1012856c = __chkesp();
  }
  else {
    if (local_48 != 1) goto LAB_10028276;
    (**(code **)(*local_3c + 0x1c))();
    DAT_1012856c = __chkesp();
  }
  ...
  if (iVar4 == iVar1) {
    ...
    iVar1 = FUN_1007f370(DAT_10122dc8);
    if (iVar4 != iVar1) goto LAB_10027a26;
    ...
    if (DAT_10122dc0 < 0) {
      if (DAT_10122dc4 < 0) {
        ...
        do {
          do {
            if (*pbVar8 != 0xff) {
              *puVar10 = *(undefined2 *)(iVar4 + (uint)*(ushort *)(iVar1 + (uint)*pbVar8 * 2) * 2);
            }
            pbVar8 = pbVar8 + -1;
            puVar10 = puVar10 + 1;
            iVar3 = iVar3 + -1;
          ...
          puVar10 = (undefined2 *)((int)puVar10 + _DAT_10128560);
...
LAB_10027a26:
    ...
    lVar11 = __ftol();
    thunk_FUN_10008360(&local_18.left,param_2 + (int)lVar11,iVar3,iVar1,iVar4);
    local_28 = local_18.left;
    local_24 = local_18.top;
    local_20 = local_18.right;
    local_1c = local_18.bottom;
    (**(code **)(*param_1 + 0xcc))();
    pRVar2 = (RECT *)__chkesp();
    iVar4 = thunk_FUN_10008590(&local_18,&local_18,pRVar2);
    if (iVar4 == 0) {
      (**(code **)(*param_1 + 0x24))(1);
      __chkesp();
      goto LAB_10028276;
    ...
    (**(code **)(*param_1 + 0x20))();
    iVar4 = __chkesp();
    local_2c = (undefined2 *)(iVar4 + local_18.left * 2 + local_18.top * DAT_1012855c * 2);
    (**(code **)(*param_1 + 0xe0))();
    DAT_1012855c = __chkesp();
    DAT_10128564 = local_18.right - local_18.left;
    DAT_10128578 = local_18.bottom - local_18.top;
    ...
    iVar4 = FUN_1007f370(DAT_10122dc0);
    _DAT_10128588 = iVar1 / iVar4;
    iVar1 = DAT_10122dc8 << 0x10;
    iVar4 = FUN_1007f370(DAT_10122dc4);
    DAT_10128540 = iVar1 / iVar4;
    if (DAT_10122dc0 < 0) {
      if (DAT_10122dc4 < 0) {
        ...
        *(int *)PTR_DAT_10122e1c = *(int *)PTR_DAT_10122e20 + DAT_1012857c;
        ...
        do {
          ...
          uVar6 = CONCAT22((short)((uint)iVar3 >> 0x10),DAT_10128554);
          do {
            if (*pbVar8 != 0xff) {
              *puVar10 = *(undefined2 *)(iVar4 + (uint)*(ushort *)(iVar1 + (uint)*pbVar8 * 2) * 2);
            }
            uVar5 = (ushort)uVar6;
            uVar6 = CONCAT22((short)(uVar6 >> 0x10),uVar5 + (ushort)iVar7);
            pbVar8 = pbVar8 + (-(uint)CARRY2(uVar5,(ushort)iVar7) - _DAT_10128580);
            puVar10 = puVar10 + 1;
            iVar7 = iVar7 + -0x10000;
          } while (-1 < iVar7);
          puVar10 = (undefined2 *)((int)puVar10 + _DAT_10128560);
          iVar3 = uVar6 + _DAT_10128544;
          pbVar8 = pbVar8 + *(int *)(PTR_DAT_10122e20 + (uint)CARRY4(uVar6,_DAT_10128544) * -4);
          DAT_10128578 = DAT_10128578 + -1;
        } while (DAT_10128578 != 0);
      }
      else {
      ...
      *(int *)PTR_DAT_10122e1c = *(int *)PTR_DAT_10122e20 + DAT_1012857c;
      ...
      do {
        ...
        do {
          ...
          uVar5 = (ushort)uVar6;
          uVar6 = CONCAT22((short)(uVar6 >> 0x10),uVar5 + (ushort)iVar7);
          pbVar8 = pbVar8 + CARRY2(uVar5,(ushort)iVar7) + _DAT_10128580;
          puVar10 = puVar10 + 1;
          iVar7 = iVar7 + -0x10000;
        } while (-1 < iVar7);
        puVar10 = (undefined2 *)((int)puVar10 + _DAT_10128560);
