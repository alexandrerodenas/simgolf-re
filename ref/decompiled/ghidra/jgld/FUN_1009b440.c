...
/* Function: FUN_1009b440 @ 0x1009B440 */
/* Body size: 970 addresses */


int __cdecl
FUN_1009b440(LCID param_1,DWORD param_2,byte *param_3,int param_4,byte *param_5,int param_6,
            UINT param_7)

{
  ...
  local_1c = puVar2;
  if (0 < param_4) {
    param_4 = FUN_1009b840((char *)param_3,param_4);
  }
  if (0 < param_6) {
    param_6 = FUN_1009b840((char *)param_5,param_6);
  }
  if (DAT_10128ae4 == 2) {
    iVar3 = CompareStringA(param_1,param_2,(PCNZCH)param_3,param_4,(PCNZCH)param_5,param_6);
  }
  else if (DAT_10128ae4 == 1) {
    if (param_7 == 0) {
      param_7 = DAT_1012899c;
    }
    if ((param_4 == 0) || (param_6 == 0)) {
      ...
      if ((((param_4 != 0) || (param_6 != 1)) && ((param_4 != 1 || (param_6 != 0)))) &&
         (iVar3 = FUN_10081f90(2,0x10120790,0xb6,0,
                               (byte *)
