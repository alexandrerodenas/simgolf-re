...
/* Function: FUN_1008bb10 @ 0x1008BB10 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

bool __cdecl FUN_1008bb10(uint param_1,double *param_2,uint param_3)
    ...
    if (((param_1 & 4) == 0) || ((param_3 & 4) == 0)) {
      if (((param_1 & 1) == 0) || ((param_3 & 8) == 0)) {
        if (((param_1 & 2) != 0) && ((param_3 & 0x10) != 0)) {
          ...
          if (*param_2 == _DAT_1011d040) {
            local_c = 1;
          }
          else {
            fVar4 = FUN_1008c1a0(*(uint *)param_2,*(uint *)((int)param_2 + 4),&local_1c);
            dVar1 = (double)fVar4;
            local_18 = local_1c + -0x600;
            if (local_18 < -0x432) {
              local_14 = dVar1 * _DAT_1011d040;
              local_c = 1;
            }
            else {
        ...
        if (uVar3 < 0x801) {
          if (uVar3 == 0x800) {
            if (*param_2 <= _DAT_1011d040) {
              local_34 = -(double)CONCAT44(DAT_10125b54,DAT_10125b50);
            }
            else {
              local_34 = (double)CONCAT44(DAT_10125b44,DAT_10125b40);
            }
            ...
            *(undefined4 *)((int)param_2 + 4) = local_34._4_4_;
            ...
            if (*param_2 <= _DAT_1011d040) {
              local_2c = -(double)CONCAT44(DAT_10125b44,DAT_10125b40);
            }
            else {
              local_2c = (double)CONCAT44(DAT_10125b44,DAT_10125b40);
            }
            ...
            *(undefined4 *)((int)param_2 + 4) = local_2c._4_4_;
            ...
            if (*param_2 <= _DAT_1011d040) {
              local_3c = -(double)CONCAT44(DAT_10125b44,DAT_10125b40);
            }
            else {
              local_3c = (double)CONCAT44(DAT_10125b54,DAT_10125b50);
            }
          ...
          if (*param_2 <= _DAT_1011d040) {
            local_44 = -(double)CONCAT44(DAT_10125b54,DAT_10125b50);
          }
          else {
            local_44 = (double)CONCAT44(DAT_10125b54,DAT_10125b50);
          }
