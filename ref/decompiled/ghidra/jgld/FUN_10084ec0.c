...
/* Function: FUN_10084ec0 @ 0x10084EC0 */


void __cdecl FUN_10084ec0(LPVOID param_1)

{
  if (DAT_10123750 != 0xffffffff) {
    if (param_1 == (LPVOID)0x0) {
      param_1 = TlsGetValue(DAT_10123750);
    }
    if (param_1 != (LPVOID)0x0) {
      ...
      if (*(undefined **)((int)param_1 + 0x50) != &DAT_10125c20) {
        __free_dbg(*(void **)((int)param_1 + 0x50),2);
      }
      __free_dbg(param_1,2);
    }
    TlsSetValue(DAT_10123750,(LPVOID)0x0);
  }
  return;
}
