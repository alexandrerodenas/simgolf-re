...
/* Function: FUN_1005a790 @ 0x1005A790 */
/* Body size: 1512 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __thiscall
FUN_1005a790(void *this,int *param_1,int param_2,int param_3,int *param_4,byte param_5)
    ...
    if (local_38 != (int *)0x0) {
      ...
      *(uint *)((int)local_8 + 0x28) = (uint)*(byte *)((int)local_8 + 0x28);
      ...
      if (local_68 == 0) {
        ...
        if (local_68 != 1) goto LAB_1005ad62;
        (**(code **)(*local_38 + 0x1c))();
        DAT_10128600 = __chkesp();
      }
      ...
      if (iVar5 == iVar3) {
        ...
        if (iVar5 == iVar3) {
          ...
          if (DAT_10122dc0 < 0) {
            if (DAT_10122dc4 < 0) {
              iVar5 = FUN_10081f90(0,0x1011d610,DAT_10122e40 + 0x65,0,&DAT_1011d528);
              if (iVar5 == 1) {
                pcVar2 = (code *)swi(3);
                (*pcVar2)();
                return;
              ...
              iVar5 = FUN_10081f90(0,0x1011d610,DAT_10122e40 + 99,0,&DAT_1011d528);
              if (iVar5 == 1) {
                pcVar2 = (code *)swi(3);
                (*pcVar2)();
                return;
            ...
            iVar5 = FUN_10081f90(0,0x1011d610,DAT_10122e40 + 0x5f,0,&DAT_1011d528);
            if (iVar5 == 1) {
              pcVar2 = (code *)swi(3);
              (*pcVar2)();
              return;
            ...
            for (local_3c = 0; local_3c < DAT_101285f0; local_3c = local_3c + 1) {
              ...
              for (local_40 = 0; local_40 < local_5c; local_40 = local_40 + 1) {
                ...
                if (((bVar1 < 0xfe) && (param_5 < *(byte *)(local_30 + local_44))) &&
                   (bVar1 != 0xfe)) {
