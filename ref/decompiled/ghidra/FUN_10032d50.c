...
/* Function: FUN_10032d50 @ 0x10032D50 */
/* Body size: 3246 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined4 __thiscall FUN_10032d50(void *this,int *param_1,int param_2,int param_3)

{
  ...
  if (((DAT_100550fc ^ (int)DAT_100550fc >> 0x1f) - ((int)DAT_100550fc >> 0x1f) == iVar2) &&
    ...
    if ((int)DAT_100550fc < 0) {
      if ((int)DAT_10055100 < 0) {
        ...
        iVar2 = DAT_10057c24;
        puVar11 = (undefined2 *)(iVar5 + (DAT_10057c14 * local_1c.top + local_1c.left) * 2);
        ...
        do {
          do {
            if (((*pbVar6 != 0xff) && ((uVar8 & 1) == 0)) &&
               (((DAT_10057c30 & 1) == 0 && ((uVar8 + DAT_10057c30 & 2) == 0)))) {
              *puVar11 = *(undefined2 *)(iVar2 + (uint)*pbVar6 * 2);
            }
            pbVar6 = pbVar6 + -1;
            puVar11 = puVar11 + 1;
            uVar8 = uVar8 - 1;
    ...
    if ((int)DAT_10055100 < 0) {
      ...
      do {
        do {
          if ((((*pbVar6 != 0xff) && ((uVar8 & 1) == 0)) && ((DAT_10057c30 & 1) == 0)) &&
             ((uVar8 + DAT_10057c30 & 2) == 0)) {
            *puVar11 = *(undefined2 *)(iVar2 + (uint)*pbVar6 * 2);
          }
          pbVar6 = pbVar6 + 1;
          puVar11 = puVar11 + 1;
  ...
  puVar11 = (undefined2 *)(iVar2 + (DAT_10057c14 * local_1c.top + local_1c.left) * 2);
  DAT_10057c14 = (**(code **)(*param_1 + 0xe0))();
  DAT_10057c1c = local_1c.right - local_1c.left;
  _DAT_10057c18 = (DAT_10057c14 - DAT_10057c1c) * 2;
  DAT_10057c30 = local_1c.bottom - local_1c.top;
  ...
  if ((int)DAT_100550fc < 0) {
    if ((int)DAT_10055100 < 0) {
      ...
      *(int *)PTR_DAT_10055108 = *(int *)PTR_DAT_1005510c + DAT_10057c34;
      ...
      do {
        iVar10 = CONCAT22((short)(DAT_10057c1c >> 0x10),DAT_10057c40);
        uVar8 = CONCAT22((short)((uint)iVar5 >> 0x10),DAT_10057c0c);
        do {
          if ((((*pbVar6 != 0xff) && ((uVar8 & 1) == 0)) && ((DAT_10057c30 & 1) == 0)) &&
             ((uVar8 + DAT_10057c30 & 2) == 0)) {
            *puVar11 = *(undefined2 *)(iVar2 + (uint)*pbVar6 * 2);
          ...
          uVar7 = (ushort)uVar8;
          uVar8 = CONCAT22((short)(uVar8 >> 0x10),uVar7 + (ushort)iVar10);
          pbVar6 = pbVar6 + (-(uint)CARRY2(uVar7,(ushort)iVar10) - _DAT_10057c38);
          puVar11 = puVar11 + 1;
          iVar10 = iVar10 + -0x10000;
        } while (-1 < iVar10);
        puVar11 = (undefined2 *)((int)puVar11 + _DAT_10057c18);
        iVar5 = uVar8 + _DAT_10057bfc;
    ...
    DAT_10057c10 = (local_1c.top - iVar5) * DAT_10057bf8;
    _DAT_10057c3c = DAT_10057bf8 * DAT_10057c30 + (DAT_10057c10 & 0xffff) >> 0x10;
    iVar10 = (DAT_10057c10 >> 0x10) * DAT_10057c34;
    uVar8 = _DAT_10057c0c >> 0x10;
    _DAT_10057c28 = _DAT_10057c40 * DAT_10057c1c + (_DAT_10057c0c & 0xffff) >> 0x10;
    iVar2 = *(int *)((int)local_8 + 0x30);
    iVar5 = *(int *)((int)local_8 + 0x14);
    *(uint *)PTR_DAT_1005510c = (DAT_10057bf8 >> 0x10) * DAT_10057c34 + _DAT_10057c28;
    pbVar6 = (byte *)((iVar10 - uVar8) + iVar2 + -1 + iVar5);
    *(int *)PTR_DAT_10055108 = *(int *)PTR_DAT_1005510c + DAT_10057c34;
    iVar2 = DAT_10057c24;
    iVar5 = DAT_10057c10 << 0x10;
    DAT_10057c1c = (DAT_10057c1c + -1) * 0x10000;
    ...
    *(int *)PTR_DAT_10055108 = *(int *)PTR_DAT_1005510c + DAT_10057c34;
    ...
    do {
      ...
      do {
        ...
        uVar7 = (ushort)uVar8;
        uVar8 = CONCAT22((short)(uVar8 >> 0x10),uVar7 + (ushort)iVar10);
        pbVar6 = pbVar6 + CARRY2(uVar7,(ushort)iVar10) + _DAT_10057c38;
        puVar11 = puVar11 + 1;
        iVar10 = iVar10 + -0x10000;
      } while (-1 < iVar10);
      puVar11 = (undefined2 *)((int)puVar11 + _DAT_10057c18);
