...
/* Function: FUN_10087eb0 @ 0x10087EB0 */
/* Body size: 1565 addresses */


undefined4 FUN_10087eb0(void)

{
  ...
  BVar2 = IsBadWritePtr(DAT_10129fdc,DAT_10129fd8 * 0x14);
  if (BVar2 == 0) {
    local_140 = DAT_10129fdc;
    for (local_124 = 0; local_124 < DAT_10129fd8; local_124 = local_124 + 1) {
