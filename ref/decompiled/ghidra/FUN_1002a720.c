...
/* Function: FUN_1002a720 @ 0x1002A720 */
/* Body size: 3870 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined4 __thiscall FUN_1002a720(void *this,int *param_1,int param_2,int param_3,char param_4)
        ...
        do {
          do {
            if ((*pbVar6 != 0xff) && ((param_4 == '\0' || (*pbVar6 < 0xf8)))) {
              ...
              *puVar12 = ((ushort)(((uVar8 & 0xf81f) * 0x30 + iVar7 >> 2) + iVar7 >> 1) & 0x81f0) +
                         ((ushort)(((uVar8 & 0x7e0) * 0x30 + iVar9 >> 2) + iVar9 >> 1) & 0x7e00);
            }
            pbVar6 = pbVar6 + -1;
            puVar12 = puVar12 + 1;
            iVar5 = iVar5 + -1;
      ...
      do {
        ...
        do {
          if ((*pbVar6 != 0xff) && ((param_4 == '\0' || (*pbVar6 < 0xf8)))) {
            ...
            iVar9 = (*puVar12 & 0x7e0) * 0x10;
            *puVar12 = ((ushort)(((uVar8 & 0xf81f) * 0x30 + iVar5 >> 2) + iVar5 >> 1) & 0x81f0) +
                       ((ushort)(((uVar8 & 0x7e0) * 0x30 + iVar9 >> 2) + iVar9 >> 1) & 0x7e00);
          }
          uVar8 = (ushort)uVar11;
