...
/* Function: FUN_100470bf @ 0x100470BF */
/* Body size: 232 addresses */


uint __cdecl FUN_100470bf(char *param_1,uint param_2,uint param_3,int *param_4)
  ...
  if (pcVar6 == (char *)0x0) {
    ...
    do {
      if (((*(ushort *)(piVar1 + 3) & 0x10c) == 0) ||
        ...
        if (param_1 < param_4) {
          uVar4 = FUN_1004aa00(piVar1);
          if (uVar4 == 0xffffffff) goto LAB_1004719b;
          *pcVar5 = (char)uVar4;
          ...
          iVar3 = FUN_1004aad9(piVar1[4],pcVar5,pcVar2);
          if (iVar3 == 0) {
...
LAB_1004719b:
        ...
        FUN_1004acd0((undefined4 *)pcVar5,(undefined4 *)*piVar1,(uint)pcVar7);
