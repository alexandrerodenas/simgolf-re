...
undefined8 __cdecl
FUN_1001a6c0(double *param_1,undefined4 *param_2,int param_3,short *param_4,int param_5)

{
  ...
  while( true ) {
    while ((int)local_8 <= (int)psVar8) {
      if (param_4 == (short *)0x0) goto LAB_1001a849;
      *param_2 = local_c;
      psVar8 = local_c;
      if (bVar5) {
        param_4 = (short *)0x0;
    ...
    sVar2 = psVar8[1];
    *param_1 = (double)*psVar8 * dVar4;
    param_1[1] = (double)sVar2 * dVar3;
    iVar6 = iVar6 + -1;
    if (iVar6 == 0) break;
    param_1 = param_1 + 2;
    psVar8 = psVar8 + 2;
