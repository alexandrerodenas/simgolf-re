...
/* Function: FUN_10047148 @ 0x10047148 */
/* Body size: 520 addresses */


/* WARNING: Type propagation algorithm not settling */

int * __cdecl FUN_10047148(uint param_1)
    ...
    if (piVar7[4] != -1) {
      ...
      if (puVar8 < piVar7 + 0x806) {
        do {
          if (((int)param_1 <= (int)*puVar8) && (param_1 < puVar8[1])) {
            piVar5 = (int *)FUN_10047350(piVar4,*puVar8,param_1);
            if (piVar5 != (int *)0x0) goto LAB_10047213;
            puVar8[1] = param_1;
          }
          puVar8 = puVar8 + 2;
          piVar4 = piVar4 + 0x400;
      ...
      for (puVar8 = (uint *)(piVar7 + 6); puVar8 < puVar1; puVar8 = puVar8 + 2) {
        if (((int)param_1 <= (int)*puVar8) && (param_1 < puVar8[1])) {
          ...
          if (piVar5 != (int *)0x0) {
LAB_10047213:
            PTR_LOOP_100673f8 = (undefined *)piVar7;
    ...
    piVar7 = (int *)*piVar7;
    if (piVar7 == (int *)PTR_LOOP_100673f8) {
      ppuVar9 = &PTR_LOOP_100653d8;
      while ((ppuVar9[4] == (undefined *)0xffffffff || (ppuVar9[3] == (undefined *)0x0))) {
        ppuVar9 = (undefined **)*ppuVar9;
        if (ppuVar9 == &PTR_LOOP_100653d8) {
          ppuVar9 = FUN_10046e50();
          if (ppuVar9 == (undefined **)0x0) {
            return (int *)0x0;
          }
          piVar7 = (int *)ppuVar9[4];
          *(char *)(piVar7 + 2) = (char)param_1;
          PTR_LOOP_100673f8 = (undefined *)ppuVar9;
