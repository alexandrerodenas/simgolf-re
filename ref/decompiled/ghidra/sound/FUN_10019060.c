...
/* Function: FUN_10019060 @ 0x10019060 */
/* Body size: 736 addresses */


int __cdecl FUN_10019060(undefined4 *param_1,int *param_2,int param_3,int param_4,int param_5)
  ...
  do {
    ...
    *(short *)(local_30 + 6) = *(short *)(local_30 + 6) + (ushort)(0xffffa31e < uVar1);
    ...
    if ((int)local_8 <= (int)pbVar9) {
      if (bVar8 == 0) {
        if (!bVar3) goto LAB_100192b9;
        local_14 = local_14 + 1;
        *(undefined4 *)(local_30 + 4) = 0;
        *param_2 = (int)local_c;
        iVar7 = iVar6 + -1;
        pbVar9 = local_c;
        if (iVar6 + -1 != 0) goto LAB_10019166;
      }
      local_14 = local_14 + 1;
      *(undefined4 *)(local_30 + 4) = 0;
      *param_2 = (int)local_c;
