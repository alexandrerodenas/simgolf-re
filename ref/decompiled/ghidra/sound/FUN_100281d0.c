...
/* Function: FUN_100281d0 @ 0x100281D0 */
/* Body size: 691 addresses */


int __cdecl FUN_100281d0(undefined4 *param_1,int *param_2,int param_3,int param_4,int param_5)

{
  ...
  do {
    while( true ) {
      ...
      *puVar10 = (short)((uint)(iVar7 * local_2c) >> 0x10);
      puVar10[1] = (short)((uint)(iVar7 * local_28) >> 0x10);
      puVar10 = puVar10 + 2;
      ...
      *(short *)(local_30 + 6) = *(short *)(local_30 + 6) + (ushort)(0xffffa31e < uVar2);
      ...
      pbVar9 = local_c;
      local_c = pbVar3;
      if (iVar6 + -1 == 0) goto LAB_100283fc;
    }
    iVar7 = iVar6 + -1;
  } while (iVar6 + -1 != 0);
LAB_100283fc:
