...
/* Function: FUN_10049a92 @ 0x10049A92 */


undefined4 __cdecl FUN_10049a92(int param_1,int param_2)

{
  ...
  if (((*puVar1 & 1 << (bVar3 & 0x1f)) != 0) &&
     (iVar2 = FUN_100499f3(param_1,param_2 + 1), iVar2 == 0)) {
    local_8 = FUN_10049a3c(param_1,param_2 + -1);
  }
