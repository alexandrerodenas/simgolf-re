...
/* Function: FUN_100184a0 @ 0x100184A0 */
/* Body size: 838 addresses */


int __cdecl FUN_100184a0(double *param_1,int *param_2,int param_3,int param_4,int param_5)

{
  ...
  if (param_5 == 1) {
    ...
    if ((*(uint *)(param_4 + 0x58) & 0x20) != 0) {
      local_20 = *(undefined4 *)(param_4 + 0x1378);
      bVar6 = true;
      local_24 = (undefined4 *)(iVar10 + 0x20);
    }
  }
  else {
    local_58 = *(undefined4 *)(param_4 + 0x80);
    uStack_54 = *(undefined4 *)(param_4 + 0x84);
    local_60 = *(undefined4 *)(param_4 + 0x70);
    uStack_5c = *(undefined4 *)(param_4 + 0x74);
...
LAB_10018651:
      psVar11 = psVar11 + 1;
      if ((int)local_8 <= (int)psVar11) goto LAB_1001872b;
