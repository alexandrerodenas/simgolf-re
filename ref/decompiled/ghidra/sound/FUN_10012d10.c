...
int __thiscall FUN_10012d10(void *this,int *param_1,uint param_2,undefined4 param_3)
...
LAB_10012db1:
        ...
        if (iVar5 == 0) {
          if (iVar8 != 0) {
            ...
            if (pvVar6 != (void *)0x0) {
              pvVar2 = DAT_100b4a34;
              if ((*(byte *)((int)this + 0x6c) & 2) == 0) goto LAB_10012e45;
              goto joined_r0x10012e02;
            }
          }
          goto LAB_10012db1;
        }
...
LAB_10012e4f:
  ...
  *param_1 = (int)puVar7;
  puVar7[0x1d] = param_2;
  thunk_FUN_1000f0c0((void *)*param_1,param_3);
  *(void **)(*param_1 + 0x5c) = this;
  ...
  return iVar8;
joined_r0x10012e02:
  if (pvVar2 == (void *)0x0) goto LAB_10012e20;
  if (pvVar2 == pvVar6) {
    if (pvVar2 != (void *)0x0) {
