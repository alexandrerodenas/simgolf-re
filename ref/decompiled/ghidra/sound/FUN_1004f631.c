...
/* Function: FUN_1004f631 @ 0x1004F631 */


void __cdecl FUN_1004f631(int *param_1,int *param_2)
...
LAB_1004f6d4:
    ...
    if (((uVar6 != 0) || (piVar1 = (int *)((int)piVar1 + 1), (param_1[2] & 0x7fffffffU) != 0)) ||
      ...
      if (((uVar9 == 0) && (param_1 = (int *)((int)param_1 + 1), (param_2[2] & 0x7fffffffU) == 0))
         && ((param_2[1] == 0 && (*param_2 == 0)))) goto LAB_1004f6d4;
      local_14 = 0;
      local_8 = &local_24;
      param_2 = (int *)0x5;
      do {
        if (0 < (int)param_2) {
          ...
          local_1c = param_2;
          do {
            iVar8 = FUN_1004d099(*(uint *)(local_8 + -2),(uint)*local_c * (uint)*local_10,
                                 (uint *)(local_8 + -2));
            if (iVar8 != 0) {
              *local_8 = *local_8 + 1;
            }
...
LAB_1004f788:
        ...
        do {
          ...
          FUN_1004d118((uint *)&local_28);
          param_1 = (int *)((int)param_1 + 0xffff);
        } while (0 < (short)(ushort)param_1);
        if ((short)(ushort)param_1 < 1) goto LAB_1004f788;
      }
      ...
      if (0x7ffe < (ushort)param_1) goto LAB_1004f831;
