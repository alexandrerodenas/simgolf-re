...
/* Function: FUN_10015cf0 @ 0x10015CF0 */
/* Body size: 497 addresses */


void __cdecl
FUN_10015cf0(undefined4 *param_1,undefined4 *param_2,int param_3,int param_4,int param_5)

{
  ...
  do {
    while( true ) {
      iVar4 = iVar3;
      *piVar7 = *psVar6 * local_24;
      piVar7[1] = psVar6[1] * local_20;
      piVar7 = piVar7 + 2;
      psVar6 = psVar6 + 2;
      if ((int)psVar6 < (int)local_8) break;
      psVar1 = local_c;
      if (bVar5 == 0) {
        if (!bVar2) goto LAB_10015e70;
        *param_2 = local_c;
      }
      else {
        *param_2 = local_c;
      ...
      psVar6 = local_c;
      local_c = psVar1;
      if (iVar4 + -1 == 0) goto LAB_10015e70;
    }
    iVar3 = iVar4 + -1;
  } while (iVar4 + -1 != 0);
LAB_10015e70:
