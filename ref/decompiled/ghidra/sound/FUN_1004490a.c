...
/* Function: FUN_1004490a @ 0x1004490A */
/* Body size: 1825 addresses */


int __cdecl FUN_1004490a(int *param_1,byte *param_2,undefined4 *param_3)

{
  ...
  do {
    ...
    local_34 = (int)(char)(&DAT_1005ee38)[uVar2 * 8 + local_34] >> 4;
    switch(local_34) {
    case 0:
switchD_10044978_caseD_0:
      local_28 = 0;
      if ((PTR_DAT_1006773c[(uint)bVar9 * 2 + 1] & 0x80) != 0) {
        FUN_1004504b((int)(char)bVar9,param_1,&local_18);
        bVar9 = *param_2;
        param_2 = pbVar1 + 2;
      }
      FUN_1004504b((int)(char)bVar9,param_1,&local_18);
    ...
    case 3:
      if (bVar9 == 0x2a) {
        local_24 = FUN_100450e9((int *)&param_3);
        if (local_24 < 0) {
          local_8 = local_8 | 4;
          local_24 = -local_24;
        }
    ...
    case 5:
      if (bVar9 == 0x2a) {
        local_14 = FUN_100450e9((int *)&param_3);
        if (local_14 < 0) {
          local_14 = -1;
        }
      }
...
LAB_10044bc5:
            if ((local_8 & 0x810) == 0) {
              uVar5 = FUN_100450e9((int *)&param_3);
              local_24c[0] = (char)uVar5;
              local_10 = (undefined1 *)0x1;
            }
            else {
              uVar5 = FUN_10045106((int *)&param_3);
              local_10 = (undefined1 *)FUN_1004a2a6(local_24c,(WCHAR)uVar5);
              if ((int)local_10 < 0) {
                local_2c = 1;
              }
            }
            ...
            psVar6 = (short *)FUN_100450e9((int *)&param_3);
            if ((psVar6 == (short *)0x0) ||
               (pWVar4 = *(WCHAR **)(psVar6 + 2), pWVar4 == (WCHAR *)0x0)) {
              local_c = (WCHAR *)PTR_DAT_100651d0;
              pWVar4 = (WCHAR *)PTR_DAT_100651d0;
              goto LAB_10044d0a;
            }
            if ((local_8 & 0x800) == 0) {
              local_28 = 0;
            ...
            if (bVar9 == 99) goto LAB_10044bc5;
            if (bVar9 == 100) goto LAB_10044def;
          }
        }
        else {
LAB_10044b98:
          ...
          param_3 = param_3 + 2;
          local_c = pWVar4;
          (*(code *)PTR___fptrap_100651b8)(&local_4c,local_24c,(int)(char)bVar9,local_14,local_38);
          uVar2 = local_8 & 0x80;
          if ((uVar2 != 0) && (local_14 == 0)) {
            (*(code *)PTR___fptrap_100651c4)(local_24c);
          }
          if ((bVar9 == 0x67) && (uVar2 == 0)) {
            (*(code *)PTR___fptrap_100651bc)(local_24c);
          }
          if (local_24c[0] == '-') {
...
LAB_10044def:
          ...
          if (bVar9 == 0x6e) {
            piVar7 = (int *)FUN_100450e9((int *)&param_3);
            if ((local_8 & 0x20) == 0) {
              *piVar7 = local_18;
            }
            else {
...
LAB_10044b37:
            ...
            pWVar3 = (WCHAR *)FUN_100450e9((int *)&param_3);
            if ((local_8 & 0x810) == 0) {
              pWVar4 = pWVar3;
              if (pWVar3 == (WCHAR *)0x0) {
                pWVar3 = (WCHAR *)PTR_DAT_100651d0;
                pWVar4 = (WCHAR *)PTR_DAT_100651d0;
              }
          ...
          if (bVar9 != 0x75) {
            if (bVar9 != 0x78) goto LAB_10044f14;
            local_30 = 0x27;
            goto LAB_10044d90;
          }
        }
...
LAB_10044dfa:
        if ((local_8 & 0x8000) == 0) {
          if ((local_8 & 0x20) == 0) {
            if ((local_8 & 0x40) == 0) {
              uVar2 = FUN_100450e9((int *)&param_3);
          ...
          uVar13 = FUN_100450f6((int *)&param_3);
        }
LAB_10044e4d:
...
LAB_10044f14:
      ...
      if (local_2c == 0) {
        if ((local_8 & 0x40) != 0) {
          if ((local_8 & 0x100) == 0) {
            if ((local_8 & 1) == 0) {
              if ((local_8 & 2) == 0) goto LAB_10044f4c;
              local_1a = ' ';
            }
            else {
              local_1a = '+';
...
LAB_10044f4c:
        ...
        if ((local_8 & 0xc) == 0) {
          FUN_10045080(0x20,iVar10,param_1,&local_18);
        }
        FUN_100450b1(&local_1a,local_20,param_1,&local_18);
        if (((uVar2 & 8) != 0) && ((uVar2 & 4) == 0)) {
          FUN_10045080(0x30,iVar10,param_1,&local_18);
        }
        if ((local_28 == 0) || (puVar12 = local_10, pWVar4 = local_c, (int)local_10 < 1)) {
          FUN_100450b1((char *)local_c,(int)local_10,param_1,&local_18);
        }
        else {
          do {
            puVar12 = puVar12 + -1;
            iVar8 = FUN_1004a2a6(local_3c,*pWVar4);
            if (iVar8 < 1) break;
            FUN_100450b1(local_3c,iVar8,param_1,&local_18);
            pWVar4 = pWVar4 + 1;
