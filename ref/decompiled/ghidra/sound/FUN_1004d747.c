...
/* Function: FUN_1004d747 @ 0x1004D747 */
/* Body size: 659 addresses */


undefined4 __cdecl
FUN_1004d747(uint param_1,uint param_2,uint param_3,int param_4,byte param_5,short *param_6)
      ...
      *param_6 = 1;
      if (((param_2 == 0x80000000) && (param_1 == 0)) || ((param_2 & 0x40000000) != 0)) {
        if (((param_3 & 0x8000) == 0) || (param_2 != 0xc0000000)) {
          if ((param_2 != 0x80000000) || (param_1 != 0)) goto LAB_1004d83c;
          pcVar11 = "1#INF";
        }
        else {
          if (param_1 != 0) {
LAB_1004d83c:
        ...
        FUN_1004a010((uint *)(param_6 + 2),(uint *)pcVar11);
...
LAB_1004d841:
    ...
    local_e = param_2;
    local_12 = param_1;
    FUN_1004f851((int *)&local_14,-(int)sVar8,1);
    if (0x3ffe < CONCAT11(cStack_9,local_a)) {
      sVar8 = sVar8 + 1;
      FUN_1004f631((int *)&local_14,(int *)&local_20);
    }
    *psVar3 = sVar8;
    iVar10 = param_4;
    if (((param_5 & 1) == 0) || (iVar10 = param_4 + sVar8, 0 < param_4 + sVar8)) {
      ...
      if ('4' < *(char *)((int)psVar6 + -1)) {
        for (; psVar1 <= psVar7; psVar7 = (short *)((int)psVar7 + -1)) {
          if ((char)*psVar7 != '9') {
            if (psVar1 <= psVar7) goto LAB_1004d999;
            break;
          }
          *(char *)psVar7 = '0';
        }
...
LAB_1004d99b:
      ...
      for (; psVar1 <= psVar7; psVar7 = (short *)((int)psVar7 + -1)) {
        if ((char)*psVar7 != '0') {
          if (psVar1 <= psVar7) goto LAB_1004d99b;
          break;
        }
      }
      *psVar3 = 0;
