...
/* Function: FUN_10028b70 @ 0x10028B70 */
/* Body size: 574 addresses */


LRESULT FUN_10028b70(HWND param_1,uint param_2,LPWAVEHDR param_3,int *param_4)

{
  ...
  LVar3 = CallWindowProcA(DAT_100b49c4,param_1,param_2,(WPARAM)param_3,(LPARAM)param_4);
  return LVar3;
}
