...
/* Function: FUN_10025190 @ 0x10025190 */


int __cdecl FUN_10025190(undefined4 *param_1,int *param_2,int param_3,int param_4,int param_5)
    ...
    while( true ) {
      do {
        ...
        *(short *)(local_2c + 6) = *(short *)(local_2c + 6) + (ushort)CARRY4(uVar6,local_28);
        ...
        uVar14 = paddsw(uVar14,*puVar12);
        *puVar12 = uVar14;
        puVar12 = (undefined8 *)((int)puVar12 + local_20);
        if (iVar8 < 1) goto LAB_10025524;
        iVar7 = iVar8;
