...
/* Function: FUN_10041700 @ 0x10041700 */


void * __thiscall FUN_10041700(void *this,int param_1)
  ...
  if (iVar3 != 0) {
    if (param_1 != 0) {
      ...
      if ((uVar1 & 0x60) == 0) {
        ...
        if ((uVar1 & 0x40) == 0) {
          local_c._0_3_ = CONCAT12(0x6f,(undefined2)local_c);
        }
        else {
          bVar2 = ~(byte)(uVar1 >> 4);
          local_c = CONCAT13(local_c._3_1_,CONCAT12(bVar2,(undefined2)local_c)) & 0xff20ffff |
                    0x580000;
