...
/* Function: FUN_10032130 @ 0x10032130 */


undefined4 __thiscall FUN_10032130(void *this,HPSTR param_1)

{
  ...
  if (param_1 != (HPSTR)0x0) {
    ...
    iVar2 = thunk_FUN_10012fe0(param_1,piVar1,(undefined4 *)((int)this + 0x180),0x100e0,
                               *(undefined4 *)((int)this + 0x178));
    if (iVar2 != 0) {
      return 0x11;
    }
    *(uint *)((int)this + 0x58) = *(uint *)((int)this + 0x58) | 0x10000000;
    iVar2 = thunk_FUN_100101a0((void *)*piVar1,0,*(undefined4 *)((int)this + 0x178),&param_1,
                               &local_c,&local_4,&local_8);
