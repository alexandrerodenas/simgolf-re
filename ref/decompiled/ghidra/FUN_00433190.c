...
LAB_00433506:
    ...
    uVar10 = 0xffffffff;
    do {
      ppuVar15 = (undefined **)pcVar8;
      if (uVar10 == 0) break;
      uVar10 = uVar10 - 1;
      ppuVar15 = (undefined **)((int)pcVar8 + 1);
      cVar2 = *pcVar8;
      pcVar8 = (char *)ppuVar15;
    } while (cVar2 != '\0');
    uVar10 = ~uVar10;
    iVar13 = -1;
    pcVar8 = (char *)&DAT_0051a068;
    ...
    pcVar8 = (char *)((int)ppuVar15 - uVar10);
    pcVar16 = pcVar16 + -1;
    for (uVar11 = uVar10 >> 2; uVar11 != 0; uVar11 = uVar11 - 1) {
      *(undefined4 *)pcVar16 = *(undefined4 *)pcVar8;
      pcVar8 = pcVar8 + 4;
  ...
  if (iVar5 == 0x15) {
    ...
    uVar19 = 0xf6;
LAB_00433702:
    FUN_00473cb0(PTR_DAT_004c1570,uVar19,uVar20,1,1,1,0);
  }
  else if (iVar5 == 0x16) {
    uVar20 = 0x1fe;
    uVar19 = 0xdc;
...
LAB_00433a1b:
  ...
  case 2:
    uVar10 = 0xffffffff;
    ppuVar15 = &PTR_DAT_004c7f6c;
    do {
      ppuVar17 = ppuVar15;
      if (uVar10 == 0) break;
      uVar10 = uVar10 - 1;
      ppuVar17 = (undefined **)((int)ppuVar15 + 1);
      cVar2 = *(char *)ppuVar15;
      ppuVar15 = ppuVar17;
    } while (cVar2 != '\0');
    uVar10 = ~uVar10;
    ...
    pcVar8 = (char *)((int)ppuVar17 - uVar10);
    pcVar16 = pcVar16 + -1;
    for (uVar11 = uVar10 >> 2; uVar11 != 0; uVar11 = uVar11 - 1) {
      *(undefined4 *)pcVar16 = *(undefined4 *)pcVar8;
      pcVar8 = pcVar8 + 4;
