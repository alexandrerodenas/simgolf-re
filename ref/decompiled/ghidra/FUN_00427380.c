...

{
  ...
  if ((_DAT_0059e7b8 & 0x200000) == 0) {
    if ((DAT_005a6d3c == 0) && (DAT_00584210 == 0)) {
    ...
    *(int *)(&DAT_00575ca4 + (char)(&DAT_005794d9)[iVar19] * 0x208) =
    ...
    (&DAT_00584210)[((int)DAT_005a6d3c % 100) * 10] =
         (&DAT_00584210)[((int)DAT_005a6d3c % 100) * 10] + (short)iVar6;
      ...
      if (((&DAT_005794d1)[iVar6] & 0xf0) != 0) {
        if (((char)(&DAT_005794d9)[iVar19] < (char)(&DAT_005794d9)[iVar6]) ||
          ...
          if ((&DAT_00575cb8)[(char)(&DAT_005794d9)[iVar19] * 0x208] == '\0') {
            ...
            if (((&DAT_005794d1)[iVar6] & 0xf0) != 0) {
              local_18 = (short)iVar12;
              if (((param_1 == uVar11) && (local_20 < local_1c)) ||
                 ((param_1 == uVar13 && (local_1c < local_20)))) {
                ...
                *(short *)(&DAT_0058421e + (iVar20 % 100) * 0x14) =
                     *(short *)(&DAT_0058421e + (iVar20 % 100) * 0x14) - local_18;
                FUN_004481b0(0x24,100,0,0,0);
              ...
              if (((param_1 == uVar11) && (local_1c < local_20)) ||
                 ((param_1 == uVar13 && (local_20 < local_1c)))) {
                DAT_00571fd4 = DAT_00571fd4 + iVar12;
                FUN_0040c890(iVar12,(&DAT_005794b8)[param_1 * 0x40],(&DAT_005794bc)[param_1 * 0x40],
                             0xffffffff);
                uVar14 = 0xffffffff;
                *(short *)(&DAT_0058421e + ((int)DAT_005a6d3c % 100) * 0x14) =
                     *(short *)(&DAT_0058421e + ((int)DAT_005a6d3c % 100) * 0x14) + local_18;
            ...
            if (local_20 == local_1c) {
              ...
              if (local_20 == local_14) {
                ...
                uVar11 = local_20 - local_14 >> 0x1f;
                pcVar7 = (char *)FUN_004ad425((local_20 - local_14 ^ uVar11) - uVar11,&DAT_0058a528,
                                              10);
                uVar11 = 0xffffffff;
                do {
                  pcVar9 = pcVar7;
              ...
              uVar13 = local_20 - local_1c >> 0x1f;
              iVar6 = (local_20 - local_1c ^ uVar13) - uVar13;
              for (uVar11 = uVar11 & 3; uVar11 != 0; uVar11 = uVar11 - 1) {
                *pcVar9 = *pcVar7;
                pcVar7 = pcVar7 + 1;
                pcVar9 = pcVar9 + 1;
    ...
    if (((_DAT_0059e7b8 & 0x200000) == 0) &&
      ...
      do {
        if (cVar18 < iVar6) {
          ...
          local_10 = local_10 + iVar20;
          local_14 = local_14 + *pcVar7;
          local_20 = local_20 + (iVar20 - *pcVar7);
          local_1c = local_1c +
...
LAB_004284aa:
      if ((((2 < DAT_005685f0) && ((&DAT_005794dc)[iVar19] != '\0')) && (DAT_004c2e0c == 0xffffffff)
          ) && (((bVar4 && ((DAT_0056a524 == 0 || (iVar12 < DAT_0056a524)))) && (iVar12 <= local_14)
                ))) {
        DAT_004c2e0c = param_1 | 0x100;
        FUN_004676e0(param_1,0);
        FUN_0045b8b0(0x14);
      ...
      iVar20 = iVar12 * 0x2c;
      if ((local_10 < (int)(uint)*(byte *)(&DAT_005849e0 + iVar12 * 0xb)) ||
         (*(byte *)(&DAT_005849e0 + iVar12 * 0xb) == 0)) {
        *(char *)(&DAT_005849e0 + iVar12 * 0xb) = (char)local_10;
      }
      iVar12 = DAT_005685f0;
      ...
      if (cVar18 == '\0') {
        ...
        local_20._0_1_ = (undefined1)((cVar18 + local_20) / 2);
      }
      *(undefined1 *)((int)&DAT_005849e0 + iVar20 + 1) = (undefined1)local_20;
      if (((((*(byte *)(iVar20 + 0x5849e2 + iVar12) & 3) != 0) || (iVar6 == 0)) ||
          (DAT_005a6d3c == 0)) || ((DAT_00571fd4 < 200 && (DAT_0056d1b0 < 1)))) {
        local_1c = local_1c + 1;
      }
      if (DAT_00543cc4 != 0) {
        local_1c = local_1c + DAT_00543cc4;
      }
      if ((((&DAT_005794d0)[iVar19] == '\0') &&
          (bVar5 = *(byte *)((int)&DAT_005849e0 + iVar20 + 2), 1 << (bVar5 & 7) <= local_1c)) &&
         ((bVar5 & 7) < 5)) {
  ...
  if ((uVar11 & 0x4200000) == 0) {
    if (((*(char *)(&DAT_00575ab0 + cVar18 * 0x82) == '\0') ||
