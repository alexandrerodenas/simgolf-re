...
/* Function: FUN_1001df80 @ 0x1001DF80 */
/* Body size: 2029 addresses */
...
void __thiscall
FUN_1001df80(void *this,int *param_1,int param_2,int param_3,int *param_4,byte param_5,
            undefined2 param_6)

{
  ...
  if ((*(int *)((int)this + 0x14) == 0) || (param_1 == (int *)0x0)) goto LAB_1001e757;
  local_8 = this;
  (**(code **)(*param_1 + 0x10))();
  iVar3 = __chkesp();
  if (iVar3 == 0) goto LAB_1001e757;
  if (param_4 != (int *)0x0) {
    (**(code **)(*param_4 + 0x10))();
    iVar3 = __chkesp();
    if (iVar3 != 0) {
      ...
      if (local_44 == 0) {
        ...
        if (local_44 != 1) goto LAB_1001e757;
        (**(code **)(*local_38 + 0x1c))();
        DAT_1012856c = __chkesp();
      }
      ...
      if (iVar3 == iVar2) {
        ...
        iVar2 = FUN_1007f370(DAT_10122dc8);
        if (iVar3 != iVar2) goto LAB_1001e6fd;
