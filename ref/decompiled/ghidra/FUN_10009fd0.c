...
/* Body size: 332 addresses */


void FUN_10009fd0(int *param_1,int param_2,int param_3)

{
  ...
  (**(code **)(*local_14 + 0xe8))();
  iVar1 = __chkesp();
  local_68 = thunk_FUN_10015480(local_64,param_1,param_2,param_3,iVar1);
  ...
  ExceptionList = local_10;
  puStack_c = (undefined1 *)0x1000a116;
  __chkesp();
  return;
}
