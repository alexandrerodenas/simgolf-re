...
/* Function: FUN_100240b0 @ 0x100240B0 */
/* Body size: 3630 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined4 __thiscall FUN_100240b0(void *this,int *param_1,int param_2,int param_3,char param_4)
    ...
    if ((int)DAT_100550fc < 0) {
        ...
        do {
          do {
            if ((*pbVar6 != 0xff) && ((param_4 == '\0' || (*pbVar6 < 0xf8)))) {
              ...
              *puVar11 = ((ushort)((uVar7 & 0xf81f) * 0x10 + (*puVar11 & 0xf81f) * 0x10 >> 1) &
                         0x81f0) + ((ushort)((uVar7 & 0x7e0) * 0x10 + (*puVar11 & 0x7e0) * 0x10 >> 1
                                            ) & 0x7e00);
            }
            pbVar6 = pbVar6 + -1;
            puVar11 = puVar11 + 1;
      ...
      do {
        do {
          if ((*pbVar6 != 0xff) && ((param_4 == '\0' || (*pbVar6 < 0xf8)))) {
            uVar7 = *(ushort *)(iVar2 + (uint)*pbVar6 * 2);
            *puVar11 = ((ushort)((uVar7 & 0xf81f) * 0x10 + (*puVar11 & 0xf81f) * 0x10 >> 1) & 0x81f0
                       ) + ((ushort)((uVar7 & 0x7e0) * 0x10 + (*puVar11 & 0x7e0) * 0x10 >> 1) &
                           0x7e00);
          }
          pbVar6 = pbVar6 + -1;
          puVar11 = puVar11 + 1;
    ...
    do {
      do {
        if ((*pbVar6 != 0xff) && ((param_4 == '\0' || (*pbVar6 < 0xf8)))) {
          uVar7 = *(ushort *)(iVar2 + (uint)*pbVar6 * 2);
          *puVar11 = ((ushort)((uVar7 & 0xf81f) * 0x10 + (*puVar11 & 0xf81f) * 0x10 >> 1) & 0x81f0)
                     + ((ushort)((uVar7 & 0x7e0) * 0x10 + (*puVar11 & 0x7e0) * 0x10 >> 1) & 0x7e00);
        }
        pbVar6 = pbVar6 + 1;
        puVar11 = puVar11 + 1;
        iVar5 = iVar5 + -1;
