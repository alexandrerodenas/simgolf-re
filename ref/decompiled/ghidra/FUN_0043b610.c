...
LAB_0043c7ab:
    ...
    switch(iVar12) {
    case 0:
      goto code_r0x0043c8eb;
    case 1:
      _DAT_0059e7b8 = local_9ec;
...
code_r0x0043ca36:
        ...
        goto code_r0x0043ca3b;
      }
      if (bVar2 == 0) break;
      bVar2 = pbVar7[1];
      bVar17 = bVar2 < pbVar14[1];
      if (bVar2 != pbVar14[1]) goto code_r0x0043ca36;
      pbVar7 = pbVar7 + 2;
      pbVar14 = pbVar14 + 2;
    } while (bVar2 != 0);
    iVar3 = 0;
