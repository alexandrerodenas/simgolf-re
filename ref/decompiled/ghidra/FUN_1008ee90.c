...
/* Function: FUN_1008ee90 @ 0x1008EE90 */
/* Body size: 578 addresses */


undefined4 __cdecl FUN_1008ee90(ushort *param_1,uint *param_2,int *param_3)

{
  ...
  if (local_8 == -0x3fff) {
    ...
    iVar1 = FUN_1008ec00((int)&local_1c,param_3[2]);
    if (iVar1 != 0) {
      local_8 = local_8 + 1;
    }
    if (local_8 < param_3[1] - param_3[2]) {
      ...
      FUN_1008ec00((int)&local_1c,param_3[2]);
