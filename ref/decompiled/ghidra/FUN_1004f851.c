...
/* Function: FUN_1004f851 @ 0x1004F851 */
/* Body size: 124 addresses */


void __cdecl FUN_1004f851(int *param_1,uint param_2,int param_3)

{
  ...
  ppuVar3 = &PTR_s_November_10068550;
  if (param_2 != 0) {
    if ((int)param_2 < 0) {
      param_2 = -param_2;
      ppuVar3 = (undefined **)0x100686b0;
    }
    if (param_3 == 0) {
    ...
    while (param_2 != 0) {
      ...
      if (uVar2 != 0) {
        ...
        FUN_1004f631(param_1,(int *)ppuVar4);
      }
    }
  }
  return;
