...
/* Function: FUN_1000e920 @ 0x1000E920 */
/* Body size: 4142 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* WARNING: Restarted to delay deadcode elimination for space: stack */

undefined4 __thiscall FUN_1000e920(void *this,int *param_1,int param_2,int param_3,ushort param_4)

{
  ...
  if (((DAT_100550fc ^ (int)DAT_100550fc >> 0x1f) - ((int)DAT_100550fc >> 0x1f) == iVar2) &&
    ...
    if ((int)DAT_100550fc < 0) {
      if ((int)DAT_10055100 < 0) {
        ...
        iVar2 = DAT_10057c24;
        puVar15 = (ushort *)(iVar5 + (DAT_10057c14 * local_1c.top + local_1c.left) * 2);
        ...
        do {
          do {
            if ((*pbVar6 != 0xff) && (*pbVar6 < 0xf8)) {
              uVar7 = *(ushort *)(iVar2 + (uint)*pbVar6 * 2);
              uVar14 = CONCAT22(param_4,uVar7) & 0xffff83ff;
              uVar10 = (ushort)uVar14;
              uVar12 = (ushort)(uVar14 >> 0x10);
              uVar14 = CONCAT22(uVar12,uVar10 | (((uVar7 & 0x7c00) >> 0xb) +
                                                ((param_4 & 0x7c00) >> 0xb)) * 0x400) & 0xfffffc1f;
              uVar7 = (ushort)uVar14;
              uVar13 = (ushort)(uVar14 >> 0x10);
              uVar14 = CONCAT22(uVar13,uVar7 | (((uVar10 & 0x3e0) >> 6) + ((uVar12 & 0x3e0) >> 6)) *
                                               0x20) & 0xffffffe0;
              param_4 = (ushort)(uVar14 >> 0x10);
              *puVar15 = (ushort)uVar14 | ((uVar7 & 0x1f) >> 1) + ((uVar13 & 0x1f) >> 1);
            }
            pbVar6 = pbVar6 + -1;
            puVar15 = puVar15 + 1;
            iVar5 = iVar5 + -1;
          ...
          puVar15 = (ushort *)((int)puVar15 + _DAT_10057c18);
    ...
    do {
      do {
        if ((*pbVar6 != 0xff) && (*pbVar6 < 0xf8)) {
          ...
          uVar10 = (ushort)uVar14;
          uVar12 = (ushort)(uVar14 >> 0x10);
          uVar14 = CONCAT22(uVar12,uVar10 | (((uVar7 & 0x7c00) >> 0xb) + ((param_4 & 0x7c00) >> 0xb)
                                            ) * 0x400) & 0xfffffc1f;
          uVar7 = (ushort)uVar14;
          uVar13 = (ushort)(uVar14 >> 0x10);
          uVar14 = CONCAT22(uVar13,uVar7 | (((uVar10 & 0x3e0) >> 6) + ((uVar12 & 0x3e0) >> 6)) *
  ...
  lVar16 = __ftol();
  iVar5 = (int)lVar16 + param_3;
  lVar16 = __ftol();
  iVar2 = (int)lVar16 + param_2;
  local_1c.left = iVar2;
  local_1c.top = iVar5;
  lVar16 = __ftol();
  local_1c.right = (int)lVar16 + iVar2;
  lVar16 = __ftol();
  LVar1 = local_1c.left;
  local_1c.bottom = (int)lVar16 + iVar5;
  pRVar3 = (RECT *)(**(code **)(*param_1 + 0xcc))();
  BVar4 = IntersectRect(&local_1c,&local_1c,pRVar3);
  if (BVar4 == 0) {
    (**(code **)(*param_1 + 0x24))(1);
  ...
  puVar15 = (ushort *)(iVar2 + (DAT_10057c14 * local_1c.top + local_1c.left) * 2);
  DAT_10057c14 = (**(code **)(*param_1 + 0xe0))();
  DAT_10057c1c = local_1c.right - local_1c.left;
  _DAT_10057c18 = (DAT_10057c14 - DAT_10057c1c) * 2;
  DAT_10057c30 = local_1c.bottom - local_1c.top;
  ...
  if ((int)DAT_100550fc < 0) {
    if ((int)DAT_10055100 < 0) {
      ...
      *(int *)PTR_DAT_10055108 = *(int *)PTR_DAT_1005510c + DAT_10057c34;
      ...
      do {
        ...
        uVar14 = CONCAT22((short)((uint)iVar5 >> 0x10),DAT_10057c0c);
        do {
          if ((*pbVar6 != 0xff) && (*pbVar6 < 0xf8)) {
            uVar7 = *(ushort *)(iVar2 + (uint)*pbVar6 * 2);
            uVar11 = CONCAT22(param_4,uVar7) & 0xffff83ff;
            uVar10 = (ushort)uVar11;
            uVar12 = (ushort)(uVar11 >> 0x10);
            uVar11 = CONCAT22(uVar12,uVar10 | (((uVar7 & 0x7c00) >> 0xb) +
                                              ((param_4 & 0x7c00) >> 0xb)) * 0x400) & 0xfffffc1f;
            uVar7 = (ushort)uVar11;
            uVar13 = (ushort)(uVar11 >> 0x10);
            uVar11 = CONCAT22(uVar13,uVar7 | (((uVar10 & 0x3e0) >> 6) + ((uVar12 & 0x3e0) >> 6)) *
                                             0x20) & 0xffffffe0;
            param_4 = (ushort)(uVar11 >> 0x10);
            *puVar15 = (ushort)uVar11 | ((uVar7 & 0x1f) >> 1) + ((uVar13 & 0x1f) >> 1);
          }
          uVar7 = (ushort)uVar14;
          uVar14 = CONCAT22((short)(uVar14 >> 0x10),uVar7 + (ushort)iVar9);
          pbVar6 = pbVar6 + (-(uint)CARRY2(uVar7,(ushort)iVar9) - _DAT_10057c38);
          puVar15 = puVar15 + 1;
          iVar9 = iVar9 + -0x10000;
        } while (-1 < iVar9);
        puVar15 = (ushort *)((int)puVar15 + _DAT_10057c18);
        iVar5 = uVar14 + _DAT_10057bfc;
        pbVar6 = pbVar6 + *(int *)(PTR_DAT_1005510c + (uint)CARRY4(uVar14,_DAT_10057bfc) * -4);
        DAT_10057c30 = DAT_10057c30 + -1;
      } while (DAT_10057c30 != 0);
      (**(code **)(*param_1 + 0x24))(2);
      return 0;
    ...
    uVar14 = _DAT_10057c0c >> 0x10;
    _DAT_10057c28 = _DAT_10057c40 * DAT_10057c1c + (_DAT_10057c0c & 0xffff) >> 0x10;
    iVar2 = *(int *)((int)local_8 + 0x30);
    iVar5 = *(int *)((int)local_8 + 0x14);
    *(uint *)PTR_DAT_1005510c = (DAT_10057bf8 >> 0x10) * DAT_10057c34 + _DAT_10057c28;
    pbVar6 = (byte *)((iVar9 - uVar14) + iVar2 + -1 + iVar5);
    *(int *)PTR_DAT_10055108 = *(int *)PTR_DAT_1005510c + DAT_10057c34;
    iVar2 = DAT_10057c24;
    iVar5 = DAT_10057c10 << 0x10;
    DAT_10057c1c = (DAT_10057c1c + -1) * 0x10000;
    ...
    do {
      ...
      do {
        if ((*pbVar6 != 0xff) && (*pbVar6 < 0xf8)) {
          ...
          uVar10 = (ushort)uVar11;
          uVar12 = (ushort)(uVar11 >> 0x10);
          uVar11 = CONCAT22(uVar12,uVar10 | (((uVar7 & 0x7c00) >> 0xb) + ((param_4 & 0x7c00) >> 0xb)
                                            ) * 0x400) & 0xfffffc1f;
          uVar7 = (ushort)uVar11;
          uVar13 = (ushort)(uVar11 >> 0x10);
          uVar11 = CONCAT22(uVar13,uVar7 | (((uVar10 & 0x3e0) >> 6) + ((uVar12 & 0x3e0) >> 6)) *
  ...
  if ((int)DAT_10055100 < 0) {
    ...
    *(uint *)PTR_DAT_1005510c = (DAT_10057bf8 >> 0x10) * DAT_10057c34 + _DAT_10057c28;
    pbVar6 = (byte *)(iVar5 + uVar14 + iVar2);
    *(int *)PTR_DAT_10055108 = *(int *)PTR_DAT_1005510c + DAT_10057c34;
    iVar2 = DAT_10057c24;
    iVar5 = DAT_10057c10 << 0x10;
    DAT_10057c1c = (DAT_10057c1c + -1) * 0x10000;
  ...
  do {
    ...
    do {
      if ((*pbVar6 != 0xff) && (*pbVar6 < 0xf8)) {
        ...
        uVar7 = (ushort)uVar11;
        uVar13 = (ushort)(uVar11 >> 0x10);
        uVar11 = CONCAT22(uVar13,uVar7 | (((uVar10 & 0x3e0) >> 6) + ((uVar12 & 0x3e0) >> 6)) * 0x20)
                 & 0xffffffe0;
        param_4 = (ushort)(uVar11 >> 0x10);
        *puVar15 = (ushort)uVar11 | ((uVar7 & 0x1f) >> 1) + ((uVar13 & 0x1f) >> 1);
      }
