...
/* Function: FUN_100576a0 @ 0x100576A0 */
/* Body size: 3850 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __thiscall FUN_100576a0(void *this,int *param_1,int param_2,int param_3)

{
  ...
  if ((*(int *)((int)this + 0x14) == 0) || (param_1 == (int *)0x0)) goto LAB_10058594;
  local_8 = this;
  (**(code **)(*param_1 + 0x10))();
  iVar3 = __chkesp();
  if (iVar3 == 0) goto LAB_10058594;
  ...
  if (iVar3 == iVar1) {
    ...
    iVar1 = FUN_1007f370(DAT_10122dc8);
    if (iVar3 != iVar1) goto LAB_10057cf8;
    ...
    if (DAT_10122dc0 < 0) {
      if (DAT_10122dc4 < 0) {
        ...
        iVar1 = __chkesp();
        iVar3 = DAT_1012856c;
        local_2c = (undefined2 *)(iVar1 + local_18.left * 2 + local_18.top * DAT_1012855c * 2);
        ...
        do {
          do {
            if (((*pbVar7 != 0xff) && ((uVar5 & 1) == 0)) &&
               (((DAT_10128578 & 1) == 0 && ((uVar5 + DAT_10128578 & 2) == 0)))) {
              *puVar9 = *(undefined2 *)(iVar3 + (uint)*pbVar7 * 2);
            }
            pbVar7 = pbVar7 + -1;
            puVar9 = puVar9 + 1;
            uVar5 = uVar5 - 1;
          ...
          puVar9 = (undefined2 *)((int)puVar9 + _DAT_10128560);
      ...
      do {
        do {
          if ((((*pbVar7 != 0xff) && ((uVar5 & 1) == 0)) && ((DAT_10128578 & 1) == 0)) &&
             ((uVar5 + DAT_10128578 & 2) == 0)) {
            *puVar9 = *(undefined2 *)(iVar3 + (uint)*pbVar7 * 2);
          }
          pbVar7 = pbVar7 + 1;
          puVar9 = puVar9 + 1;
...
LAB_10057cf8:
    ...
    lVar10 = __ftol();
    thunk_FUN_10008360(&local_18.left,param_2 + (int)lVar10,iVar6,iVar1,iVar3);
    local_28 = local_18.left;
    local_24 = local_18.top;
    local_20 = local_18.right;
    local_1c = local_18.bottom;
    ...
    if (DAT_10122dc0 < 0) {
      if (DAT_10122dc4 < 0) {
        ...
        *(int *)PTR_DAT_10122e1c = *(int *)PTR_DAT_10122e20 + DAT_1012857c;
        ...
        puVar9 = local_2c;
        do {
          iVar6 = CONCAT22((short)(DAT_10128564 >> 0x10),DAT_10128588);
          uVar5 = CONCAT22((short)((uint)iVar1 >> 0x10),DAT_10128554);
          do {
            if ((((*pbVar7 != 0xff) && ((uVar5 & 1) == 0)) && ((DAT_10128578 & 1) == 0)) &&
               ((uVar5 + DAT_10128578 & 2) == 0)) {
              *puVar9 = *(undefined2 *)(iVar3 + (uint)*pbVar7 * 2);
            ...
            uVar4 = (ushort)uVar5;
            uVar5 = CONCAT22((short)(uVar5 >> 0x10),uVar4 + (ushort)iVar6);
            pbVar7 = pbVar7 + (-(uint)CARRY2(uVar4,(ushort)iVar6) - _DAT_10128580);
            puVar9 = puVar9 + 1;
            iVar6 = iVar6 + -0x10000;
          } while (-1 < iVar6);
          puVar9 = (undefined2 *)((int)puVar9 + _DAT_10128560);
          iVar1 = uVar5 + _DAT_10128544;
          pbVar7 = pbVar7 + *(int *)(PTR_DAT_10122e20 + (uint)CARRY4(uVar5,_DAT_10128544) * -4);
          DAT_10128578 = DAT_10128578 - 1;
        } while (DAT_10128578 != 0);
      }
      else {
      ...
      *(int *)PTR_DAT_10122e1c = *(int *)PTR_DAT_10122e20 + DAT_1012857c;
      ...
      do {
        ...
        do {
          ...
          uVar4 = (ushort)uVar5;
          uVar5 = CONCAT22((short)(uVar5 >> 0x10),uVar4 + (ushort)iVar6);
          pbVar7 = pbVar7 + CARRY2(uVar4,(ushort)iVar6) + _DAT_10128580;
          puVar9 = puVar9 + 1;
          iVar6 = iVar6 + -0x10000;
        } while (-1 < iVar6);
        puVar9 = (undefined2 *)((int)puVar9 + _DAT_10128560);
