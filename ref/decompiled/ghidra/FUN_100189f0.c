...
/* Function: FUN_100189f0 @ 0x100189F0 */
/* Body size: 3814 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined4 __thiscall FUN_100189f0(void *this,int *param_1,int param_2,int param_3,char param_4)
        ...
        do {
          do {
            if ((*pbVar6 != 0xff) && ((param_4 == '\0' || (*pbVar6 < 0xf8)))) {
              ...
              iVar7 = (*puVar12 & 0x7c1f) * 0x10;
              iVar9 = (*puVar12 & 0x3e0) * 0x10;
              *puVar12 = (ushort)(((((uVar8 & 0x7c1f) * 0x10 + iVar7 >> 1) + iVar7 >> 1) + iVar7 >>
                                   1 & 0x7c1f0) +
                                  ((((uVar8 & 0x3e0) * 0x10 + iVar9 >> 1) + iVar9 >> 1) + iVar9 >> 1
                                  & 0x3e00) >> 4);
            }
            pbVar6 = pbVar6 + -1;
            puVar12 = puVar12 + 1;
      ...
      do {
        do {
          if ((*pbVar6 != 0xff) && ((param_4 == '\0' || (*pbVar6 < 0xf8)))) {
            ...
            iVar7 = (*puVar12 & 0x7c1f) * 0x10;
            iVar9 = (*puVar12 & 0x3e0) * 0x10;
            *puVar12 = (ushort)(((((uVar8 & 0x7c1f) * 0x10 + iVar7 >> 1) + iVar7 >> 1) + iVar7 >> 1
                                & 0x7c1f0) +
                                ((((uVar8 & 0x3e0) * 0x10 + iVar9 >> 1) + iVar9 >> 1) + iVar9 >> 1 &
                                0x3e00) >> 4);
          }
      ...
      *(int *)PTR_DAT_10055108 = *(int *)PTR_DAT_1005510c + DAT_10057c34;
      ...
      do {
        ...
        do {
          if ((*pbVar6 != 0xff) && ((param_4 == '\0' || (*pbVar6 < 0xf8)))) {
            uVar8 = *(ushort *)(iVar2 + (uint)*pbVar6 * 2);
            iVar5 = (*puVar12 & 0x7c1f) * 0x10;
            iVar9 = (*puVar12 & 0x3e0) * 0x10;
            *puVar12 = (ushort)(((((uVar8 & 0x7c1f) * 0x10 + iVar5 >> 1) + iVar5 >> 1) + iVar5 >> 1
                                & 0x7c1f0) +
                                ((((uVar8 & 0x3e0) * 0x10 + iVar9 >> 1) + iVar9 >> 1) + iVar9 >> 1 &
                                0x3e00) >> 4);
          }
