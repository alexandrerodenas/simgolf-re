...
/* Function: FUN_1001d5a0 @ 0x1001D5A0 */
/* Body size: 952 addresses */


int * __cdecl FUN_1001d5a0(uint param_1)

{
  ...
  local_24 = (undefined **)PTR_LOOP_10066050;
  do {
    if (local_24[4] != (undefined *)0xffffffff) {
      ...
      for (; local_8 < local_24 + 0x806; local_8 = local_8 + 2) {
        if (((int)param_1 <= (int)*local_8) && (param_1 < local_8[1])) {
          piVar2 = (int *)FUN_1001d960(local_c,*local_8,param_1);
          if (piVar2 != (int *)0x0) {
            PTR_LOOP_10066050 = (undefined *)local_24;
  ...
  } while (local_24 != (undefined **)PTR_LOOP_10066050);
  local_24 = &PTR_LOOP_10064030;
  while ((local_24[4] == (undefined *)0xffffffff || (local_24[3] == (undefined *)0x0))) {
    local_24 = (undefined **)*local_24;
    if (local_24 == &PTR_LOOP_10064030) {
      ppuVar4 = FUN_1001d0e0();
      if (ppuVar4 == (undefined **)0x0) {
        ...
        *(undefined1 *)(piVar2 + 2) = (undefined1)param_1;
        PTR_LOOP_10066050 = (undefined *)ppuVar4;
