...
/* Function: FUN_10019400 @ 0x10019400 */
/* Body size: 695 addresses */


int __cdecl FUN_10019400(undefined4 *param_1,int *param_2,int param_3,int param_4,int param_5)

{
  ...
  do {
    while( true ) {
      ...
      iVar7 = ((int)((iVar5 - iVar7) * (uint)*(ushort *)(local_28 + 2)) >> 0x10) + iVar7;
      if (iVar7 < 0x8000) {
        if (iVar7 < -0x8000) {
      ...
      puVar10 = puVar10 + 2;
      puVar1 = (uint *)(local_28 + 2);
      uVar2 = *puVar1;
      *puVar1 = *puVar1 + 0x5ce1;
      *(short *)(local_28 + 6) = *(short *)(local_28 + 6) + (ushort)(0xffffa31e < uVar2);
      pbVar9 = (byte *)(*param_2 + *(int *)(local_28 + 4));
      if ((int)pbVar9 < (int)local_8) break;
      pbVar3 = local_c;
      if (bVar8 == 0) {
        if (!bVar4) goto LAB_10019630;
      ...
      pbVar9 = local_c;
      local_c = pbVar3;
      if (iVar6 + -1 == 0) goto LAB_10019630;
    }
    iVar7 = iVar6 + -1;
  } while (iVar6 + -1 != 0);
LAB_10019630:
