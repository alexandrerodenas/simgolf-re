...
FUN_1000c4f0(void *this,int *param_1,int param_2,int param_3,int *param_4,byte param_5,byte *param_6
            )
        ...
        if (((DAT_100550fc ^ (int)DAT_100550fc >> 0x1f) - ((int)DAT_100550fc >> 0x1f) == iVar2) &&
          ...
          if ((int)DAT_100550fc < 0) {
            if ((int)DAT_10055100 < 0) {
              ...
              iVar2 = DAT_10057c24;
              bVar1 = DAT_10057c20;
              puVar7 = (undefined2 *)(iVar4 + (DAT_10057c14 * local_1c.top + local_1c.left) * 2);
                ...
                do {
                  if (*pbVar5 != 0xff) {
                    if (*param_6 < bVar1) {
                      ...
                      *puVar7 = *(undefined2 *)(iVar2 + (uint)*pbVar5 * 2);
                    }
                  }
                  pbVar5 = pbVar5 + -1;
                  puVar7 = puVar7 + 1;
            ...
            puVar7 = (undefined2 *)(iVar2 + (DAT_10057c14 * local_1c.top + local_1c.left) * 2);
            ...
            DAT_10057c1c = local_1c.right - local_1c.left;
            _DAT_10057bf4 = DAT_10057c34 - DAT_10057c1c;
            pbVar6 = (byte *)(DAT_10057bf0 * local_1c.top + local_1c.left + iVar4);
            _DAT_10057c18 = (DAT_10057c14 - DAT_10057c1c) * 2;
            _DAT_10057bec = DAT_10057bf0 - DAT_10057c1c;
            iVar4 = DAT_10057c1c;
            do {
