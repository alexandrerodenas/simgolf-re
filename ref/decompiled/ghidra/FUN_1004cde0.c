...
/* Function: FUN_1004cde0 @ 0x1004CDE0 */
...
uint __cdecl
FUN_1004cde0(int param_1,uint param_2,ushort param_3,undefined4 param_4,uint param_5,uint param_6)

{
  ...
  while (!CARRY4(param_2,param_2)) {
    ...
    fVar3 = fVar1 * (float10)_DAT_10056c68;
