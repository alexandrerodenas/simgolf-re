...
/* Function: FUN_10090260 @ 0x10090260 */
/* Body size: 260 addresses */


uint __cdecl FUN_10090260(HANDLE param_1,uint param_2)

{
  ...
  if (DVar1 == 0) {
    ...
    if (_Filehandle == 0xffffffff) {
      ...
      *(byte *)((&DAT_10129e60)[(int)_Filehandle >> 5] + 4 + (_Filehandle & 0x1f) * 0x24) =
           local_10 | 1;
