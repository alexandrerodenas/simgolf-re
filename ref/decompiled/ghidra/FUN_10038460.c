...
/* Function: FUN_10038460 @ 0x10038460 */
/* Body size: 4498 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __thiscall FUN_10038460(void *this,int *param_1,int param_2,int param_3,char param_4)

{
  ...
  if ((*(int *)((int)this + 0x14) == 0) || (param_1 == (int *)0x0)) goto LAB_100395dc;
  local_8 = this;
  (**(code **)(*param_1 + 0x10))();
  iVar3 = __chkesp();
  if (iVar3 == 0) goto LAB_100395dc;
  ...
  if (iVar3 == iVar1) {
    ...
    iVar1 = FUN_1007f370(DAT_10122dc8);
    if (iVar3 != iVar1) goto LAB_10038bf4;
        ...
        do {
          do {
            if ((*pbVar8 != 0xff) && ((param_4 == '\0' || (*pbVar8 < 0xf8)))) {
              ...
              iVar4 = (uVar5 & 0x7c1f) * 0x10;
              iVar6 = (uVar5 & 0x3e0) * 0x10;
              *puVar10 = (ushort)((((*puVar10 & 0x7c1f) * 0x30 + iVar4 >> 2) + iVar4 >> 1 & 0x7c1f0)
                                  + (((*puVar10 & 0x3e0) * 0x30 + iVar6 >> 2) + iVar6 >> 1 & 0x3e00)
                                 >> 4);
            }
            pbVar8 = pbVar8 + -1;
            puVar10 = puVar10 + 1;
        ...
        *(int *)PTR_DAT_10122e1c = *(int *)PTR_DAT_10122e20 + DAT_1012857c;
        ...
        do {
          ...
          do {
            if ((*pbVar8 != 0xff) && ((param_4 == '\0' || (*pbVar8 < 0xf8)))) {
              uVar5 = *(ushort *)(iVar3 + (uint)*pbVar8 * 2);
              iVar1 = (uVar5 & 0x7c1f) * 0x10;
              iVar6 = (uVar5 & 0x3e0) * 0x10;
              *puVar10 = (ushort)((((*puVar10 & 0x7c1f) * 0x30 + iVar1 >> 2) + iVar1 >> 1 & 0x7c1f0)
                                  + (((*puVar10 & 0x3e0) * 0x30 + iVar6 >> 2) + iVar6 >> 1 & 0x3e00)
                                 >> 4);
            }
            uVar5 = (ushort)uVar7;
