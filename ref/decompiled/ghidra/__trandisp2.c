...
/* Function: __trandisp2 @ 0x10048017 */
...

{
  ...
  *(ushort *)(unaff_EBP + -0xa0) =
  ...
  cVar2 = (char)(*(char *)(unaff_EBP + -0x9f) << 1) >> 1;
                    /* WARNING: Could not recover jumptable at 0x100480a1. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(param_2 + (char)((&DAT_1006759c)[(byte)(cVar2 << 1 | cVar2 < '\0') & 0xf] |
                               (&DAT_1006759c)[(byte)((bVar3 & 7) << 1 | (char)bVar3 < '\0')] << 2)
              + 0x10))();
  return;
}
