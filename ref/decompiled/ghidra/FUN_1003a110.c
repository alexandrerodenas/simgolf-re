...
/* Function: FUN_1003a110 @ 0x1003A110 */
/* Body size: 2866 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* WARNING: Restarted to delay deadcode elimination for space: stack */

undefined4 __thiscall FUN_1003a110(void *this,int *param_1,int param_2,int param_3,int param_4)
    ...
    if ((int)DAT_100550fc < 0) {
      if ((int)DAT_10055100 < 0) {
        ...
        do {
          do {
            if (*pbVar5 < 0xfe) {
              *puVar11 = *(undefined1 *)(iVar2 + (uint)CONCAT11(*pbVar5,*puVar11));
            }
            pbVar5 = pbVar5 + -1;
            puVar11 = puVar11 + 1;
            iVar6 = iVar6 + -1;
