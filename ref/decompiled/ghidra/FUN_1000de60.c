...
/* Body size: 1707 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __fastcall FUN_1000de60(void *param_1)

{
  ...
  *(float *)(&DAT_100b28cc + *(int *)((int)param_1 + 0x50) * 0xc) =
       *(float *)(&DAT_100b28cc + *(int *)((int)param_1 + 0x50) * 0xc) + _DAT_1005f51c;
  local_8 = param_1;
  if (*(int *)((int)param_1 + 0x34) != 0) {
    iVar1 = thunk_FUN_10001f60(*(int *)((int)param_1 + 0x34));
    if (iVar1 == 6) {
      *(float *)(&DAT_100b28cc + *(int *)((int)local_8 + 0x88) * 0xc) =
           *(float *)(&DAT_100b28cc + *(int *)((int)local_8 + 0x88) * 0xc) + _DAT_1005f51c;
        ...
        if (iVar1 == 6) {
          ...
          if (iVar1 == 6) {
            *(float *)(&DAT_100b28cc + *(int *)((int)local_8 + 0x48) * 0xc) =
                 *(float *)(&DAT_100b28cc + *(int *)((int)local_8 + 0x48) * 0xc) + _DAT_1005f51c;
            iVar1 = thunk_FUN_100153c0(*(int *)((int)local_8 + 0x34));
        ...
        if (iVar1 == 6) {
          ...
          if (iVar1 == 6) {
            *(float *)(&DAT_100b28cc + *(int *)((int)local_8 + 0xf8) * 0xc) =
                 *(float *)(&DAT_100b28cc + *(int *)((int)local_8 + 0xf8) * 0xc) + _DAT_1005f51c;
            iVar1 = thunk_FUN_100153c0(*(int *)((int)local_8 + 0x34));
  ...
  if (*(int *)((int)local_8 + 0x38) != 0) {
    ...
    if (iVar1 == 6) {
      *(float *)(&DAT_100b28cc + *(int *)((int)local_8 + 0x164) * 0xc) =
           *(float *)(&DAT_100b28cc + *(int *)((int)local_8 + 0x164) * 0xc) + _DAT_1005f51c;
        ...
        if (iVar1 == 6) {
          ...
          if (iVar1 == 6) {
            *(float *)(&DAT_100b28cc + *(int *)((int)local_8 + 0x160) * 0xc) =
                 *(float *)(&DAT_100b28cc + *(int *)((int)local_8 + 0x160) * 0xc) + _DAT_1005f51c;
            iVar1 = thunk_FUN_100153c0(*(int *)((int)local_8 + 0x38));
        ...
        if (iVar1 == 6) {
          ...
          if (iVar1 == 6) {
            *(float *)(&DAT_100b28cc + *(int *)((int)local_8 + 0x1d4) * 0xc) =
                 *(float *)(&DAT_100b28cc + *(int *)((int)local_8 + 0x1d4) * 0xc) + _DAT_1005f51c;
            iVar1 = thunk_FUN_100153c0(*(int *)((int)local_8 + 0x38));
  ...
  if (*(int *)((int)local_8 + 0x3c) != 0) {
    ...
    if (iVar1 == 6) {
      *(float *)(&DAT_100b28cc + *(int *)((int)local_8 + 0x4c) * 0xc) =
           *(float *)(&DAT_100b28cc + *(int *)((int)local_8 + 0x4c) * 0xc) + _DAT_1005f51c;
      iVar1 = thunk_FUN_100153c0(*(int *)((int)local_8 + 0x3c));
  ...
  if (*(int *)((int)local_8 + 0x40) != 0) {
    ...
    if (iVar1 == 6) {
      *(float *)(&DAT_100b28cc + *(int *)((int)local_8 + 0xf4) * 0xc) =
           *(float *)(&DAT_100b28cc + *(int *)((int)local_8 + 0xf4) * 0xc) + _DAT_1005f51c;
      iVar1 = thunk_FUN_100153c0(*(int *)((int)local_8 + 0x40));
