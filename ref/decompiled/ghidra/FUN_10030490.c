...
/* Function: FUN_10030490 @ 0x10030490 */
/* Body size: 289 addresses */


undefined1 * FUN_10030490(void)

{
  ...
  if (puVar4 != (undefined1 *)0x0) {
    ...
    for (local_14 = 0; local_14 < 7; local_14 = local_14 + 1) {
      *local_18 = 0x3a;
      puVar5 = FUN_10018580((uint *)(local_18 + 1),*(uint **)(puVar1 + local_14 * 4));
      sVar2 = _strlen((char *)puVar5);
      puVar6 = (undefined1 *)((int)(local_18 + 1) + sVar2);
      *puVar6 = 0x3a;
      puVar5 = (uint *)(puVar6 + 1);
      _Str = FUN_10018580(puVar5,*(uint **)(puVar1 + local_14 * 4 + 0x1c));
