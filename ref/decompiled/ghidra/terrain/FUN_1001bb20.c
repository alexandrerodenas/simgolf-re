...
int * __cdecl FUN_1001bb20(int param_1)

{
  ...
  puVar7 = DAT_101122fc + DAT_101122f8 * 5;
  ...
  for (local_1c = DAT_101122ec;
      (local_1c < puVar7 && ((local_28 & *local_1c) == 0 && (local_38 & local_1c[1]) == 0));
      local_1c = local_1c + 5) {
  }
  if (local_1c == puVar7) {
    for (local_1c = DAT_101122fc;
        (local_1c < DAT_101122ec && ((local_28 & *local_1c) == 0 && (local_38 & local_1c[1]) == 0));
        local_1c = local_1c + 5) {
    }
    if (local_1c == DAT_101122ec) {
      for (; (local_1c < puVar7 && (local_1c[2] == 0)); local_1c = local_1c + 5) {
      }
      if (local_1c == puVar7) {
        for (local_1c = DAT_101122fc; (local_1c < DAT_101122ec && (local_1c[2] == 0));
            local_1c = local_1c + 5) {
        }
        if ((local_1c == DAT_101122ec) && (local_1c = FUN_1001c060(), local_1c == (uint *)0x0)) {
          return (int *)0x0;
        }
      }
      iVar5 = FUN_1001c170((int)local_1c);
  ...
  *(uint *)((int)piVar8 + (uVar9 - 4)) = uVar9 + 1;
  iVar5 = *piVar2;
  *piVar2 = *piVar2 + 1;
  if (((iVar5 == 0) && (local_1c == DAT_101122f4)) && (local_34 == DAT_101122e8)) {
    DAT_101122f4 = (uint *)0x0;
  }
  *piVar4 = local_34;
  return piVar8 + 1;
}
