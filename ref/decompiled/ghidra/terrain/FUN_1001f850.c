...
/* Body size: 797 addresses */


undefined4 * __cdecl
FUN_1001f850(LPCSTR param_1,char *param_2,undefined4 param_3,undefined4 *param_4)

{
  ...
  local_20 = DAT_1011098c;
  bVar4 = false;
  bVar5 = false;
  if ((param_1 == (LPCSTR)0x0) &&
     (iVar6 = FUN_1001a320(2,0x100602b4,0x47,0,(byte *)"filename != NULL"), iVar6 == 1)) {
    pcVar2 = (code *)swi(3);
    puVar7 = (undefined4 *)(*pcVar2)();
    return puVar7;
  }
  if ((param_2 == (char *)0x0) &&
     (iVar6 = FUN_1001a320(2,0x100602b4,0x48,0,(byte *)"mode != NULL"), iVar6 == 1)) {
    pcVar2 = (code *)swi(3);
    puVar7 = (undefined4 *)(*pcVar2)();
    return puVar7;
  }
  if ((param_4 == (undefined4 *)0x0) &&
     (iVar6 = FUN_1001a320(2,0x100602b4,0x49,0,(byte *)"str != NULL"), iVar6 == 1)) {
    pcVar2 = (code *)swi(3);
    puVar7 = (undefined4 *)(*pcVar2)();
    return puVar7;
  }
  ...
  uVar8 = FUN_100266b0(param_1,local_18,param_3,0x1a4);
  if ((int)uVar8 < 0) {
