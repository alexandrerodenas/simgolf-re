...
void __cdecl FUN_1001d340(int param_1)

{
  ...
  local_18 = (undefined **)PTR_LOOP_10064034;
  do {
    ppuVar1 = local_18;
    if (local_18[4] != (undefined *)0xffffffff) {
      ...
      if ((local_14 != 0) && (local_18[6] == (undefined *)0xffffffff)) {
        ...
        if (local_10 == 0x400) {
          FUN_1001d2c0(local_18);
        }
      }
    }
    local_18 = ppuVar1;
    if ((local_18 == (undefined **)PTR_LOOP_10064034) || (param_1 < 1)) {
      return;
    }
  } while( true );
}
