...
/* Function: FUN_10018e40 @ 0x10018E40 */
/* Body size: 297 addresses */


undefined8 __cdecl FUN_10018e40(byte *param_1)

{
  ...
  while( true ) {
    if (DAT_10066268 < 2) {
      local_18 = *(ushort *)(PTR_DAT_1006605c + (uint)*param_1 * 2) & 8;
    }
    else {
      local_18 = FUN_1001e6d0((uint)*param_1,8);
    }
    if (local_18 == 0) break;
    param_1 = param_1 + 1;
  }
  ...
  while( true ) {
    if (DAT_10066268 < 2) {
      local_1c = *(ushort *)(PTR_DAT_1006605c + local_8 * 2) & 4;
    }
    else {
      local_1c = FUN_1001e6d0(local_8,4);
    }
    if (local_1c == 0) break;
