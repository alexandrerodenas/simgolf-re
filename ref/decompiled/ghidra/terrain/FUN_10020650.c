...
/* Function: FUN_10020650 @ 0x10020650 */
/* Body size: 358 addresses */


undefined1 * __cdecl
FUN_10020650(undefined1 *param_1,int param_2,int param_3,int *param_4,char param_5)

{
  ...
  if (0 < param_2) {
    *local_8 = local_8[1];
    local_8 = local_8 + 1;
    *local_8 = DAT_1006626c;
  }
  puVar1 = FUN_10018580((uint *)(local_8 + (uint)(param_5 == '\0') + param_2),(uint *)"e+000");
  if (param_3 != 0) {
