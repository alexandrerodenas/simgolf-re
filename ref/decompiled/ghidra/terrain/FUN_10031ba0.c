...
/* Function: FUN_10031ba0 @ 0x10031BA0 */
/* Body size: 575 addresses */


BOOL __cdecl
FUN_10031ba0(DWORD param_1,LPCWSTR param_2,int param_3,LPWORD param_4,UINT param_5,LCID param_6)

{
  ...
  else if (DAT_10110a44 == 2) {
    if (param_5 == 0) {
      param_5 = DAT_101109b8;
    }
          ...
          if (&stack0x00000000 == (undefined1 *)0x44) {
            ...
            *(undefined2 *)(&stack0xffffffba + param_3 * 2) = 0xffff;
            ...
            if ((*(short *)(&stack0xffffffba + param_3 * 2) == -1) ||
              ...
              FUN_10024410((undefined4 *)param_4,(undefined4 *)&stack0xffffffbc,param_3 << 1);
            }
          }
        }
      }
