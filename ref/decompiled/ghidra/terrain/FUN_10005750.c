...
void FUN_10005750(float param_1,int param_2)

{
  ...
  fVar3 = (float10)thunk_FUN_10005840(param_1,(float)param_2);
  local_1c = (float)(fVar3 * (float10)local_c);
  local_20 = 2 - param_2;
  thunk_FUN_10005840(_DAT_1005f024 - param_1,(float)local_20);
  local_8 = 0x100057fe;
  __chkesp();
  return;
}
