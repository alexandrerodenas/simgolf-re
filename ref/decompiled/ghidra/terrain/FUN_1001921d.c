...
/* Function: FUN_1001921d @ 0x1001921D */
/* Body size: 145 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint __cdecl FUN_1001921d(int param_1,undefined4 param_2)

{
  ...
  if (in_ZF) {
    ...
    if (DAT_10110780 == 0) {
      __startOneArgErrorHandling(&DAT_10063ec0,0x12,in_FPUControlWord,unaff_retaddr,param_1,param_2)
      ;
      return extraout_EAX;
    }
  }
    ...
    if (DAT_10110780 == 0) {
      uVar1 = __math_exit(&DAT_10063ec0,0x12,unaff_retaddr,param_1,param_2);
      return uVar1;
    }
  }
  return uVar1;
