...
/* Function: __XcptFilter @ 0x1008FC20 */
/* Body size: 446 addresses */
...

{
  ...
  pDVar4 = FUN_10084e20();
  piVar5 = FUN_1008fde0(_ExceptionNum,(int *)pDVar4[0x14]);
  if ((piVar5 == (int *)0x0) || (piVar5[2] == 0)) {
    ...
    if (piVar5[1] == 8) {
      for (local_18 = DAT_10125c98; local_18 < DAT_10125c98 + _DAT_10125c9c; local_18 = local_18 + 1
          ) {
