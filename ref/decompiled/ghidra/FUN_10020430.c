...
/* Function: FUN_10020430 @ 0x10020430 */
/* Body size: 3869 addresses */
...
void __thiscall
FUN_10020430(void *this,int *param_1,int param_2,int param_3,int param_4,int param_5)

{
  ...
  if ((*(int *)((int)this + 0x14) == 0) || (param_1 == (int *)0x0)) goto LAB_10021337;
  local_8 = this;
  (**(code **)(*param_1 + 0x10))();
  iVar3 = __chkesp();
  if (iVar3 == 0) goto LAB_10021337;
  ...
  if (local_48 == 0) {
    ...
    if (local_48 != 1) goto LAB_10021337;
    (**(code **)(*local_3c + 0x1c))();
    DAT_1012856c = __chkesp();
  }
  ...
  if (iVar3 == iVar1) {
    ...
    iVar1 = FUN_1007f370(DAT_10122dc8);
    if (iVar3 != iVar1) goto LAB_10020a8b;
          ...
          do {
            if (*pbVar7 < 0xfe) {
              if (*pbVar7 == 0xf8) {
                ...
                *puVar9 = *(ushort *)(iVar3 + (uint)*(byte *)(DAT_10128548 + (uint)*pbVar7) * 2);
              }
            }
            pbVar7 = pbVar7 + -1;
            puVar9 = puVar9 + 1;
