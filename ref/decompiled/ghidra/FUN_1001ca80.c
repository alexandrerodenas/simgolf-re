...
/* Function: FUN_1001ca80 @ 0x1001CA80 */
/* Body size: 1565 addresses */


undefined4 FUN_1001ca80(void)

{
  ...
  BVar2 = IsBadWritePtr(DAT_101122fc,DAT_101122f8 * 0x14);
  if (BVar2 == 0) {
    local_140 = DAT_101122fc;
    for (local_124 = 0; local_124 < DAT_101122f8; local_124 = local_124 + 1) {
