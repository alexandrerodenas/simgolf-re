...
/* Function: FUN_1007ea5d @ 0x1007EA5D */
/* Body size: 158 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint __cdecl FUN_1007ea5d(int param_1,undefined4 param_2)

{
  ...
  if (in_ZF) {
    ...
    if (DAT_10128748 == 0) {
      __startOneArgErrorHandling(&DAT_10123330,0x12,in_FPUControlWord,unaff_retaddr,param_1,param_2)
      ;
      return extraout_EAX;
    }
  }
    ...
    if (DAT_10128748 == 0) {
      uVar1 = __math_exit(&DAT_10123330,0x12,unaff_retaddr,param_1,param_2);
      return uVar1;
    }
  }
  return uVar1;
