...
/* Function: FUN_004af220 @ 0x004AF220 */
/* Body size: 176 addresses */


int FUN_004af220(int *param_1,undefined4 param_2,int param_3,uint param_4)
  ...
  *(uint *)(iVar2 + 0x4c) = uVar1;
  ...
  if (param_4 != 0) {
    do {
      ...
      iVar3 = FUN_004af0c0(param_1,param_2,uVar1 * param_3 * 0x80);
      if (uVar1 != 0) {
