...
/* Function: FUN_004ab7c6 @ 0x004AB7C6 */


undefined4 FUN_004ab7c6(int param_1,int param_2)

{
  ...
  if (((*puVar1 & 1 << (bVar3 & 0x1f)) != 0) &&
     (iVar2 = FUN_004ab727(param_1,param_2 + 1), iVar2 == 0)) {
    local_8 = FUN_004ab770(param_1,param_2 + -1);
  }
