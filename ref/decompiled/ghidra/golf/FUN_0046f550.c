...
switchD_0046fcba_default:
    ...
    if ((DAT_00834170 == 0) ||
      ...
      if (uVar7 != 0xffffffff) {
        uVar8 = uVar7;
        if (uVar7 < 4) goto switchD_00470216_switchD;
        goto LAB_0047028f;
      }
    }
    else {
...
code_r0x00470756:
  ...
  case 3:
    ...
    break;
  default:
    goto switchD_00470875_default;
  }
  FUN_004481b0(iVar4,uVar18,uVar19,uVar20,uVar21);
switchD_00470875_default:
  FUN_00483d30();
  DAT_00822d68 = 0;
  local_4._0_1_ = 1;
  FUN_00474c40();
