...

{
  ...
  do {
    ...
    if ((DAT_00822d68 != 0) || (local_404 != 0)) {
      ...
      if ((DAT_00839280 & 1 << ((byte)iVar3 & 0x1f)) != 0) {
        iVar3 = local_408;
      }
...
LAB_0046e10b:
    ...
    case 0xd:
    case 0x20:
      if ((1 << ((byte)iVar3 & 0x1f) & DAT_00839280) == 0) {
        local_410 = 1;
      }
      break;
    default:
      ...
      do {
        ...
        iVar7 = iVar3;
        if (0x1f < iVar2) break;
      } while ((*(byte *)((int)&DAT_00838ec4 + iVar2) == 0xff) ||
              (iVar7 = iVar2, (*(byte *)((int)&DAT_00838ec4 + iVar2) & 0x1f) != (uVar4 & 0x1f)));
      break;
    case 0x1b:
      local_410 = 1;
      goto LAB_0046e1a8;
