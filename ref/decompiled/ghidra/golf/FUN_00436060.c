...

{
  ...
  if ((DAT_005685f0 < 2) || ((_DAT_0059e7b8 & 0x4200000) != 0)) {
  ...
  if (((_DAT_0059e7b8 & 0x400000) == 0) || ((_DAT_0059e7b8 & 0x4200000) != 0)) {
  ...
  case 0:
    ...
    return 0xffffffff;
  case 1:
    if (((1 < DAT_005685f0) && ((_DAT_0059e7b8 & 0x4200000) == 0)) && (DAT_005a59f8 == -1)) {
      _DAT_0059e7b8 = _DAT_0059e7b8 & 0xffffdfff | 0x4000;
      return 0xffffffff;
    }
    break;
  case 2:
    if (((((_DAT_0059e7b8 & 0x2000) != 0) && (1 < DAT_005685f0)) && (DAT_004c2e14 != -1)) &&
       ((DAT_005a59f8 == -1 && ((_DAT_0059e7b8 & 0x4200000) == 0)))) {
      _DAT_0059e7b8 = _DAT_0059e7b8 | 0x4000;
      return 0xffffffff;
    }
    break;
  case 3:
