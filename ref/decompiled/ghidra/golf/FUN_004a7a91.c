...
/* Function: FUN_004a7a91 @ 0x004A7A91 */


void FUN_004a7a91(uint *param_1,uint param_2)

{
  ...
  *piVar3 = *piVar3 + -1;
  uVar5 = DAT_00842148;
  puVar2 = DAT_00842150;
  if ((*piVar3 == 0) && (uVar5 = uVar10, puVar2 = param_1, DAT_00842150 != (uint *)0x0)) {
    VirtualFree((LPVOID)(DAT_00842148 * 0x8000 + DAT_00842150[3]),0x8000,0x4000);
    DAT_00842150[2] = DAT_00842150[2] | 0x80000000U >> ((byte)DAT_00842148 & 0x1f);
    *(undefined4 *)(DAT_00842150[4] + 0xc4 + DAT_00842148 * 4) = 0;
    *(char *)(DAT_00842150[4] + 0x43) = *(char *)(DAT_00842150[4] + 0x43) + -1;
    if (*(char *)(DAT_00842150[4] + 0x43) == '\0') {
      DAT_00842150[1] = DAT_00842150[1] & 0xfffffffe;
    }
    puVar2 = param_1;
    if (DAT_00842150[2] == 0xffffffff) {
      VirtualFree((LPVOID)DAT_00842150[3],0,0x8000);
      HeapFree(DAT_0084215c,0,(LPVOID)DAT_00842150[4]);
      FUN_004a6d80(DAT_00842150,DAT_00842150 + 5,
                   (DAT_00842154 * 0x14 - (int)DAT_00842150) + -0x14 + DAT_00842158);
      DAT_00842154 = DAT_00842154 + -1;
      if (DAT_00842150 < param_1) {
        param_1 = param_1 + -5;
      }
      DAT_0084214c = DAT_00842158;
      puVar2 = param_1;
    }
  }
  DAT_00842150 = puVar2;
