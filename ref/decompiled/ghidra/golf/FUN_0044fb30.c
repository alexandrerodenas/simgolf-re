  ...
  do {
    ...
    if (cVar2 == '\0') {
      ...
      if (param_1 == 0) {
        ...
        DAT_0051a068._0_1_ = 0;
        pcVar6 = (char *)FUN_004ad425((int)(char)(&DAT_00575ab0)[iVar4],&DAT_00821c50,10);
        uVar10 = 0xffffffff;
        do {
          pcVar17 = pcVar6;
          if (uVar10 == 0) break;
...
LAB_00450932:
  ...
  if (param_1 == 0) {
    ...
    if (iStack_cc < 1) {
      ...
      FUN_00476310(0x80000000,0xffffffff,2,2);
      iVar8 = 0x2bd;
      DAT_0059e7b8 = DAT_0059e7b8 & 0xffbfffff;
      iVar3 = 0x18e;
    }
    else {
      ...
      iVar8 = 0x2bd;
      DAT_0059e7b8 = DAT_0059e7b8 | 0x402000;
      iVar3 = 0x18e;
    }
  }
  bVar1 = false;
