      ...
      *pcVar8 = '\0';
      ...
      if (param_1 != (char *)0x0) {
        ...
        if ((cVar2 == 'M') || (cVar2 == 'm')) {
          ...
          local_148 = *(uint *)(&DAT_0083e8b8 + iVar6 * 4);
...
LAB_00494720:
          if (uVar7 == 1) {
            ...
            if (uVar7 != 2) {
              if (uVar7 == 3) {
                uVar10 = (uint)(local_148 != 0) + (-(uint)(uVar5 != 0) & 2);
              }
              else {
                uVar10 = uVar7;
                if (uVar7 == 5) {
                  uVar10 = (-(uint)(uVar5 != 0) & 3) + local_148;
                }
              }
            }
          }
...
LAB_004946d5:
      ...
      if ((iVar6 == 0) || (iVar6 = _strncmp(pcVar3,s__DROPLINK_004e423c,9), iVar6 == 0)) {
        ...
        *pcVar4 = '\0';
        if ((&DAT_0083fe08)[(int)pcVar8 * 2] == 0) {
          iVar6 = FUN_004a4ad0(*(undefined4 *)(&DAT_0083fdbc + (int)pcVar8 * 8));
          if (iVar6 < 0x100) {
            pcVar3 = *(char **)(*(int *)(&DAT_0083fdb8 + (int)pcVar8 * 8) + 0x578 + iVar6 * 0x18);
          }
          else {
            pcVar3 = (char *)0x0;
          }
          ...
          pcVar3 = (char *)FUN_004940e0(*(undefined4 *)((&DAT_0083fe08)[(int)pcVar8 * 2] + 0x1c));
        }
        uVar5 = 0xffffffff;
        do {
          pcVar8 = pcVar3;
    ...
    case 'H':
      ...
      if (iVar6 == 0) {
        ...
        *pcVar9 = '\0';
        FUN_004ad425(*(undefined4 *)(&DAT_0083de68 + (int)local_14c * 4),local_f0,10);
        uVar5 = 0xffffffff;
        pcVar3 = local_f0;
        do {
          pcVar8 = pcVar3;
    ...
    case 'L':
      ...
      if (iVar6 == 0) {
        ...
        *pcVar8 = '\0';
        ...
        FUN_004ad425(*(undefined4 *)(&DAT_0083f46c + (int)local_14c * 0x108),local_50,10);
        uVar5 = 0xffffffff;
        pcVar9 = local_50;
        do {
          pcVar4 = pcVar9;
    ...
    case 'N':
      ...
      if (iVar6 == 0) {
        ...
        *pcVar8 = '\0';
        FUN_004ad425(*(undefined4 *)(&DAT_0083de68 + (int)local_14c * 4),local_a0,10);
        uVar5 = 0xffffffff;
        pcVar9 = local_a0;
        do {
          pcVar4 = pcVar9;
        ...
        *pcVar8 = '\0';
        FUN_004ad425(*(undefined4 *)(&DAT_0083de68 + (int)local_14c * 4),local_140,10);
        uVar5 = 0xffffffff;
        pcVar9 = local_140;
        do {
          pcVar4 = pcVar9;
