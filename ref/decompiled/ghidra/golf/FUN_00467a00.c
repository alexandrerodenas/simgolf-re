...

{
  ...
  if ((_DAT_0059e7b8 & 0x2000000) != 0) {
    return;
  }
  if (((param_2 == 0x13) && (((&DAT_005794d0)[iVar16] & 0xe0) != 0x20)) &&
     (iVar8 = (int)(char)(&DAT_005794d9)[iVar16], 9 < *(int *)(&DAT_00575ad0 + iVar8 * 0x208))) {
    if (((((&DAT_00575cb0)[iVar8 * 0x82] & 4) != 0) &&
        (1 < (int)(char)(&DAT_005794db)[iVar16 + iVar8] -
             (int)*(char *)(&DAT_00575ab0 + iVar8 * 0x82))) ||
       ((((&DAT_00575cb0)[iVar8 * 0x82] & 8) != 0 &&
        ((int)(char)(&DAT_005794db)[iVar16 + iVar8] - (int)*(char *)(&DAT_00575ab0 + iVar8 * 0x82) <
         0)))) {
      param_2 = 0x17;
    }
  }
...
LAB_00468471:
  ...
  case 0x3b:
    if (*(char *)((char)(&DAT_005794d9)[iVar16] + 0x5849e3 +
                 (short)(&DAT_0057956e)[param_1 * 0x80] * 0x2c) != '\0') goto LAB_00468471;
    break;
  case 0x41:
    if (1 < DAT_00822c88) {
      uVar15 = 0xfffffffe;
...
LAB_0046868c:
  ...
  *(short *)(&DAT_00575c08 + (char)(&DAT_005794d9)[iVar16] * 0x208) =
  ...
  if ((((((int)(uVar12 & 0xffff) <= DAT_00822c88) ||
      ...
      (((_DAT_0059e7b8 & 0x4000000) == 0 && (param_2 != 0x2f)))) &&
  ...
  if (param_2 != 0x32) {
    ...
    if ((((500 < DAT_00834170 - DAT_0055e5ac) && (*(short *)(&DAT_00579566 + iVar16) == 0)) &&
      ...
      if ((DAT_00822c88 != 0) && ((int)local_108 < -1)) {
        uVar13 = 0x80007084;
      }
