...
/* Function: FUN_00475fb0 @ 0x00475FB0 */


undefined4 __thiscall
FUN_00475fb0(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6,int param_7)
      ...
      if ((iVar4 != 0) && (iVar5 != 0)) {
        ...
        if (0 < iVar6) {
          do {
            ...
            if (0 < param_6) {
              do {
                FUN_00475c60(unaff_EBX,0,0,iVar2,iVar7,iVar4,iVar5);
                param_7 = param_7 + -1;
                iVar2 = iVar2 + iVar4;
              } while (param_7 != 0);
            }
