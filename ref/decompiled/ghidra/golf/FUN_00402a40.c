...
LAB_00402afe:
    ...
    if ('\0' < cVar4) {
      if ((&DAT_0057958c)[DAT_005a59f8 * 0x40] == 0) {
        iStack_30 = (&DAT_005794b8)[DAT_005a59f8 * 0x40];
        iStack_2c = (&DAT_005794bc)[DAT_005a59f8 * 0x40];
      }
      else {
        iStack_30 = (&DAT_0057958c)[DAT_005a59f8 * 0x40] + (&DAT_004c2878)[local_24 & 7] * 0x400;
        iStack_2c = (&DAT_00579590)[DAT_005a59f8 * 0x40] + (&DAT_004c2898)[local_24 & 7] * 0x400;
      }
      iStack_10 = iStack_30 - (&DAT_00585850)[local_24 * 0x13];
      iStack_18 = iStack_2c - (&DAT_00585854)[local_24 * 0x13];
      iVar11 = FUN_00467170(iStack_10,iStack_18);
      ...
      iVar11 = FUN_004672d0(iStack_10,iStack_18);
    ...
    if ((cVar4 == -6) &&
       ((DAT_005a59f8 != -1 || (((DAT_0059e7b8 & 0x200000) != 0 && (DAT_005795d9 != '\0'))))))
    goto LAB_004038b7;
    if ((*(short *)(&DAT_00585868 + iVar16) != 0) || (((&DAT_00585862)[iVar16] & 0x10) != 0)) {
LAB_00403503:
      if (((&DAT_00585862)[iVar16] & 0x10) != 0) {
        iStack_30 = DAT_00578150 * 0x400 + 0x200;
        iStack_2c = DAT_00578154 * 0x400 + 0x200;
        if ((int)(local_24 * 0x23 + DAT_00834170) % 100 == 0) {
          (&DAT_00585865)[iVar16] = 7;
          (&DAT_00585864)[iVar16] = 0x23;
        }
        iVar11 = FUN_00467170(iStack_30 - (&DAT_00585850)[local_24 * 0x13],
                              iStack_2c - (&DAT_00585854)[local_24 * 0x13]);
        if (iVar11 < 0x600) {
          (&DAT_00585862)[iVar16] = 0;
        }
      }
      if (*(short *)(&DAT_00585868 + iVar16) == 0) {
        DAT_0059e7b8 = DAT_0059e7b8 | 0x100;
        cVar4 = FUN_0042e7e0(iStack_30,iStack_2c,(&DAT_00585850)[local_24 * 0x13],
                             (&DAT_00585854)[local_24 * 0x13],local_24);
        DAT_0059e7b8 = DAT_0059e7b8 & 0xfffffeff;
      ...
      if (0 < (int)local_24) {
        ...
        do {
          if ((*(char *)((int)piVar15 + 0x12) != '\0') && (uStack_14 != local_24)) {
        ...
        } while ((int)uStack_14 < (int)local_24);
      }
    ...
    if ((&DAT_00585860)[iVar16] != -1) {
      iStack_30 = (char)(&DAT_00585860)[iVar16] * 0x400 + 0x200;
      iStack_2c = (char)(&DAT_00585861)[iVar16] * 0x400 + 0x200;
    }
    iStack_20 = -1;
    iStack_1c = -1;
    if ((cVar4 == -4) || (cVar4 == -6)) {
      ...
      do {
        iStack_18 = -0x10;
        do {
          iVar17 = (int)(char)(&DAT_00585860)[iVar16] + uStack_14;
          iVar14 = (char)(&DAT_00585861)[iVar16] + iStack_18;
          ...
          if (((iVar9 == 0) && (((&DAT_0053caf0)[iVar14 + iVar17 * 0x32] & 0x800) != 0)) &&
            ...
            iStack_30 = iVar17 * 0x400 + 0x200;
            iStack_2c = iVar14 * 0x400 + 0x200;
            iStack_28 = 1;
            iStack_20 = -4;
            iVar19 = iVar9;
            iStack_1c = iVar17;
        ...
        } while (iStack_18 < 0x11);
        uStack_14 = uStack_14 + 1;
      } while ((int)uStack_14 < 0x11);
      if ((iStack_28 == -1) && (((&DAT_00585862)[iVar16] & 8) != 0)) {
        iVar11 = 0x1400;
        iVar13 = 0;
    ...
    cVar4 = (&DAT_00585863)[iVar16];
    if (((cVar4 != -4) && (cVar4 != -6)) || ((iStack_1c == -1 && (cVar4 == -6)))) {
      iStack_30 = (char)(&DAT_00585860)[iVar16] * 0x400 + 0x200;
      iStack_18 = 0;
      ...
      do {
        ...
        if (((('\0' < *(char *)((int)puVar18 + 0x1d)) && ('\x06' < *(char *)((int)puVar18 + 0x19)))
            && (iStack_18 != (short)(&DAT_00585870)[local_24 * 0x26])) &&
...
LAB_00403039:
          ...
          if (((iVar13 == cVar4) || (cVar4 == -6)) && (iVar11 < iStack_10)) {
            iStack_28 = iStack_18;
            iStack_20 = iVar13;
            iStack_10 = iVar11;
          }
      ...
      if (iStack_10 < 100) {
        iStack_30 = (&DAT_005794b8)[iStack_28 * 0x40];
        iStack_2c = (&DAT_005794bc)[iStack_28 * 0x40];
      }
      else {
        if (iStack_28 != -1) {
          uVar5 = FUN_004671a0((&DAT_005794b8)[iStack_28 * 0x40] - (&DAT_00585850)[local_24 * 0x13],
                               (&DAT_005794bc)[iStack_28 * 0x40] - (&DAT_00585854)[local_24 * 0x13])
          ;
    ...
    if (((&DAT_00585863)[iVar16] == -6) && (DAT_00575cb8 == '\0')) {
      if (((DAT_00834170 & 0x200) == 0) &&
        ...
        iStack_30 = DAT_00543d08 * 0x400 + 0x200;
        iStack_2c = DAT_00543d0c * 0x400 + 0x200;
      }
      else {
        iStack_30 = (&DAT_00585850)[local_24 * 0x13];
        iStack_2c = (&DAT_00585854)[local_24 * 0x13];
      }
    }
    iStack_18 = iStack_2c - (&DAT_00585854)[local_24 * 0x13];
    ...
    *(ushort *)(&DAT_00585868 + iVar16) = ((0x800 < iVar11) - 1 & 0xfe00) + 0x200;
    ...
    if (((&DAT_00585863)[iVar16] == -6) && (iStack_20 != -2)) {
      iVar13 = 8;
    }
    if (iStack_28 == -1) {
    ...
    *(short *)(&DAT_0058586a + iVar16) = *(short *)(&DAT_0058586a + iVar16) + 0x40;
    (&DAT_00585865)[iVar16] = 7;
    (&DAT_00585870)[local_24 * 0x26] = (short)iStack_28;
    switch(iStack_20) {
    case -5:
      ...
      *(short *)(&DAT_0058586a + iVar16) = *(short *)(&DAT_0058586a + iVar16) + -0x20;
      ...
      (&DAT_00579556)[iStack_28 * 0x80] = 0xffe0;
      (&DAT_005794d5)[iStack_28 * 0x100] = 0xb;
      (&DAT_005794d2)[iStack_28 * 0x100] = bVar1 ^ 4;
      break;
    case -4:
      if (iStack_28 == 2) {
        ...
        *(undefined2 *)(&DAT_0058586a + iVar16) = 0xc;
        (&DAT_005736b8)[iStack_1c * 9] = 0xffffffff;
      }
      else {
        ...
        *(ushort *)(&DAT_0058586a + iVar16) =
        ...
        iVar11 = iStack_4 + iStack_1c * 0x32;
        ...
        if ((uVar2 & 0x4000) == 0) {
          ...
          FUN_00402930(iStack_1c,iStack_4);
        }
        else {
      ...
      goto switchD_00403273_default;
    case -3:
      uVar10 = (&DAT_005794c8)[iStack_28 * 0x40];
      if (((uVar10 & 0x20000000) == 0) || (((&DAT_00585862)[iVar16] & 8) == 0)) {
        (&DAT_00585864)[iVar16] = 0xfd;
        (&DAT_005794c8)[iStack_28 * 0x40] = uVar10 | 0x4000;
      }
      else {
        (&DAT_0057955c)[iStack_28 * 0x80] = 0xfff5;
        (&DAT_00585864)[iVar16] = 0xf9;
        (&DAT_00579556)[iStack_28 * 0x80] = 0;
      }
      (&DAT_0058586e)[local_24 * 0x26] = 0xc;
      (&DAT_0058586c)[local_24 * 0x26] = 0;
    ...
    case -2:
      ...
      *(short *)(&DAT_0058586a + iVar16) = *(short *)(&DAT_0058586a + iVar16) + 0x40;
      ...
      (&DAT_0058586e)[local_24 * 0x26] = 0xc;
      (&DAT_0058586c)[local_24 * 0x26] = 0;
      (&DAT_00579556)[iStack_28 * 0x80] = (&DAT_00579556)[iStack_28 * 0x80] + -0x10;
      (&DAT_005794d2)[iStack_28 * 0x100] = bVar1 ^ 4;
      (&DAT_005794d5)[iStack_28 * 0x100] = 0xb;
      break;
    default:
