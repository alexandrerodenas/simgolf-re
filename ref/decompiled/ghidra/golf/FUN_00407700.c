...
switchD_00407974_caseD_4:
        ...
        case 1:
          ...
          break;
        case 2:
          goto switchD_0040791b_caseD_2;
        case 3:
          pcVar5 = s_white_carnation_004c4cb8;
          break;
        case 4:
          goto switchD_00407974_caseD_4;
        default:
          goto switchD_0040791b_default;
        }
      }
      ...
      if (DAT_005a34e0 != '\x01') goto switchD_00407793_caseD_c;
    }
    else {
    ...
    if (param_3 == 0x13) {
      ...
      if ((*(byte *)(&DAT_0053caf0 + param_2) & 0x20) == 0) {
        if ((*(char *)((int)&DAT_0056988c + param_2) == '\0') ||
          ...
          pcVar5 = s_rock_formation_004c4df4;
          if (DAT_005a34e0 != '\x01') goto switchD_00407793_caseD_12;
        }
        else {
