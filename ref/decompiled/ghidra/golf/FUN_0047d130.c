...
LAB_0047d4a0:
    ...
    if ((DAT_0083ab18 != 0) || ((param_1[0x27] & 0x4000000U) != 0)) {
      ...
      case 2:
        ...
        goto LAB_0047d49b;
      default:
        goto switchD_0047d3e1_caseD_3;
      case 10:
      case 0xb:
        FUN_0047d060(1);
        _DAT_0083aba0 = 1;
        lpCursorName = &DAT_00007f84;
        break;
      case 0xc:
      case 0xf:
        FUN_0047d060(1);
        _DAT_0083aba0 = 1;
        lpCursorName = &DAT_00007f85;
        break;
      case 0xd:
      case 0x11:
        FUN_0047d060(1);
        _DAT_0083aba0 = 1;
        lpCursorName = &DAT_00007f82;
        break;
      case 0xe:
      case 0x10:
        FUN_0047d060(1);
        _DAT_0083aba0 = 1;
        lpCursorName = &DAT_00007f83;
        break;
      case 0xfffffffe:
      case 0xffffffff:
      case 1:
        goto switchD_0047d3e1_caseD_fffffffe;
      }
      goto LAB_0047d4a0;
    }
    if (param_1[0x82] != 0) {
...
LAB_0047d2a0:
  ...
  SetCursor(hCursor);
switchD_0047d3e1_caseD_fffffffe:
  return;
}
