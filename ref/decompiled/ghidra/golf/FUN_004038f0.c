...

{
  ...
  if (0x7f < DAT_004c2e10) {
    ...
    if ((((byte)DAT_00834170 & 2) != 0) || ((DAT_0059e7b8 & 4) != 0)) {
    ...
    if (((char)psVar12[-6] != '\0') &&
      ...
      *(undefined4 *)(psVar12 + -9) = local_1c;
      ...
      if (cVar1 == -6) {
        ...
        goto LAB_00403ede;
        local_24 = 99;
        _DAT_00582e70 = (short)(char)DAT_004d60a9;
        uVar4 = CONCAT31((int3)(CONCAT22((short)(uVar4 >> 0x10),_DAT_00582e70) >> 8),DAT_004d60ab)
                >> 4 & 3;
        DAT_00582e6e = 0;
        DAT_00582dd1 = 7;
        DAT_00582e72 = 2;
      ...
      if ((*(char *)((int)psVar12 + -9) == '\0') && (*(char *)((int)psVar12 + -0xb) < '\0')) {
        ...
        if ((((DAT_0059e7b8 & 0x80) == 0) && (3 < DAT_004c2844)) && (DAT_00567afc != 3)) {
