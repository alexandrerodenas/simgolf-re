...

{
  ...
  *unaff_FS_OFFSET = &uStack_c;
  ...
  _DAT_00582e70 = (ushort)(char)(&DAT_004d60a9)[iVar9];
  DAT_00582dd0 = '\0';
  ...
  do {
    do {
      ...
      if (local_2e0 == 0) {
        ...
        do {
          if (param_1 == 0) {
            bVar8 = (&DAT_005a5a04)[(int)pcStack_2ec];
          }
          else {
      ...
      if ((local_2d4 != DAT_005a9f54) || (local_2d4 == -1)) {
        ...
        goto switchD_00439637_default;
      }
      DAT_005aa554 = DAT_005aa554 + 1;
      if (DAT_005aa554 < 0xb) goto switchD_00439637_default;
      DAT_0051a068._0_1_ = '\0';
      switch(local_2d4) {
      case 8:
...
LAB_00439feb:
          ...
          case 2:
            ...
            _DAT_00582e70 = _DAT_00582e70 & 0xff87 | (ushort)uVar5;
            break;
          case 3:
            uVar11 = (uint)(byte)(&DAT_004d60a9)[iVar9];
            if (DAT_00822d68 == 1) {
            ...
            (&DAT_004d60a9)[iVar9] = (char)uVar5;
            _DAT_00582e70 = _DAT_00582e70 & 0xfff8 | (ushort)uVar5;
          }
        }
