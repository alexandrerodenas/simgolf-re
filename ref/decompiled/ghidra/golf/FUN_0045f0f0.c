  ...
  do {
    do {
      ...
      if (-1 < param_5) {
        ...
        iVar5 = param_4;
        if (param_4 == -1) {
          DAT_00582e70 = (short)DAT_004d60a9;
          DAT_00582e6e = 0;
          iVar5 = 0x99;
        }
    ...
    if ((DAT_00822d68 == 0) ||
      ...
      if (param_3 != 0) {
        if ((DAT_00822d68 == 0) || (iStack_304 == -1)) {
          ...
          iVar5 = iStack_304 % 10;
          if (iStack_304 < 10) {
            if ((local_314 < param_3) && (*(char *)((int)&DAT_005a5a04 + iVar5) < '\n')) {
              local_314 = local_314 + 1;
              local_310 = local_310 + -1;
              *(char *)((int)&DAT_005a5a04 + iVar5) = *(char *)((int)&DAT_005a5a04 + iVar5) + '\x01'
              ;
            ...
            cVar2 = *(char *)((int)&DAT_005a5a04 + iVar5);
            if (('\0' < cVar2) && (local_2e4[iVar5] < cVar2)) {
              local_314 = local_314 + -1;
              local_310 = local_310 + 1;
              *(char *)((int)&DAT_005a5a04 + iVar5) = cVar2 + -1;
              if ((char)(cVar2 + -1) == '\0') {
                DAT_004c2c9c = DAT_004c2c9c & ~(ushort)(1 << ((byte)iVar5 & 0x1f));
              }
              goto LAB_0045f146;
