...

{
  ...
  do {
    ...
    if (*(int *)(&DAT_00575ad0 + iVar14) == 0) goto LAB_004539e6;
    pcVar5 = &DAT_005794da;
    do {
...
LAB_004539e6:
    ...
    DAT_0051a068._0_1_ = 0;
    pcVar5 = (char *)FUN_004ad425((int)*(char *)(&DAT_00575ab0 + param_1 * 0x82),&DAT_00821c50,10);
    uVar8 = 0xffffffff;
    do {
      pcVar19 = pcVar5;
      if (uVar8 == 0) break;
    ...
    cVar1 = *(char *)(&DAT_00575ab0 + param_1 * 0x82);
    local_158 = 0;
    local_174 = 0;
    piVar13 = local_120;
    ...
    if (*(char *)(&DAT_00575ab0 + param_1 * 0x82) == '\0') {
