...
/* Function: FUN_0047ca10 @ 0x0047CA10 */
/* Body size: 244 addresses */


void __thiscall FUN_0047ca10(int param_1,int *param_2,int *param_3)

{
  ...
  if ((*(uint *)(param_1 + 0x9c) & 0x400) == 0) {
    if ((*(uint *)(param_1 + 0x9c) & 0x11) == 0) goto LAB_0047cac2;
  ...
  if (iVar1 != -1) {
    *param_3 = (iVar1 - *(int *)(param_1 + 0x184)) + iVar2;
  }
LAB_0047cac2:
  if ((*(byte *)(param_1 + 0x9c) & 0x10) != 0) {
    *param_3 = *param_3 + (*(int *)(param_1 + 0x180) - *(int *)(param_1 + 0x184));
  }
