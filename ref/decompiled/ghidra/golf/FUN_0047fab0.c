      ...
      if ((*(byte *)(param_1 + 0xa0) & 2) == 0) {
        ...
        *(int *)(param_1 + 0x1c8) = *(int *)(param_1 + 0x1c8) + iVar3;
        ...
        if (iVar4 != 0) {
          ...
          local_10.left = *piVar1;
          local_10.top = *(LONG *)(iVar4 + 0x1b0);
          local_10.right = *(LONG *)(iVar4 + 0x1b4);
          local_10.bottom = *(LONG *)(iVar4 + 0x1b8);
          *piVar1 = *piVar1 + iVar2;
          *(int *)(iVar4 + 0x1b4) = *(int *)(iVar4 + 0x1b4) + iVar2;
          *(int *)(iVar4 + 0x1b0) = *(int *)(iVar4 + 0x1b0) + iVar3;
          *(int *)(iVar4 + 0x1b8) = *(int *)(iVar4 + 0x1b8) + iVar3;
          UnionRect(&local_10,&local_10,(RECT *)(*(int *)(param_1 + 300) + 0x1ac));
        }
      }
    }
    break;
  default:
    goto switchD_0047fbea_caseD_3;
  case 10:
    if (iVar2 != 0) {
...
joined_r0x00480063:
  ...
  if ((*(byte *)(param_1 + 0xa0) & 2) == 0) {
    local_20.right = *(int *)(param_1 + 0x1b4) - *(int *)(param_1 + 0x1ac);
    local_20.bottom = *(int *)(param_1 + 0x1b8) - *(int *)(param_1 + 0x1b0);
    local_20.left = 0;
    local_20.top = 0;
    FUN_0047b0d0(&local_20);
  }
  else {
  ...
  UnionRect(&local_30,&local_30,&local_20);
  if (*(int *)(param_1 + 300) != 0) {
    UnionRect(&local_30,&local_30,&local_10);
  }
