...
/* Function: FUN_10018d10 @ 0x10018D10 */
/* Body size: 666 addresses */


int __cdecl FUN_10018d10(undefined4 *param_1,int *param_2,int param_3,int param_4,int param_5)
  ...
  do {
    while( true ) {
      ...
      *(short *)(local_30 + 6) = *(short *)(local_30 + 6) + (ushort)(0xffffa31e < uVar2);
      ...
      psVar8 = local_c;
      local_c = psVar3;
      if (iVar6 + -1 == 0) goto LAB_10018f23;
    }
    iVar5 = iVar6 + -1;
  } while (iVar6 + -1 != 0);
LAB_10018f23:
