...
/* Function: FUN_10024ee0 @ 0x10024EE0 */
/* Body size: 3710 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined4 __thiscall FUN_10024ee0(void *this,int *param_1,int param_2,int param_3,char param_4)
        ...
        do {
          do {
            if ((*pbVar6 != 0xff) && ((param_4 == '\0' || (*pbVar6 < 0xf8)))) {
              ...
              *puVar12 = ((ushort)(((uVar8 & 0xf81f) * 0x10 + iVar7 >> 1) + iVar7 >> 1) & 0x81f0) +
                         ((ushort)(((uVar8 & 0x7e0) * 0x10 + iVar9 >> 1) + iVar9 >> 1) & 0x7e00);
            }
            pbVar6 = pbVar6 + -1;
            puVar12 = puVar12 + 1;
            iVar5 = iVar5 + -1;
      ...
      do {
        ...
        do {
          if ((*pbVar6 != 0xff) && ((param_4 == '\0' || (*pbVar6 < 0xf8)))) {
            ...
            iVar9 = (*puVar12 & 0x7e0) * 0x10;
            *puVar12 = ((ushort)(((uVar8 & 0xf81f) * 0x10 + iVar5 >> 1) + iVar5 >> 1) & 0x81f0) +
                       ((ushort)(((uVar8 & 0x7e0) * 0x10 + iVar9 >> 1) + iVar9 >> 1) & 0x7e00);
          }
          uVar8 = (ushort)uVar11;
