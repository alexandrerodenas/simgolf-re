...

{
  ...
  local_10 = param_1;
  CreateFileA(param_1,0x80000000,1,(LPSECURITY_ATTRIBUTES)0x0,3,(DWORD)local_c,(HANDLE)0x0);
  uVar1 = __chkesp();
  *(undefined4 *)((int)local_8 + 8) = uVar1;
  if (*(int *)((int)local_8 + 8) == -1) {
    ...
    CreateFileMappingA(*(HANDLE *)((int)local_8 + 8),(LPSECURITY_ATTRIBUTES)0x0,2,0,0,(LPCSTR)0x0);
    uVar1 = __chkesp();
    *(undefined4 *)((int)local_8 + 0xc) = uVar1;
    if (*(int *)((int)local_8 + 0xc) == 0) {
      ...
      MapViewOfFile(*(HANDLE *)((int)local_8 + 0xc),4,0,0,0);
      uVar1 = __chkesp();
