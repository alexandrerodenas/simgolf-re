...
/* Function: FUN_10032e80 @ 0x10032E80 */
/* Body size: 970 addresses */


int __cdecl
FUN_10032e80(LCID param_1,DWORD param_2,byte *param_3,int param_4,byte *param_5,int param_6,
            UINT param_7)

{
  ...
  local_1c = puVar2;
  if (0 < param_4) {
    param_4 = FUN_10033280((char *)param_3,param_4);
  }
  if (0 < param_6) {
    param_6 = FUN_10033280((char *)param_5,param_6);
  }
  if (DAT_10110b0c == 2) {
    iVar3 = CompareStringA(param_1,param_2,(PCNZCH)param_3,param_4,(PCNZCH)param_5,param_6);
  }
  else if (DAT_10110b0c == 1) {
    if (param_7 == 0) {
    ...
    if ((param_4 == 0) || (param_6 == 0)) {
      ...
      if ((((param_4 != 0) || (param_6 != 1)) && ((param_4 != 1 || (param_6 != 0)))) &&
         (iVar3 = FUN_1001a320(2,0x10061238,0xb6,0,
                               (byte *)
