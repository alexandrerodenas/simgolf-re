...
/* Body size: 3085 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* WARNING: Restarted to delay deadcode elimination for space: stack */

undefined4 __thiscall FUN_10011b70(void *this,int *param_1,int param_2,int param_3,int param_4)

{
  ...
  if (((DAT_100550fc ^ (int)DAT_100550fc >> 0x1f) - ((int)DAT_100550fc >> 0x1f) == iVar2) &&
    ...
    if ((int)DAT_100550fc < 0) {
      if ((int)DAT_10055100 < 0) {
        ...
        iVar9 = DAT_10057c24;
        iVar2 = DAT_10057c00;
        puVar12 = (undefined2 *)(iVar5 + (DAT_10057c14 * local_1c.top + local_1c.left) * 2);
        ...
        do {
          do {
            if (*pbVar6 != 0xff) {
              *puVar12 = *(undefined2 *)(iVar2 + (uint)*(ushort *)(iVar9 + (uint)*pbVar6 * 2) * 2);
            }
            pbVar6 = pbVar6 + -1;
            puVar12 = puVar12 + 1;
            iVar5 = iVar5 + -1;
          ...
          puVar12 = (undefined2 *)((int)puVar12 + _DAT_10057c18);
  ...
  puVar12 = (undefined2 *)(iVar2 + (DAT_10057c14 * local_1c.top + local_1c.left) * 2);
  DAT_10057c14 = (**(code **)(*param_1 + 0xe0))();
  DAT_10057c1c = local_1c.right - local_1c.left;
  _DAT_10057c18 = (DAT_10057c14 - DAT_10057c1c) * 2;
  DAT_10057c30 = local_1c.bottom - local_1c.top;
  ...
  if ((int)DAT_100550fc < 0) {
    if ((int)DAT_10055100 < 0) {
      ...
      DAT_10057c10 = (local_1c.top - iVar9) * DAT_10057bf8;
      ...
      *(int *)PTR_DAT_10055108 = *(int *)PTR_DAT_1005510c + DAT_10057c34;
      ...
      do {
        iVar10 = CONCAT22((short)((uint)DAT_10057c1c >> 0x10),DAT_10057c40);
        ...
        do {
          ...
          uVar7 = (ushort)uVar11;
          uVar11 = CONCAT22((short)(uVar11 >> 0x10),uVar7 + (ushort)iVar10);
    ...
    *(uint *)PTR_DAT_1005510c = (DAT_10057bf8 >> 0x10) * DAT_10057c34 + _DAT_10057c28;
    pbVar6 = (byte *)((iVar5 - uVar11) + iVar2 + -1 + iVar9);
    *(int *)PTR_DAT_10055108 = *(int *)PTR_DAT_1005510c + DAT_10057c34;
    iVar9 = DAT_10057c24;
    iVar2 = DAT_10057c00;
    iVar5 = DAT_10057c10 << 0x10;
  ...
  if ((int)DAT_10055100 < 0) {
    ...
    _DAT_10057c28 = _DAT_10057c40 * DAT_10057c1c + (_DAT_10057c0c & 0xffff) >> 0x10;
    _DAT_10057c3c = DAT_10057bf8 * DAT_10057c30 + (DAT_10057c10 & 0xffff) >> 0x10;
    iVar9 = ((*(int *)((int)local_8 + 0x34) - (DAT_10057c10 >> 0x10)) + -1) * DAT_10057c34;
    uVar11 = _DAT_10057c0c >> 0x10;
    iVar2 = *(int *)((int)local_8 + 0x14);
    *(uint *)PTR_DAT_1005510c = (DAT_10057bf8 >> 0x10) * DAT_10057c34 + _DAT_10057c28;
    pbVar6 = (byte *)(iVar9 + uVar11 + iVar2);
    *(int *)PTR_DAT_10055108 = *(int *)PTR_DAT_1005510c + DAT_10057c34;
    iVar9 = DAT_10057c24;
    iVar2 = DAT_10057c00;
    iVar5 = DAT_10057c10 << 0x10;
