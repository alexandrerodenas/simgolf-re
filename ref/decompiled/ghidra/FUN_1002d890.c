...
/* Body size: 4258 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __thiscall FUN_1002d890(void *this,int *param_1,int param_2,int param_3,char param_4)

{
  ...
  if ((*(int *)((int)this + 0x14) == 0) || (param_1 == (int *)0x0)) goto LAB_1002e91c;
  local_8 = this;
  (**(code **)(*param_1 + 0x10))();
  iVar3 = __chkesp();
  if (iVar3 == 0) goto LAB_1002e91c;
  ...
  if (iVar3 == iVar1) {
    ...
    iVar1 = FUN_1007f370(DAT_10122dc8);
    if (iVar3 != iVar1) goto LAB_1002dfac;
        ...
        do {
          do {
            if ((*pbVar7 != 0xff) && ((param_4 == '\0' || (*pbVar7 < 0xf8)))) {
              ...
              *puVar9 = (ushort)(((uVar4 & 0x7c1f) * 0x10 + (*puVar9 & 0x7c1f) * 0x10 >> 1 & 0x7c1f0
                                 ) + ((uVar4 & 0x3e0) * 0x10 + (*puVar9 & 0x3e0) * 0x10 >> 1 &
                                     0x3e00) >> 4);
            }
            pbVar7 = pbVar7 + -1;
            puVar9 = puVar9 + 1;
      ...
      do {
        do {
          if ((*pbVar7 != 0xff) && ((param_4 == '\0' || (*pbVar7 < 0xf8)))) {
            uVar4 = *(ushort *)(iVar3 + (uint)*pbVar7 * 2);
            *puVar9 = (ushort)(((uVar4 & 0x7c1f) * 0x10 + (*puVar9 & 0x7c1f) * 0x10 >> 1 & 0x7c1f0)
                               + ((uVar4 & 0x3e0) * 0x10 + (*puVar9 & 0x3e0) * 0x10 >> 1 & 0x3e00)
                              >> 4);
          }
          pbVar7 = pbVar7 + 1;
          puVar9 = puVar9 + 1;
