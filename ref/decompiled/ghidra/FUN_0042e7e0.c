...

{
  ...
  uVar6 = 0;
  iVar19 = (-(uint)((_DAT_0059e7b8 & 0x100) != 0) & 0x5a) + 0xa0;
  local_38 = iVar19;
  do {
    ...
    if ((int)uVar16 <= iVar19) {
      ...
      do {
        ...
        if ((((-1 < iVar22) && (-1 < iVar23)) && (iVar22 < 0x32)) && (iVar23 < 0x32)) {
          ...
          if (((_DAT_0059e7b8 & 0x100) != 0) || ((&DAT_005794d9)[param_5 * 0x100] == '\x13')) {
  ...
  uVar16 = uVar6;
  if ((((_DAT_0059e7b8 & 0x100) == 0) && (*(char *)((int)&DAT_005722e8 + iVar10) == '\x11')) &&
    ...
    if (uVar6 < 7) {
      ...
      uVar16 = uVar16 & 7;
      if (uVar16 != uVar6) {
        _DAT_0059e7b8 = _DAT_0059e7b8 | 0x80000;
      }
    }
  }
LAB_0042ee26:
