...
/* Function: FUN_100985a0 @ 0x100985A0 */
/* Body size: 195 addresses */


void __cdecl FUN_100985a0(int *param_1,uint param_2,int param_3)

{
  ...
  local_8 = &PTR_s_November_101269e0;
  if (param_2 != 0) {
    if ((int)param_2 < 0) {
      param_2 = -param_2;
      local_8 = (undefined **)&DAT_10126b40;
    }
    ...
    while (param_2 != 0) {
      ...
      if (uVar1 != 0) {
        ...
        FUN_10098160(param_1,(int *)local_c);
      }
    }
  }
  return;
