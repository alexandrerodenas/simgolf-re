...
/* Function: FUN_10061db0 @ 0x10061DB0 */
/* Body size: 3300 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* WARNING: Restarted to delay deadcode elimination for space: stack */

void __thiscall FUN_10061db0(void *this,int *param_1,int param_2,int param_3,int param_4)

{
  ...
  if ((*(int *)((int)this + 0x14) == 0) || (param_1 == (int *)0x0)) goto LAB_10062a81;
  local_8 = this;
  (**(code **)(*param_1 + 0x10))();
  iVar4 = __chkesp();
  if (iVar4 == 0) goto LAB_10062a81;
  ...
  if (iVar4 == iVar2) {
    ...
    iVar2 = FUN_1007f370(DAT_10122dc8);
    if (iVar4 != iVar2) goto LAB_1006229f;
    ...
    if (DAT_10122dc0 < 0) {
      if (DAT_10122dc4 < 0) {
        ...
        do {
          do {
            if (*pbVar8 < 0xfe) {
              *puVar10 = *(undefined1 *)(iVar4 + (uint)*pbVar8);
            }
            pbVar8 = pbVar8 + -1;
            puVar10 = puVar10 + 1;
            iVar2 = iVar2 + -1;
