...
/* Body size: 3077 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* WARNING: Restarted to delay deadcode elimination for space: stack */

undefined4 __thiscall FUN_10010f60(void *this,int *param_1,int param_2,int param_3,int param_4)
    ...
    if ((int)DAT_100550fc < 0) {
      if ((int)DAT_10055100 < 0) {
        ...
        do {
          do {
            if (*pbVar6 != 0xff) {
              *puVar12 = *(undefined2 *)(iVar9 + (uint)*(byte *)(iVar2 + (uint)*pbVar6) * 2);
            }
            pbVar6 = pbVar6 + -1;
            puVar12 = puVar12 + 1;
            iVar5 = iVar5 + -1;
