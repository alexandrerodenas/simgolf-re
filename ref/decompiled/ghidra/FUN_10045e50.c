...
/* Function: FUN_10045e50 @ 0x10045E50 */
/* Body size: 4378 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __thiscall FUN_10045e50(void *this,int *param_1,int param_2,int param_3,char param_4)

{
  ...
  if ((*(int *)((int)this + 0x14) == 0) || (param_1 == (int *)0x0)) goto LAB_10046f54;
  local_8 = this;
  (**(code **)(*param_1 + 0x10))();
  iVar3 = __chkesp();
  if (iVar3 == 0) goto LAB_10046f54;
  ...
  if (iVar3 == iVar1) {
    ...
    iVar1 = FUN_1007f370(DAT_10122dc8);
    if (iVar3 != iVar1) goto LAB_100465b0;
    ...
    if (DAT_10122dc0 < 0) {
      if (DAT_10122dc4 < 0) {
        ...
        do {
          do {
            if ((*pbVar8 != 0xff) && ((param_4 == '\0' || (*pbVar8 < 0xf8)))) {
              uVar5 = *(ushort *)(iVar3 + (uint)*pbVar8 * 2);
              iVar4 = (*puVar10 & 0xf81f) * 0x10;
              iVar6 = (*puVar10 & 0x7e0) * 0x10;
              *puVar10 = ((ushort)((((uVar5 & 0xf81f) * 0x10 + iVar4 >> 1) + iVar4 >> 1) + iVar4 >>
                                  1) & 0x81f0) +
                         ((ushort)((((uVar5 & 0x7e0) * 0x10 + iVar6 >> 1) + iVar6 >> 1) + iVar6 >> 1
                                  ) & 0x7e00);
            }
            pbVar8 = pbVar8 + -1;
            puVar10 = puVar10 + 1;
      ...
      do {
        do {
          if ((*pbVar8 != 0xff) && ((param_4 == '\0' || (*pbVar8 < 0xf8)))) {
            ...
            iVar4 = (*puVar10 & 0xf81f) * 0x10;
            iVar6 = (*puVar10 & 0x7e0) * 0x10;
            *puVar10 = ((ushort)((((uVar5 & 0xf81f) * 0x10 + iVar4 >> 1) + iVar4 >> 1) + iVar4 >> 1)
                       & 0x81f0) +
                       ((ushort)((((uVar5 & 0x7e0) * 0x10 + iVar6 >> 1) + iVar6 >> 1) + iVar6 >> 1)
                       & 0x7e00);
          }
...
LAB_100465b0:
    ...
    lVar11 = __ftol();
    thunk_FUN_10008360(&local_18.left,param_2 + (int)lVar11,iVar4,iVar1,iVar3);
    local_28 = local_18.left;
    local_24 = local_18.top;
    local_20 = local_18.right;
    local_1c = local_18.bottom;
    ...
    if (DAT_10122dc0 < 0) {
      if (DAT_10122dc4 < 0) {
        ...
        *(int *)PTR_DAT_10122e1c = *(int *)PTR_DAT_10122e20 + DAT_1012857c;
        ...
        puVar10 = local_2c;
        do {
          iVar4 = CONCAT22((short)((uint)DAT_10128564 >> 0x10),DAT_10128588);
          uVar7 = CONCAT22((short)((uint)iVar1 >> 0x10),DAT_10128554);
          do {
            if ((*pbVar8 != 0xff) && ((param_4 == '\0' || (*pbVar8 < 0xf8)))) {
              uVar5 = *(ushort *)(iVar3 + (uint)*pbVar8 * 2);
              iVar1 = (*puVar10 & 0xf81f) * 0x10;
              iVar6 = (*puVar10 & 0x7e0) * 0x10;
              *puVar10 = ((ushort)((((uVar5 & 0xf81f) * 0x10 + iVar1 >> 1) + iVar1 >> 1) + iVar1 >>
                                  1) & 0x81f0) +
                         ((ushort)((((uVar5 & 0x7e0) * 0x10 + iVar6 >> 1) + iVar6 >> 1) + iVar6 >> 1
                                  ) & 0x7e00);
            }
            uVar5 = (ushort)uVar7;
            uVar7 = CONCAT22((short)(uVar7 >> 0x10),uVar5 + (ushort)iVar4);
            pbVar8 = pbVar8 + (-(uint)CARRY2(uVar5,(ushort)iVar4) - _DAT_10128580);
            puVar10 = puVar10 + 1;
            iVar4 = iVar4 + -0x10000;
          } while (-1 < iVar4);
          puVar10 = (ushort *)((int)puVar10 + _DAT_10128560);
          iVar1 = uVar7 + _DAT_10128544;
          pbVar8 = pbVar8 + *(int *)(PTR_DAT_10122e20 + (uint)CARRY4(uVar7,_DAT_10128544) * -4);
          DAT_10128578 = DAT_10128578 + -1;
        } while (DAT_10128578 != 0);
      }
      else {
      ...
      do {
        ...
        do {
          if ((*pbVar8 != 0xff) && ((param_4 == '\0' || (*pbVar8 < 0xf8)))) {
            ...
            iVar1 = (*puVar10 & 0xf81f) * 0x10;
            iVar6 = (*puVar10 & 0x7e0) * 0x10;
            *puVar10 = ((ushort)((((uVar5 & 0xf81f) * 0x10 + iVar1 >> 1) + iVar1 >> 1) + iVar1 >> 1)
                       & 0x81f0) +
                       ((ushort)((((uVar5 & 0x7e0) * 0x10 + iVar6 >> 1) + iVar6 >> 1) + iVar6 >> 1)
                       & 0x7e00);
          }
          uVar5 = (ushort)uVar7;
          uVar7 = CONCAT22((short)(uVar7 >> 0x10),uVar5 + (ushort)iVar4);
          pbVar8 = pbVar8 + CARRY2(uVar5,(ushort)iVar4) + _DAT_10128580;
          puVar10 = puVar10 + 1;
          iVar4 = iVar4 + -0x10000;
        } while (-1 < iVar4);
        puVar10 = (ushort *)((int)puVar10 + _DAT_10128560);
