...
/* Function: FUN_10027ab0 @ 0x10027AB0 */
/* Body size: 250 addresses */


void __cdecl FUN_10027ab0(char *param_1,int param_2,int param_3)
  ...
  *local_8 = '\0';
  ...
  if (*param_1 == '1') {
    *(int *)(param_3 + 4) = *(int *)(param_3 + 4) + 1;
    ...
    FUN_10024410((undefined4 *)param_1,(undefined4 *)(param_1 + 1),sVar3 + 1);
  }
  return;
}
