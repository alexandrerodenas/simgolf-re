...
/* Function: FUN_100276a0 @ 0x100276A0 */


undefined4 __cdecl FUN_100276a0(ushort *param_1,uint *param_2,int *param_3)

{
  ...
  if (local_8 == -0x3fff) {
    ...
    iVar1 = FUN_10027410((int)&local_1c,param_3[2]);
    if (iVar1 != 0) {
      local_8 = local_8 + 1;
    }
    if (local_8 < param_3[1] - param_3[2]) {
      ...
      FUN_10027410((int)&local_1c,param_3[2]);
