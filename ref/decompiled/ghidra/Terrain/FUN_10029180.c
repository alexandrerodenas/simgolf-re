...
/* Function: FUN_10029180 @ 0x10029180 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

float10 __cdecl FUN_10029180(uint param_1,uint param_2,int *param_3)

{
  ...
  if ((double)CONCAT26(param_2._2_2_,CONCAT24((ushort)param_2,param_1)) == _DAT_1005f368) {
    local_10 = 0.0;
    local_8 = 0;
  }
    ...
    fVar3 = FUN_10029010(param_1,CONCAT22(param_2._2_2_,(ushort)param_2),0);
    local_10 = (double)fVar3;
  }
  else {
    fVar3 = FUN_10029010(param_1,param_2,0);
    local_10 = (double)fVar3;
