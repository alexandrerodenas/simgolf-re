...
/* Function: FUN_10026240 @ 0x10026240 */
/* Body size: 3668 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* WARNING: Restarted to delay deadcode elimination for space: stack */

void __thiscall FUN_10026240(void *this,int *param_1,int param_2,int param_3,int param_4)

{
  ...
  if ((*(int *)((int)this + 0x14) == 0) || (param_1 == (int *)0x0)) goto LAB_1002707e;
  local_8 = this;
  (**(code **)(*param_1 + 0x10))();
  iVar4 = __chkesp();
  if (iVar4 == 0) goto LAB_1002707e;
  ...
  if (local_48 == 0) {
    ...
    if (local_48 != 1) goto LAB_1002707e;
    (**(code **)(*local_3c + 0x1c))();
    DAT_1012856c = __chkesp();
  }
  ...
  if (iVar4 == iVar1) {
    ...
    iVar1 = FUN_1007f370(DAT_10122dc8);
    if (iVar4 != iVar1) goto LAB_10026832;
    ...
    if (DAT_10122dc0 < 0) {
      if (DAT_10122dc4 < 0) {
        ...
        do {
          do {
            if (*pbVar8 != 0xff) {
              *puVar10 = *(undefined2 *)(iVar1 + (uint)*(byte *)(iVar4 + (uint)*pbVar8) * 2);
            }
            pbVar8 = pbVar8 + -1;
            puVar10 = puVar10 + 1;
            iVar3 = iVar3 + -1;
