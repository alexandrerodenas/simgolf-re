...
/* Function: FUN_10049ea9 @ 0x10049EA9 */
...
void __fastcall
FUN_10049ea9(undefined4 param_1,uint param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  if (((ulonglong)(double)in_ST0 & 0x7ff0000000000000) == 0) {
    fscale(in_ST0,(float10)_DAT_10053dfc);
  }
  else if ((uStack_4 & 0x7ff00000) == 0x7ff00000) {
    fscale(in_ST0,(float10)_DAT_10053df4);
  }
  ...
  if (param_2 == 0x1d) {
    FUN_10049d60(param_1,0x1d,unaff_retaddr,param_3,param_4,param_5,param_6,param_7);
    return;
  }
