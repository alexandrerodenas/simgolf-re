...
/* Function: FUN_10027aa0 @ 0x10027AA0 */
/* Body size: 3774 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined4 __thiscall FUN_10027aa0(void *this,int *param_1,int param_2,int param_3,char param_4)

{
        ...
        do {
          do {
            if ((*pbVar6 != 0xff) && ((param_4 == '\0' || (*pbVar6 < 0xf8)))) {
              uVar8 = *(ushort *)(iVar2 + (uint)*pbVar6 * 2);
              iVar7 = (uVar8 & 0xf81f) * 0x10;
              iVar9 = (uVar8 & 0x7e0) * 0x10;
              *puVar12 = ((ushort)((((*puVar12 & 0xf81f) * 0x10 + iVar7 >> 1) + iVar7 >> 1) + iVar7
                                  >> 1) & 0x81f0) +
                         ((ushort)((((*puVar12 & 0x7e0) * 0x10 + iVar9 >> 1) + iVar9 >> 1) + iVar9
                                  >> 1) & 0x7e00);
            }
            pbVar6 = pbVar6 + -1;
            puVar12 = puVar12 + 1;
    ...
    do {
      do {
        if ((*pbVar6 != 0xff) && ((param_4 == '\0' || (*pbVar6 < 0xf8)))) {
          ...
          iVar7 = (uVar8 & 0xf81f) * 0x10;
          iVar9 = (uVar8 & 0x7e0) * 0x10;
          *puVar12 = ((ushort)((((*puVar12 & 0xf81f) * 0x10 + iVar7 >> 1) + iVar7 >> 1) + iVar7 >> 1
                              ) & 0x81f0) +
                     ((ushort)((((*puVar12 & 0x7e0) * 0x10 + iVar9 >> 1) + iVar9 >> 1) + iVar9 >> 1)
                     & 0x7e00);
        }
        pbVar6 = pbVar6 + 1;
        puVar12 = puVar12 + 1;
  ...
  lVar13 = __ftol();
  LVar1 = local_1c.left;
  local_1c.bottom = (int)lVar13 + iVar5;
  pRVar3 = (RECT *)(**(code **)(*param_1 + 0xcc))();
  BVar4 = IntersectRect(&local_1c,&local_1c,pRVar3);
  if (BVar4 == 0) {
    (**(code **)(*param_1 + 0x24))(1);
  ...
  if ((int)DAT_100550fc < 0) {
      ...
      *(int *)PTR_DAT_10055108 = *(int *)PTR_DAT_1005510c + DAT_10057c34;
      ...
      do {
        ...
        do {
          if ((*pbVar6 != 0xff) && ((param_4 == '\0' || (*pbVar6 < 0xf8)))) {
            uVar8 = *(ushort *)(iVar2 + (uint)*pbVar6 * 2);
            iVar5 = (uVar8 & 0xf81f) * 0x10;
            iVar9 = (uVar8 & 0x7e0) * 0x10;
            *puVar12 = ((ushort)((((*puVar12 & 0xf81f) * 0x10 + iVar5 >> 1) + iVar5 >> 1) + iVar5 >>
                                1) & 0x81f0) +
                       ((ushort)((((*puVar12 & 0x7e0) * 0x10 + iVar9 >> 1) + iVar9 >> 1) + iVar9 >>
                                1) & 0x7e00);
          }
          uVar8 = (ushort)uVar11;
          uVar11 = CONCAT22((short)(uVar11 >> 0x10),uVar8 + (ushort)iVar7);
          pbVar6 = pbVar6 + (-(uint)CARRY2(uVar8,(ushort)iVar7) - _DAT_10057c38);
          puVar12 = puVar12 + 1;
          iVar7 = iVar7 + -0x10000;
        } while (-1 < iVar7);
        puVar12 = (ushort *)((int)puVar12 + _DAT_10057c18);
        iVar5 = uVar11 + _DAT_10057bfc;
        pbVar6 = pbVar6 + *(int *)(PTR_DAT_1005510c + (uint)CARRY4(uVar11,_DAT_10057bfc) * -4);
        DAT_10057c30 = DAT_10057c30 + -1;
      } while (DAT_10057c30 != 0);
      (**(code **)(*param_1 + 0x24))(2);
      return 0;
    ...
    *(uint *)PTR_DAT_1005510c = (DAT_10057bf8 >> 0x10) * DAT_10057c34 + _DAT_10057c28;
    pbVar6 = (byte *)((iVar7 - uVar11) + iVar2 + -1 + iVar5);
    *(int *)PTR_DAT_10055108 = *(int *)PTR_DAT_1005510c + DAT_10057c34;
    iVar2 = DAT_10057c24;
    iVar5 = DAT_10057c10 << 0x10;
    DAT_10057c1c = (DAT_10057c1c + -1) * 0x10000;
    ...
    do {
      ...
      do {
        if ((*pbVar6 != 0xff) && ((param_4 == '\0' || (*pbVar6 < 0xf8)))) {
          ...
          iVar5 = (uVar8 & 0xf81f) * 0x10;
          iVar9 = (uVar8 & 0x7e0) * 0x10;
          *puVar12 = ((ushort)((((*puVar12 & 0xf81f) * 0x10 + iVar5 >> 1) + iVar5 >> 1) + iVar5 >> 1
                              ) & 0x81f0) +
                     ((ushort)((((*puVar12 & 0x7e0) * 0x10 + iVar9 >> 1) + iVar9 >> 1) + iVar9 >> 1)
                     & 0x7e00);
        }
  ...
  if ((int)DAT_10055100 < 0) {
    ...
    *(uint *)PTR_DAT_1005510c = (DAT_10057bf8 >> 0x10) * DAT_10057c34 + _DAT_10057c28;
    pbVar6 = (byte *)(iVar5 + uVar11 + iVar2);
    *(int *)PTR_DAT_10055108 = *(int *)PTR_DAT_1005510c + DAT_10057c34;
    iVar2 = DAT_10057c24;
    iVar5 = DAT_10057c10 << 0x10;
    DAT_10057c1c = (DAT_10057c1c + -1) * 0x10000;
    ...
    do {
      ...
      do {
        ...
        uVar8 = (ushort)uVar11;
        uVar11 = CONCAT22((short)(uVar11 >> 0x10),uVar8 + (ushort)iVar7);
        pbVar6 = pbVar6 + CARRY2(uVar8,(ushort)iVar7) + _DAT_10057c38;
        puVar12 = puVar12 + 1;
        iVar7 = iVar7 + -0x10000;
      } while (-1 < iVar7);
      puVar12 = (ushort *)((int)puVar12 + _DAT_10057c18);
