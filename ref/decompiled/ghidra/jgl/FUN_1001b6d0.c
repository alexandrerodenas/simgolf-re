...
/* Function: FUN_1001b6d0 @ 0x1001B6D0 */
/* Body size: 3830 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined4 __thiscall FUN_1001b6d0(void *this,int *param_1,int param_2,int param_3,char param_4)
    ...
    if ((int)DAT_100550fc < 0) {
        ...
        do {
          do {
            if ((*pbVar6 != 0xff) && ((param_4 == '\0' || (*pbVar6 < 0xf8)))) {
              ...
              *puVar11 = (ushort)(((uVar7 & 0x7c1f) * 0xf0 + (*puVar11 & 0x7c1f) * 0x10 >> 4 &
                                  0x7c1f0) +
                                  ((uVar7 & 0x3e0) * 0xf0 + (*puVar11 & 0x3e0) * 0x10 >> 4 & 0x3e00)
                                 >> 4);
            }
            pbVar6 = pbVar6 + -1;
            puVar11 = puVar11 + 1;
      ...
      do {
        do {
          if ((*pbVar6 != 0xff) && ((param_4 == '\0' || (*pbVar6 < 0xf8)))) {
            uVar7 = *(ushort *)(iVar2 + (uint)*pbVar6 * 2);
            *puVar11 = (ushort)(((uVar7 & 0x7c1f) * 0xf0 + (*puVar11 & 0x7c1f) * 0x10 >> 4 & 0x7c1f0
                                ) + ((uVar7 & 0x3e0) * 0xf0 + (*puVar11 & 0x3e0) * 0x10 >> 4 &
                                    0x3e00) >> 4);
          }
          pbVar6 = pbVar6 + -1;
          puVar11 = puVar11 + 1;
  ...
  do {
    ...
    do {
      if ((*pbVar6 != 0xff) && ((param_4 == '\0' || (*pbVar6 < 0xf8)))) {
        uVar7 = *(ushort *)(iVar2 + (uint)*pbVar6 * 2);
        *puVar11 = (ushort)(((uVar7 & 0x7c1f) * 0xf0 + (*puVar11 & 0x7c1f) * 0x10 >> 4 & 0x7c1f0) +
                            ((uVar7 & 0x3e0) * 0xf0 + (*puVar11 & 0x3e0) * 0x10 >> 4 & 0x3e00) >> 4)
        ;
      }
      uVar7 = (ushort)uVar10;
      uVar10 = CONCAT22((short)(uVar10 >> 0x10),uVar7 + (ushort)iVar9);
