...
/* Function: FUN_10037e60 @ 0x10037E60 */
/* Body size: 2938 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* WARNING: Restarted to delay deadcode elimination for space: stack */

undefined4 __thiscall FUN_10037e60(void *this,int *param_1,int param_2,int param_3,int param_4)

{
  ...
  if (((DAT_100550fc ^ (int)DAT_100550fc >> 0x1f) - ((int)DAT_100550fc >> 0x1f) == iVar2) &&
    ...
    if ((int)DAT_100550fc < 0) {
      if ((int)DAT_10055100 < 0) {
        ...
        pbVar11 = (byte *)(DAT_10057cd4 * local_1c.top + local_1c.left + iVar6);
        ...
        do {
          do {
            if (*pbVar5 < 0xfe) {
              if (*pbVar5 == 0xf8) {
                *pbVar11 = *(byte *)(iVar2 + (uint)*pbVar11);
              }
              else {
                *pbVar11 = *pbVar5;
              }
  ...
  if ((int)DAT_100550fc < 0) {
    if ((int)DAT_10055100 < 0) {
      ...
      pbVar11 = (byte *)((((*(int *)((int)local_8 + 0x34) - (DAT_10057cd0 >> 0x10)) + -1) *
      ...
      *(int *)PTR_DAT_10055118 = *(int *)PTR_DAT_1005511c + DAT_10057d08;
      ...
      do {
        ...
        do {
          if (*pbVar11 < 0xfe) {
            if (*pbVar11 == 0xf8) {
              uVar10 = CONCAT31((int3)(uVar10 >> 8),*pbVar5);
              *pbVar5 = *(byte *)(iVar2 + uVar10);
            }
            else {
              *pbVar5 = *pbVar11;
            }
          ...
          pbVar11 = pbVar11 + (-(uint)CARRY2(uVar7,(ushort)iVar9) - _DAT_10057d0c);
          pbVar5 = pbVar5 + 1;
          iVar9 = iVar9 + -0x10000;
        } while (-1 < iVar9);
        pbVar5 = pbVar5 + _DAT_10057cd8;
        iVar6 = uVar8 + _DAT_10057cb8;
        pbVar11 = pbVar11 + *(int *)(PTR_DAT_1005511c + (uint)CARRY4(uVar8,_DAT_10057cb8) * -4);
        DAT_10057d00 = DAT_10057d00 + -1;
      } while (DAT_10057d00 != 0);
      (**(code **)(*param_1 + 0x24))(2);
      return 0;
    ...
    *(uint *)PTR_DAT_1005511c = (DAT_10057cb4 >> 0x10) * DAT_10057d08 + _DAT_10057cf0;
    pbVar11 = (byte *)((iVar9 - uVar10) + iVar2 + -1 + iVar6);
    *(int *)PTR_DAT_10055118 = *(int *)PTR_DAT_1005511c + DAT_10057d08;
    iVar2 = DAT_10057cbc;
    iVar6 = DAT_10057cd0 << 0x10;
    DAT_10057ce0 = (DAT_10057ce0 + -1) * 0x10000;
  ...
  if ((int)DAT_10055100 < 0) {
    ...
    *(uint *)PTR_DAT_1005511c = (DAT_10057cb4 >> 0x10) * DAT_10057d08 + _DAT_10057cf0;
    pbVar11 = (byte *)(iVar6 + uVar10 + iVar2);
    *(int *)PTR_DAT_10055118 = *(int *)PTR_DAT_1005511c + DAT_10057d08;
    iVar2 = DAT_10057cbc;
    iVar6 = DAT_10057cd0 << 0x10;
    DAT_10057ce0 = (DAT_10057ce0 + -1) * 0x10000;
    ...
    do {
      ...
      do {
        ...
        uVar7 = (ushort)uVar8;
        uVar8 = CONCAT22((short)(uVar8 >> 0x10),uVar7 + (ushort)iVar9);
        pbVar11 = pbVar11 + CARRY2(uVar7,(ushort)iVar9) + _DAT_10057d0c;
        pbVar5 = pbVar5 + 1;
        iVar9 = iVar9 + -0x10000;
      } while (-1 < iVar9);
      pbVar5 = pbVar5 + _DAT_10057cd8;
  ...
  pbVar11 = (byte *)((DAT_10057cd0 >> 0x10) * DAT_10057d08 + (_DAT_10057ccc >> 0x10) +
