...
/* Function: FUN_10010cd0 @ 0x10010CD0 */
/* Body size: 654 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* WARNING: Restarted to delay deadcode elimination for space: stack */

undefined4 __thiscall FUN_10010cd0(void *this,int param_1,int *param_2,int param_3,int param_4)

{
  ...
  local_18.right = *(int *)((int)this + 0x30) + param_3;
  local_18.bottom = *(int *)((int)this + 0x34) + param_4;
  local_18.left = param_3;
  local_18.top = param_4;
  lprcSrc2 = (RECT *)(**(code **)(*param_2 + 0xcc))();
  BVar5 = IntersectRect(&local_18,&local_18,lprcSrc2);
  if (BVar5 != 0) {
    iVar4 = (local_18.top - param_4) * DAT_10057c34;
    local_8 = (byte *)((*(int *)((int)this + 0x14) - param_3) + iVar4 + local_18.left);
    pbVar7 = (byte *)((*(int *)(param_1 + 0x14) - param_3) + iVar4 + local_18.left);
    iVar6 = (**(code **)(*param_2 + 0x20))();
    iVar4 = DAT_10057c24;
    puVar10 = (ushort *)(iVar6 + (DAT_10057c14 * local_18.top + local_18.left) * 2);
    ...
    do {
      do {
        if ((*pbVar9 != 0xff) && (*pbVar7 != 0xff)) {
          if (*pbVar7 == 0) {
            *puVar10 = *(ushort *)(iVar4 + (uint)*pbVar9 * 2);
          }
          else {
            uVar2 = *(ushort *)(iVar4 + (uint)*pbVar9 * 2);
            uVar3 = *puVar10;
            bVar1 = *pbVar7;
            *puVar10 = ((ushort)(((ushort)((ushort)((byte)(uVar3 >> 7) & 0xf8) * (ushort)bVar1) >> 8
                                 ) + (uVar2 >> 7 & 0xf8)) >> 3) << 10 |
