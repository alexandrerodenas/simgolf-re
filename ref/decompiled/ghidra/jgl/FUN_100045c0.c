...
undefined4 __thiscall FUN_100045c0(void *this,int *param_1,uint param_2)

{
  ...
  if ((BVar6 != 0) &&
     ...
     puVar7 != (ushort *)0x0)) {
    uVar15 = RStack_10.top - iStack_14;
    iVar4 = RStack_10.left - iStack_18;
    if ((int)param_1 < 0) {
      param_1 = (int *)0x0;
    }
    ...
    uVar9 = RStack_10.bottom & 0xff;
    while (uVar15 != 0) {
      uVar15 = uVar15 - 1;
      uVar11 = uVar15 & 0x80000001;
      bVar17 = uVar11 == 0;
      if ((int)uVar11 < 0) {
        bVar17 = (uVar11 - 1 | 0xfffffffe) == 0xffffffff;
      }
      iVar8 = iVar4;
      if (!bVar17) {
        puVar7 = puVar7 + 1;
      ...
      if (0 < iVar8) {
        ...
        do {
          ...
          uVar14 = ((int)((RStack_10.bottom & 0xffU) * iVar2) >> 8) + ((int)(uVar9 * iVar13) >> 8);
          uVar1 = *puVar12;
          iVar8 = (**(code **)(*DAT_10057b08 + 0xb4))();
          if (iVar8 == 1) {
      ...
      puVar7 = puVar7 + ((iVar8 - (uint)!bVar17) - iVar4);
    }
