...
FUN_1000dc50(void *this,int *param_1,int param_2,int param_3,int param_4,int param_5)
      ...
      if ((int)DAT_10055100 < 0) {
        ...
        do {
          do {
            if (*pbVar6 < 0xfe) {
              if (*pbVar6 == 0xf8) {
                *puVar11 = *(ushort *)(DAT_10057c2c + (uint)*puVar11 * 2);
              }
              else {
                *puVar11 = *(ushort *)(iVar2 + (uint)*(byte *)(DAT_10057c00 + (uint)*pbVar6) * 2);
              }
            }
            pbVar6 = pbVar6 + -1;
            puVar11 = puVar11 + 1;
