...
/* Function: FUN_10047909 @ 0x10047909 */


undefined4 __cdecl
FUN_10047909(PEXCEPTION_RECORD param_1,PVOID param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  if ((param_1->ExceptionFlags & 0x66) == 0) {
    if (param_5[3] != 0) {
      ...
      FUN_100479a4(param_1,param_2,param_3,param_4,(int)param_5,param_8,param_6,param_7);
    }
  }
  else if ((param_5[1] != 0) && (param_6 == 0)) {
    FUN_10047c50((int)param_2,param_4,(int)param_5,-1);
  }
  return 1;
}
