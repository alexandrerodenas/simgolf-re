...
/* Function: FUN_10033a00 @ 0x10033A00 */
/* Body size: 1499 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined4 __thiscall
FUN_10033a00(void *this,int *param_1,int param_2,undefined2 *param_3,int param_4)
      ...
      if (0 < DAT_10057c94) {
        do {
          ...
          puStack_38 = (undefined2 *)
                       (((uint)pbVar10[1] - (((int)uVar9 < 0) - 1 & uVar9)) -
          ...
          if (0 < (int)puStack_38) {
            ...
            do {
              if (*pbVar15 < 0xfe) {
                *puVar8 = *(undefined2 *)
                           (DAT_10057c6c + (uint)*(ushort *)(DAT_10057ca4 + (uint)*pbVar15 * 2) * 2)
                ;
              }
              puVar8 = puVar8 + 1;
              pbVar15 = pbVar15 + 1;
              puStack_38 = (undefined2 *)((int)puStack_38 + -1);
            } while (puStack_38 != (undefined2 *)0x0);
          }
          pbVar10 = pbVar10 + 4;
              ...
              do {
                ...
                if (-1 < iVar7) {
                  ...
                  if (bVar1 < 0xfe) {
                    *puStack_38 = *(undefined2 *)
                                   (DAT_10057c6c +
                                   (uint)*(ushort *)(DAT_10057ca4 + (uint)bVar1 * 2) * 2);
                    iVar16 = DAT_10057c88;
                  }
                }
