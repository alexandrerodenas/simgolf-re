...
/* Function: FUN_1001f390 @ 0x1001F390 */
/* Body size: 3894 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined4 __thiscall FUN_1001f390(void *this,int *param_1,int param_2,int param_3,char param_4)
        ...
        do {
          do {
            if ((*pbVar6 != 0xff) && ((param_4 == '\0' || (*pbVar6 < 0xf8)))) {
              ...
              *puVar12 = (ushort)((((*puVar12 & 0x7c1f) * 0x70 + iVar7 >> 3) + iVar7 >> 1 & 0x7c1f0)
                                  + (((*puVar12 & 0x3e0) * 0x70 + iVar9 >> 3) + iVar9 >> 1 & 0x3e00)
                                 >> 4);
            }
            pbVar6 = pbVar6 + -1;
            puVar12 = puVar12 + 1;
    ...
    do {
      do {
        if ((*pbVar6 != 0xff) && ((param_4 == '\0' || (*pbVar6 < 0xf8)))) {
          ...
          iVar9 = (uVar8 & 0x3e0) * 0x10;
          *puVar12 = (ushort)((((*puVar12 & 0x7c1f) * 0x70 + iVar7 >> 3) + iVar7 >> 1 & 0x7c1f0) +
                              (((*puVar12 & 0x3e0) * 0x70 + iVar9 >> 3) + iVar9 >> 1 & 0x3e00) >> 4)
          ;
        }
        pbVar6 = pbVar6 + 1;
        puVar12 = puVar12 + 1;
      ...
      do {
        ...
        do {
          if ((*pbVar6 != 0xff) && ((param_4 == '\0' || (*pbVar6 < 0xf8)))) {
            ...
            iVar9 = (uVar8 & 0x3e0) * 0x10;
            *puVar12 = (ushort)((((*puVar12 & 0x7c1f) * 0x70 + iVar5 >> 3) + iVar5 >> 1 & 0x7c1f0) +
                                (((*puVar12 & 0x3e0) * 0x70 + iVar9 >> 3) + iVar9 >> 1 & 0x3e00) >>
                               4);
          }
          uVar8 = (ushort)uVar11;
