...
/* Function: FUN_10048322 @ 0x10048322 */


void __cdecl FUN_10048322(uint *param_1,uint param_2)

{
  ...
  *piVar3 = *piVar3 + -1;
  uVar5 = DAT_100593c8;
  puVar2 = DAT_100593d0;
  if ((*piVar3 == 0) && (uVar5 = uVar10, puVar2 = param_1, DAT_100593d0 != (uint *)0x0)) {
    VirtualFree((LPVOID)(DAT_100593c8 * 0x8000 + DAT_100593d0[3]),0x8000,0x4000);
    DAT_100593d0[2] = DAT_100593d0[2] | 0x80000000U >> ((byte)DAT_100593c8 & 0x1f);
    *(undefined4 *)(DAT_100593d0[4] + 0xc4 + DAT_100593c8 * 4) = 0;
    *(char *)(DAT_100593d0[4] + 0x43) = *(char *)(DAT_100593d0[4] + 0x43) + -1;
    if (*(char *)(DAT_100593d0[4] + 0x43) == '\0') {
      DAT_100593d0[1] = DAT_100593d0[1] & 0xfffffffe;
    }
    puVar2 = param_1;
    if (DAT_100593d0[2] == 0xffffffff) {
      VirtualFree((LPVOID)DAT_100593d0[3],0,0x8000);
      HeapFree(DAT_100593dc,0,(LPVOID)DAT_100593d0[4]);
      FUN_1004bb90(DAT_100593d0,DAT_100593d0 + 5,
                   (DAT_100593d4 * 0x14 - (int)DAT_100593d0) + -0x14 + DAT_100593d8);
      DAT_100593d4 = DAT_100593d4 + -1;
      if (DAT_100593d0 < param_1) {
        param_1 = param_1 + -5;
      }
      DAT_100593cc = DAT_100593d8;
      puVar2 = param_1;
    }
  }
  DAT_100593d0 = puVar2;
