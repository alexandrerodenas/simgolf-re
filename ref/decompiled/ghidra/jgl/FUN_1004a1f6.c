...
/* Function: FUN_1004a1f6 @ 0x1004A1F6 */
/* Body size: 1825 addresses */


int __cdecl FUN_1004a1f6(int *param_1,byte *param_2,undefined4 *param_3)

{
  ...
  do {
    ...
    if (((char)bVar9 < ' ') || ('x' < (char)bVar9)) {
      ...
      uVar2 = (byte)(&DAT_10053e00)[(char)bVar9] & 0xf;
    }
    local_34 = (int)(char)(&DAT_10053e20)[uVar2 * 8 + local_34] >> 4;
    switch(local_34) {
    case 0:
switchD_1004a264_caseD_0:
      local_28 = 0;
      if ((PTR_DAT_100567ac[(uint)bVar9 * 2 + 1] & 0x80) != 0) {
        FUN_1004a937((int)(char)bVar9,param_1,&local_18);
        bVar9 = *param_2;
        param_2 = pbVar1 + 2;
      }
      FUN_1004a937((int)(char)bVar9,param_1,&local_18);
    ...
    case 3:
      if (bVar9 == 0x2a) {
        local_24 = FUN_1004a9d5((int *)&param_3);
        if (local_24 < 0) {
          local_8 = local_8 | 4;
          local_24 = -local_24;
        }
    ...
    case 5:
      if (bVar9 == 0x2a) {
        local_14 = FUN_1004a9d5((int *)&param_3);
        if (local_14 < 0) {
          local_14 = -1;
        }
      }
...
LAB_1004a4b1:
            if ((local_8 & 0x810) == 0) {
              uVar5 = FUN_1004a9d5((int *)&param_3);
              local_24c[0] = (char)uVar5;
              local_10 = (undefined1 *)0x1;
            }
            else {
              uVar5 = FUN_1004a9f2((int *)&param_3);
              local_10 = (undefined1 *)FUN_1004df27(local_24c,(WCHAR)uVar5);
              if ((int)local_10 < 0) {
                local_2c = 1;
              }
            }
            ...
            psVar6 = (short *)FUN_1004a9d5((int *)&param_3);
            if ((psVar6 == (short *)0x0) ||
               (pWVar4 = *(WCHAR **)(psVar6 + 2), pWVar4 == (WCHAR *)0x0)) {
              local_c = (WCHAR *)PTR_DAT_10056790;
              pWVar4 = (WCHAR *)PTR_DAT_10056790;
              goto LAB_1004a5f6;
            }
            if ((local_8 & 0x800) == 0) {
              local_28 = 0;
            ...
            if (bVar9 == 99) goto LAB_1004a4b1;
            if (bVar9 == 100) goto LAB_1004a6db;
          }
        }
        else {
LAB_1004a484:
          ...
          param_3 = param_3 + 2;
          local_c = pWVar4;
          (*(code *)PTR___fptrap_10056620)(&local_4c,local_24c,(int)(char)bVar9,local_14,local_38);
          uVar2 = local_8 & 0x80;
          if ((uVar2 != 0) && (local_14 == 0)) {
            (*(code *)PTR___fptrap_1005662c)(local_24c);
          }
          if ((bVar9 == 0x67) && (uVar2 == 0)) {
            (*(code *)PTR___fptrap_10056624)(local_24c);
          }
          if (local_24c[0] == '-') {
...
LAB_1004a6db:
          ...
          if (bVar9 == 0x6e) {
            piVar7 = (int *)FUN_1004a9d5((int *)&param_3);
            if ((local_8 & 0x20) == 0) {
              *piVar7 = local_18;
            }
            else {
...
LAB_1004a423:
            ...
            pWVar3 = (WCHAR *)FUN_1004a9d5((int *)&param_3);
            if ((local_8 & 0x810) == 0) {
              pWVar4 = pWVar3;
              if (pWVar3 == (WCHAR *)0x0) {
                pWVar3 = (WCHAR *)PTR_DAT_10056790;
                pWVar4 = (WCHAR *)PTR_DAT_10056790;
              }
          ...
          if (bVar9 != 0x75) {
            if (bVar9 != 0x78) goto LAB_1004a800;
            local_30 = 0x27;
            goto LAB_1004a67c;
          }
        }
...
LAB_1004a6e6:
        if ((local_8 & 0x8000) == 0) {
          if ((local_8 & 0x20) == 0) {
            if ((local_8 & 0x40) == 0) {
              uVar2 = FUN_1004a9d5((int *)&param_3);
          ...
          uVar13 = FUN_1004a9e2((int *)&param_3);
        }
LAB_1004a739:
...
LAB_1004a800:
      ...
      if (local_2c == 0) {
        if ((local_8 & 0x40) != 0) {
          if ((local_8 & 0x100) == 0) {
            if ((local_8 & 1) == 0) {
              if ((local_8 & 2) == 0) goto LAB_1004a838;
              local_1a = ' ';
            }
            else {
              local_1a = '+';
...
LAB_1004a838:
        ...
        if ((local_8 & 0xc) == 0) {
          FUN_1004a96c(0x20,iVar10,param_1,&local_18);
        }
        FUN_1004a99d(&local_1a,local_20,param_1,&local_18);
        if (((uVar2 & 8) != 0) && ((uVar2 & 4) == 0)) {
          FUN_1004a96c(0x30,iVar10,param_1,&local_18);
        }
        if ((local_28 == 0) || (puVar12 = local_10, pWVar4 = local_c, (int)local_10 < 1)) {
          FUN_1004a99d((char *)local_c,(int)local_10,param_1,&local_18);
        }
        else {
          do {
            puVar12 = puVar12 + -1;
            iVar8 = FUN_1004df27(local_3c,*pWVar4);
            if (iVar8 < 1) break;
            FUN_1004a99d(local_3c,iVar8,param_1,&local_18);
            pWVar4 = pWVar4 + 1;
