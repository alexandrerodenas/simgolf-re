...
/* Function: FUN_10026be0 @ 0x10026BE0 */
/* Body size: 3774 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined4 __thiscall FUN_10026be0(void *this,int *param_1,int param_2,int param_3,char param_4)
        ...
        do {
          do {
            if ((*pbVar6 != 0xff) && ((param_4 == '\0' || (*pbVar6 < 0xf8)))) {
              ...
              iVar7 = (*puVar12 & 0xf81f) * 0x10;
              iVar9 = (*puVar12 & 0x7e0) * 0x10;
              *puVar12 = ((ushort)((((uVar8 & 0xf81f) * 0x10 + iVar7 >> 1) + iVar7 >> 1) + iVar7 >>
                                  1) & 0x81f0) +
                         ((ushort)((((uVar8 & 0x7e0) * 0x10 + iVar9 >> 1) + iVar9 >> 1) + iVar9 >> 1
                                  ) & 0x7e00);
            }
            pbVar6 = pbVar6 + -1;
            puVar12 = puVar12 + 1;
      ...
      do {
        do {
          if ((*pbVar6 != 0xff) && ((param_4 == '\0' || (*pbVar6 < 0xf8)))) {
            ...
            iVar7 = (*puVar12 & 0xf81f) * 0x10;
            iVar9 = (*puVar12 & 0x7e0) * 0x10;
            *puVar12 = ((ushort)((((uVar8 & 0xf81f) * 0x10 + iVar7 >> 1) + iVar7 >> 1) + iVar7 >> 1)
                       & 0x81f0) +
                       ((ushort)((((uVar8 & 0x7e0) * 0x10 + iVar9 >> 1) + iVar9 >> 1) + iVar9 >> 1)
                       & 0x7e00);
          }
    ...
    do {
      do {
        if ((*pbVar6 != 0xff) && ((param_4 == '\0' || (*pbVar6 < 0xf8)))) {
          ...
          iVar9 = (*puVar12 & 0x7e0) * 0x10;
          *puVar12 = ((ushort)((((uVar8 & 0xf81f) * 0x10 + iVar7 >> 1) + iVar7 >> 1) + iVar7 >> 1) &
                     0x81f0) + ((ushort)((((uVar8 & 0x7e0) * 0x10 + iVar9 >> 1) + iVar9 >> 1) +
                                         iVar9 >> 1) & 0x7e00);
        }
        pbVar6 = pbVar6 + 1;
        puVar12 = puVar12 + 1;
      ...
      *(int *)PTR_DAT_10055108 = *(int *)PTR_DAT_1005510c + DAT_10057c34;
      ...
      do {
        ...
        do {
          if ((*pbVar6 != 0xff) && ((param_4 == '\0' || (*pbVar6 < 0xf8)))) {
            uVar8 = *(ushort *)(iVar2 + (uint)*pbVar6 * 2);
            iVar5 = (*puVar12 & 0xf81f) * 0x10;
            iVar9 = (*puVar12 & 0x7e0) * 0x10;
            *puVar12 = ((ushort)((((uVar8 & 0xf81f) * 0x10 + iVar5 >> 1) + iVar5 >> 1) + iVar5 >> 1)
                       & 0x81f0) +
                       ((ushort)((((uVar8 & 0x7e0) * 0x10 + iVar9 >> 1) + iVar9 >> 1) + iVar9 >> 1)
                       & 0x7e00);
          }
  ...
  do {
    ...
    do {
      if ((*pbVar6 != 0xff) && ((param_4 == '\0' || (*pbVar6 < 0xf8)))) {
        ...
        iVar9 = (*puVar12 & 0x7e0) * 0x10;
        *puVar12 = ((ushort)((((uVar8 & 0xf81f) * 0x10 + iVar5 >> 1) + iVar5 >> 1) + iVar5 >> 1) &
                   0x81f0) + ((ushort)((((uVar8 & 0x7e0) * 0x10 + iVar9 >> 1) + iVar9 >> 1) + iVar9
                                      >> 1) & 0x7e00);
      }
      uVar8 = (ushort)uVar11;
      uVar11 = CONCAT22((short)(uVar11 >> 0x10),uVar8 + (ushort)iVar7);
