...
/* Body size: 3189 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* WARNING: Restarted to delay deadcode elimination for space: stack */

undefined4 __thiscall FUN_10012780(void *this,int *param_1,int param_2,int param_3,int param_4)
      ...
      if ((int)DAT_10055100 < 0) {
        ...
        do {
          do {
            if (*pbVar6 != 0xff) {
              if (*pbVar6 == 0xf8) {
                *puVar12 = *(ushort *)(iVar2 + (uint)*puVar12 * 2);
              }
              else {
                *puVar12 = *(ushort *)(iVar9 + (uint)*pbVar6 * 2);
              }
            }
            pbVar6 = pbVar6 + -1;
            puVar12 = puVar12 + 1;
