...
/* Function: FUN_10035e60 @ 0x10035E60 */
/* Body size: 2712 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined4 __thiscall FUN_10035e60(void *this,int *param_1,int param_2,int param_3)

{
  ...
  if (((DAT_100550fc ^ (int)DAT_100550fc >> 0x1f) - ((int)DAT_100550fc >> 0x1f) == iVar2) &&
    ...
    if ((int)DAT_100550fc < 0) {
      if ((int)DAT_10055100 < 0) {
        pcVar5 = (char *)(((local_1c.top - param_3) * DAT_10057d08 - param_2) + local_1c.left +
                         *(int *)((int)this + 0x14));
        iVar2 = (**(code **)(*param_1 + 0x18))();
        DAT_10057d00 = local_1c.bottom - local_1c.top;
        DAT_10057ce0 = local_1c.right - local_1c.left;
        pcVar10 = (char *)(DAT_10057cd4 * local_1c.top + local_1c.left + iVar2);
        ...
        do {
          ...
          pcVar5 = pcVar5 + -_DAT_10057cac;
          pcVar10 = pcVar10 + _DAT_10057cd8;
  ...
  lVar12 = __ftol();
  LVar1 = local_1c.left;
  local_1c.bottom = (int)lVar12 + iVar8;
  pRVar3 = (RECT *)(**(code **)(*param_1 + 0xcc))();
  BVar4 = IntersectRect(&local_1c,&local_1c,pRVar3);
  if (BVar4 == 0) {
    (**(code **)(*param_1 + 0x24))(1);
  ...
  iVar2 = (**(code **)(*param_1 + 0x18))();
  pcVar5 = (char *)(DAT_10057cd4 * local_1c.top + local_1c.left + iVar2);
  DAT_10057cd4 = (**(code **)(*param_1 + 0xe0))();
  DAT_10057ce0 = local_1c.right - local_1c.left;
  _DAT_10057cd8 = DAT_10057cd4 - DAT_10057ce0;
  DAT_10057d00 = local_1c.bottom - local_1c.top;
  ...
  if ((int)DAT_100550fc < 0) {
    if ((int)DAT_10055100 < 0) {
      ...
      DAT_10057cd0 = (local_1c.top - iVar8) * DAT_10057cb4;
      ...
      pcVar10 = (char *)((((*(int *)((int)local_8 + 0x34) - (DAT_10057cd0 >> 0x10)) + -1) *
      ...
      *(int *)PTR_DAT_10055118 = *(int *)PTR_DAT_1005511c + DAT_10057d08;
      iVar2 = DAT_10057cd0 << 0x10;
      DAT_10057ce0 = (DAT_10057ce0 + -1) * 0x10000;
      uVar9 = _DAT_10057d18 >> 0x10;
      _DAT_10057cb8 = DAT_10057cb4 << 0x10;
      do {
        iVar8 = CONCAT22((short)((uint)DAT_10057ce0 >> 0x10),DAT_10057d18);
        uVar7 = CONCAT22((short)((uint)iVar2 >> 0x10),DAT_10057ccc);
        do {
          if (*pcVar10 != -1) {
            *pcVar5 = *pcVar10;
          }
          uVar6 = (ushort)uVar7;
          uVar7 = CONCAT22((short)(uVar7 >> 0x10),uVar6 + (ushort)iVar8);
          pcVar10 = pcVar10 + (-(uint)CARRY2(uVar6,(ushort)iVar8) - uVar9);
          pcVar5 = pcVar5 + 1;
          iVar8 = iVar8 + -0x10000;
        } while (-1 < iVar8);
        pcVar5 = pcVar5 + _DAT_10057cd8;
        iVar2 = uVar7 + _DAT_10057cb8;
        pcVar10 = pcVar10 + *(int *)(PTR_DAT_1005511c + (uint)CARRY4(uVar7,_DAT_10057cb8) * -4);
        DAT_10057d00 = DAT_10057d00 + -1;
      } while (DAT_10057d00 != 0);
      (**(code **)(*param_1 + 0x24))(2);
      return 0;
    ...
    DAT_10057cd0 = (local_1c.top - iVar8) * DAT_10057cb4;
    _DAT_10057d10 = DAT_10057cb4 * DAT_10057d00 + (DAT_10057cd0 & 0xffff) >> 0x10;
    iVar11 = (DAT_10057cd0 >> 0x10) * DAT_10057d08;
    uVar9 = _DAT_10057ccc >> 0x10;
    _DAT_10057cf0 = _DAT_10057d18 * DAT_10057ce0 + (_DAT_10057ccc & 0xffff) >> 0x10;
    iVar2 = *(int *)((int)local_8 + 0x30);
    iVar8 = *(int *)((int)local_8 + 0x14);
    *(uint *)PTR_DAT_1005511c = (DAT_10057cb4 >> 0x10) * DAT_10057d08 + _DAT_10057cf0;
    pcVar10 = (char *)((iVar11 - uVar9) + iVar2 + -1 + iVar8);
    *(int *)PTR_DAT_10055118 = *(int *)PTR_DAT_1005511c + DAT_10057d08;
    iVar2 = DAT_10057cd0 << 0x10;
    DAT_10057ce0 = (DAT_10057ce0 + -1) * 0x10000;
    uVar9 = _DAT_10057d18 >> 0x10;
  ...
  if ((int)DAT_10055100 < 0) {
    ...
    _DAT_10057cf0 = _DAT_10057d18 * DAT_10057ce0 + (_DAT_10057ccc & 0xffff) >> 0x10;
    _DAT_10057d10 = DAT_10057cb4 * DAT_10057d00 + (DAT_10057cd0 & 0xffff) >> 0x10;
    iVar8 = ((*(int *)((int)local_8 + 0x34) - (DAT_10057cd0 >> 0x10)) + -1) * DAT_10057d08;
    uVar9 = _DAT_10057ccc >> 0x10;
    iVar2 = *(int *)((int)local_8 + 0x14);
    *(uint *)PTR_DAT_1005511c = (DAT_10057cb4 >> 0x10) * DAT_10057d08 + _DAT_10057cf0;
    pcVar10 = (char *)(iVar8 + uVar9 + iVar2);
    *(int *)PTR_DAT_10055118 = *(int *)PTR_DAT_1005511c + DAT_10057d08;
    iVar2 = DAT_10057cd0 << 0x10;
    DAT_10057ce0 = (DAT_10057ce0 + -1) * 0x10000;
    uVar9 = _DAT_10057d18 >> 0x10;
    ...
    do {
      ...
      do {
        ...
        uVar6 = (ushort)uVar7;
        uVar7 = CONCAT22((short)(uVar7 >> 0x10),uVar6 + (ushort)iVar8);
        pcVar10 = pcVar10 + CARRY2(uVar6,(ushort)iVar8) + uVar9;
        pcVar5 = pcVar5 + 1;
        iVar8 = iVar8 + -0x10000;
      } while (-1 < iVar8);
      pcVar5 = pcVar5 + _DAT_10057cd8;
  ...
  pcVar10 = (char *)((DAT_10057cd0 >> 0x10) * DAT_10057d08 + (_DAT_10057ccc >> 0x10) +
