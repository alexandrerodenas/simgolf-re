...
/* Function: FUN_1002b640 @ 0x1002B640 */
/* Body size: 3870 addresses */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined4 __thiscall FUN_1002b640(void *this,int *param_1,int param_2,int param_3,char param_4)
        ...
        do {
          do {
            if ((*pbVar6 != 0xff) && ((param_4 == '\0' || (*pbVar6 < 0xf8)))) {
              ...
              *puVar12 = ((ushort)(((*puVar12 & 0xf81f) * 0x30 + iVar7 >> 2) + iVar7 >> 1) & 0x81f0)
                         + ((ushort)(((*puVar12 & 0x7e0) * 0x30 + iVar9 >> 2) + iVar9 >> 1) & 0x7e00
                           );
            }
            pbVar6 = pbVar6 + -1;
            puVar12 = puVar12 + 1;
      ...
      do {
        ...
        do {
          if ((*pbVar6 != 0xff) && ((param_4 == '\0' || (*pbVar6 < 0xf8)))) {
            ...
            iVar9 = (uVar8 & 0x7e0) * 0x10;
            *puVar12 = ((ushort)(((*puVar12 & 0xf81f) * 0x30 + iVar5 >> 2) + iVar5 >> 1) & 0x81f0) +
                       ((ushort)(((*puVar12 & 0x7e0) * 0x30 + iVar9 >> 2) + iVar9 >> 1) & 0x7e00);
          }
          uVar8 = (ushort)uVar11;
