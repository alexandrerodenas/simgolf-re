/**
 * func_004ac1c2 — Auto-décompilé
 * Adresse: 0x004ac1c2 [golf.exe]
 * Taille: 90500 bytes, Type: std_prologue
 * Appel: __cdecl, Locals: 0B, SEH: True
 * Appelle: dword, 0x4a910c, 0x405099, 0x405096, 0x4a504f, 0x4a6070, 0x4abd90, 0x4ac4b3
 * Constantes: 0x4ac675, 0x4ac998, 0x4b3275, 0x4b680d, 0x4b6aa9, 0x4ac6da, 0x4b2e9c, 0x4ad059
 */
void func_004ac1c2(void) {
    /* 18100 instructions */
    ...
    // if (...) GOTO(0x4ac33e)
    // or dword ptr [ecx + 0xc], 8
    // mov dword ptr [ecx + 0x18], 0x1000
    // if (...) GOTO(0x4ac34f)
    // or dword ptr [ecx + 0xc], 4
    // lea eax, [ecx + 0x14]
    // mov dword ptr [ecx + 8], eax
    ...
    // push 2
    // pop eax
    // mov dword ptr [0x840c74], eax
    // cmp eax, 2
    // if (...) GOTO(0x4ac3f1)
    // mov eax, dword ptr [ebp + 0x1c]
    // cmp eax, ebx
    // if (...) GOTO(0x4ac3d9)
    // mov eax, dword ptr [0x840b44]
    ...
    // test byte ptr [eax + 0x840f01], cl
    // if (...) GOTO(0x4ac4e0)
    // cmp dword ptr [esp + 8], 0
    // if (...) GOTO(0x4ac4d9)
    // movzx eax, word ptr [eax*2 + 0x4e501a]
    ...
    // mov dword ptr [0x840dd8], ebx
    // jbe 0x4ac654
    // cmp byte ptr [ebp - 0x12], 0
    // if (...) GOTO(0x4ac62f)
    // lea ecx, [ebp - 0x11]
    // mov dl, byte ptr [ecx]
    // test dl, dl
    ...
    // mov dl, byte ptr [edx + 0x4e55a0]
    // or byte ptr [eax + 0x840f01], dl
    // inc eax
    // cmp eax, edi
    // jbe 0x4ac5d7
    // inc ecx
    ...
    // if (...) GOTO(0x4ac5b6)
    // mov eax, dword ptr [ebp + 8]
    // mov dword ptr [0x840dec], 1
    // push eax
    // mov dword ptr [0x840dd8], eax
    // CALL(0x4ac6db)
    // lea esi, [esi + 0x4e55ac]
    // mov edi, 0x840de0
    // movsd dword ptr es:[edi], dword ptr [esi]
    // movsd dword ptr es:[edi], dword ptr [esi]
    // pop ecx
    // mov dword ptr [0x841004], eax
    // movsd dword ptr es:[edi], dword ptr [esi]
    // if (...) GOTO(0x4ac675)
    // inc ecx
    // inc ecx
    ...
    // pop ecx
    // mov dword ptr [0x841004], eax
    // mov dword ptr [0x840dec], esi
    // if (...) GOTO(0x4ac65b)
    // and dword ptr [0x840dec], 0
    // xor eax, eax
    // mov edi, 0x840de0
    ...
    // and dword ptr [0x840cdc], 0
    // cmp eax, -2
    // if (...) GOTO(0x4ac6b1)
    // mov dword ptr [0x840cdc], 1
    // if (...) GOTO(dword)
    // cmp eax, -3
    // if (...) GOTO(0x4ac6c6)
    // mov dword ptr [0x840cdc], 1
    ...
    // xor eax, eax
    // mov esi, 0x100
    // mov byte ptr [ebp + eax - 0x114], al
    // inc eax
    // cmp eax, esi
    // if (...) GOTO(0x4ac761)
    // mov al, byte ptr [ebp - 0xe]
    // mov byte ptr [ebp - 0x114], 0x20
    // test al, al
    // if (...) GOTO(0x4ac7b2)
    // push ebx
    // push edi
    ...
    // test dl, 1
    // if (...) GOTO(0x4ac84b)
    // or byte ptr [eax + 0x840f01], 0x10
    // mov dl, byte ptr [ebp + eax - 0x214]
    // mov byte ptr [eax + 0x840e00], dl
    // if (...) GOTO(0x4ac867)
    // test dl, 2
    // if (...) GOTO(0x4ac860)
    // or byte ptr [eax + 0x840f01], 0x20
    // mov dl, byte ptr [ebp + eax - 0x314]
    // if (...) GOTO(0x4ac843)
    // and byte ptr [eax + 0x840e00], 0
    // inc eax
    // inc ecx
    // inc ecx
    // cmp eax, esi
    ...
    // CALL(0x4ac4e4)
    // pop ecx
    // mov dword ptr [0x842168], 1
    // return;
    // push ebx
    // xor ebx, ebx
    // cmp dword ptr [0x840ce0], ebx
    // push esi
    // push edi
    // if (...) GOTO(0x4ac927)
    // push(0x4bc9a4)  // ptr?
    ...
    // cmp edi, ebx
    // if (...) GOTO(0x4ac95d)
    // mov esi, dword ptr [0x4ba0a4]
    // push(0x4bc998)  // ptr?
    // push edi
    // CALL(esi)
    // test eax, eax
    // mov dword ptr [0x840ce0], eax
    // if (...) GOTO(0x4ac95d)
    // push(0x4bc988)  // ptr?
    // push edi
    // CALL(esi)
    // push(0x4bc974)  // ptr?
    // push edi
    // mov dword ptr [0x840ce4], eax
    // CALL(esi)
    // mov dword ptr [0x840ce8], eax
    // mov eax, dword ptr [0x840ce4]
    // test eax, eax
    // if (...) GOTO(0x4ac946)
    // CALL(eax)
    // mov ebx, eax
    ...
    // or eax, 0xffffffff
    // if (...) GOTO(0x4acade)
    // mov ebx, dword ptr [0x840cf4]
    // mov edi, 0x840cf4
    // if (...) GOTO(0x4ac9e7)
    // mov ebx, dword ptr [0x840cf0]
    // mov edi, 0x840cf0
    // if (...) GOTO(0x4ac9e7)
    // mov ebx, dword ptr [0x840cf8]
    // mov edi, 0x840cf8
    // if (...) GOTO(0x4ac9e7)
    // CALL(0x4a8e53)
    // mov esi, eax
    ...
    // mov dword ptr [esi + 0x58], 0x8c
    // mov dword ptr [ebp - 0xc], edx
    // cmp eax, 8
    // if (...) GOTO(0x4aca97)
    // mov ecx, dword ptr [0x4e53b0]
    // mov eax, dword ptr [0x4e53b4]
    // add eax, ecx
    // cmp ecx, eax
    // if (...) GOTO(0x4aca99)
    // lea eax, [ecx + ecx*2]
    ...
    // or esi, ecx
    // shl eax, 0x10
    // add dword ptr [ebp - 4], 0xfff0
    // mov dword ptr [ebx + 4], esi
    // mov dword ptr [ebx], eax
    // if (...) GOTO(0x4acc6e)
    // mov esi, 0x8000
    // test dword ptr [ebx + 8], esi
    // if (...) GOTO(0x4accb5)
    // push ebx
    // CALL(0x4acb9f)
    // add dword ptr [ebp - 4], 0xffff
    // pop ecx
    // if (...) GOTO(0x4acca0)
    ...
    // dec eax
    // if (...) GOTO(0x4ad037)
    // or dword ptr [ebp - 0x18], 0xffffffff
    // push 7
    // pop eax
    // if (...) GOTO(0x4acd18)
    // push 7
    ...
    // sub ecx, ebp
    // dec edx
    // add byte ptr [edx - 0x33], bh
    // dec edx
    // add cl, dl
    // int 0x4a
    // add bl, bh
    // int 0x4a
    // add byte ptr [esi - 0x32], dl
    // dec edx
    // add ch, cl
    // into 
    // dec edx
    ...
    // iretd 
    // dec edx
    // add byte ptr [ebp - 0x31], cl
    // dec edx
    // add byte ptr [edi + ecx*8], ch
    // dec edx
    // add byte ptr [ecx - 0x64ffb531], dh
    // iretd 
    // dec edx
    // add byte ptr [edi - 0x31], ah
    // dec edx
    ...
    // test cx, cx
    // push edi
    // mov byte ptr [ebp - 0x1c], 0xcc
    // mov byte ptr [ebp - 0x1b], 0xcc
    // mov byte ptr [ebp - 0x1a], 0xcc
    // mov byte ptr [ebp - 0x19], 0xcc
    // mov byte ptr [ebp - 0x18], 0xcc
    // mov byte ptr [ebp - 0x17], 0xcc
    // mov byte ptr [ebp - 0x16], 0xcc
    // mov byte ptr [ebp - 0x15], 0xcc
    // mov byte ptr [ebp - 0x14], 0xcc
    // mov byte ptr [ebp - 0x13], 0xcc
    // mov byte ptr [ebp - 0x12], 0xfb
    // mov byte ptr [ebp - 0x11], 0x3f
    // mov dword ptr [ebp - 4], 1
    // mov edx, eax
    // if (...) GOTO(0x4ad1f4)
    // mov byte ptr [ebx + 2], 0x2d
    // if (...) GOTO(0x4ad1f8)
    // mov byte ptr [ebx + 2], 0x20
    ...
    // imul eax, eax, 0x4d10
    // shr esi, 8
    // and word ptr [ebp - 0x10], 0
    // push 1
    // lea ecx, [esi + ecx*2]
    // mov word ptr [ebp - 6], dx
    // imul ecx, ecx, 0x4d
    // mov dword ptr [ebp - 0xa], edi
    // lea esi, [ecx + eax - 0x134312f4]
    // mov eax, dword ptr [ebp + 8]
    // sar esi, 0x10
    // mov dword ptr [ebp - 0xe], eax
    // movsx eax, si
    // neg eax
    // push eax
    // lea eax, [ebp - 0x10]
    ...
    // push(0x15)
    // pop edi
    // movzx esi, word ptr [ebp - 6]
    // sub esi, 0x3ffe
    // and word ptr [ebp - 6], 0
