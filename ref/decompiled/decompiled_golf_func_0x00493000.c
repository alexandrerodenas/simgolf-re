/**
 * func_00493000 — Auto-décompilé
 * Adresse: 0x00493000 [golf.exe]
 * Taille: 74765 bytes, Type: std_prologue
 * Appel: __cdecl, Locals: 0B, SEH: True
 * Appelle: 0x405097, dword, 0x492ed0, 0x493080, 0x492fa0, 0x493000, 0x4932d0, 0x493100
 * Constantes: 0x496cbd, 0x49d2a0, 0x83aa78, 0x4967d0, 0x4745c0, 0x4852e0, 0x4961d0, 0x4969d5
 */
void func_00493000(void) {
    /* 14953 instructions */
    ...
    // add eax, dword ptr [ebp + 8]
    // add eax, dword ptr [0x83d37c]
    // mov edi, eax
    // mov ax, word ptr [0x83d34c]
    // mov word ptr [edi], ax
    // add edi, 2
    // dec ecx
    // if (...) GOTO(0x49306b)
